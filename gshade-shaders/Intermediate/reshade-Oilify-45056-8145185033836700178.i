...
texture Anisotropy {Width = 3840; Height = 2137; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 3840), (1.0 / 2137), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 3840), (1.0 / 2137)) * Scale;
