...
dcl_output o0.xyzw
dcl_temps 10
add r0.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.033333, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.xyxx, t12.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.zwzz, t12.xyzw, s0
add r2.xyzw, v1.xyxy, l(-0.066667, 0.000000, -0.033333, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.zwzz, t12.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t12.xyzw, s0
add r4.xyzw, v1.xyxy, l(-0.133333, 0.000000, -0.100000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t12.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t12.xyzw, s0
add r6.xyzw, v1.xyxy, l(-0.200000, -0.000000, -0.166667, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r6.xyxx, t12.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.zwzz, t12.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.066667, 0.000000, 0.100000, 0.000000)
...
add r1.xyzw, v1.xyxy, l(0.133333, 0.000000, 0.166667, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t12.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t12.xyzw, s0
mad r0.xyzw, r2.xyzw, r9.zzzz, r0.xyzw
mad r0.xyzw, r1.xyzw, r9.yyyy, r0.xyzw
add r1.xy, v1.xyxx, l(0.200000, 0.000000, 0.000000, 0.000000)
