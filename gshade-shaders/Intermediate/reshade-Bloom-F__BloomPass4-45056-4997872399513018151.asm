...
loop 
  breakc_z r2.x
  itof r2.y, r1.w
  mad r0.y, r2.y, l(0.007487), v1.y
  sample_indexable(texture2d)(float,float,float,float) r2.yzw, r0.xyxx, t10.wxyz, s0
  imax r0.y, -r1.w, r1.w
  mad r1.xyz, r2.yzwy, icb[r0.y + 0].xxxx, r1.xyzx
  iadd r1.w, r1.w, l(1)
  ilt r2.x, r1.w, l(11)
endloop 
mul o0.xyz, r1.xyzx, l(2.500000, 2.500000, 2.500000, 0.000000)
mul r0.x, cb0[4].y, l(0.008333)
mov r0.y, l(0)
mov r1.xy, l(-10,-1,0,0)
loop 
  breakc_z r1.y
  itof r1.z, r1.x
  mad r0.z, r0.x, r1.z, v1.x
  sample_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t10.xywz, s0
  imax r1.z, -r1.x, r1.x
  mad r0.y, r0.z, icb[r1.z + 0].x, r0.y
  iadd r1.x, r1.x, l(1)
  ilt r1.y, r1.x, l(11)
endloop 
