...
#line 108
texture FeatureCurr          { Width = 3840;   Height = 2137;   Format = RG16F; MipLevels = 8; };
sampler sFeatureCurr         { Texture = FeatureCurr;  };
texture FeaturePrev          { Width = 3840;   Height = 2137;   Format = RG16F; MipLevels = 8; };
...
#line 116
texture MotionTexCur7               { Width = 3840 >> 7;   Height = 2137 >> 7;   Format = RGBA16F;  };
sampler sMotionTexCur7              { Texture = MotionTexCur7;};
texture MotionTexCur6               { Width = 3840 >> 6;   Height = 2137 >> 6;   Format = RGBA16F;  };
sampler sMotionTexCur6              { Texture = MotionTexCur6;};
texture MotionTexCur5               { Width = 3840 >> 5;   Height = 2137 >> 5;   Format = RGBA16F;  };
sampler sMotionTexCur5              { Texture = MotionTexCur5;};
texture MotionTexCur4               { Width = 3840 >> 4;   Height = 2137 >> 4;   Format = RGBA16F;  };
sampler sMotionTexCur4              { Texture = MotionTexCur4;};
texture MotionTexCur3               { Width = 3840 >> 3;   Height = 2137 >> 3;   Format = RGBA16F;  };
sampler sMotionTexCur3              { Texture = MotionTexCur3;};
texture MotionTexCur2               { Width = 3840 >> 2;   Height = 2137 >> 2;   Format = RGBA16F;  };
sampler sMotionTexCur2              { Texture = MotionTexCur2;};
texture MotionTexCur1               { Width = 3840 >> 1;   Height = 2137 >> 1;   Format = RGBA16F;  };
sampler sMotionTexCur1              { Texture = MotionTexCur1;};
texture MotionTexCur0               { Width = 3840 >> 0;   Height = 2137 >> 0;   Format = RGBA16F;  };
...
{
float2 texelsize = rcp(float2(3840, 2137) / exp2(mip_gcurr));
...
{
float2 texelsize = rcp(float2(3840, 2137) / exp2(mip_gcurr + 1));
