...
#line 27 "C:\Program Files\GShade\gshade-shaders\Shaders\FakeHDR.fx"
#line 33
float3 fHDRPass(float4 vpos : SV_Position, float2 texcoord : TexCoord) : SV_Target
{
const float3 color = tex2D(ReShade::BackBuffer, texcoord).rgb;
#line 38
const float2 rad1 = fradius1 * float2((1.0 / 3840), (1.0 / 2137));
const float2 rad2 = fradius2 * float2((1.0 / 3840), (1.0 / 2137));
#line 42
