...
movc r3.xy, r3.xxxx, l(0,0.000468,0,0), l(0.000260,0,0,0)
mov x0[0].x, l(1.000000)
div r3.z, l(1.000000, 1.000000, 1.000000, 1.000000), r1.x
mul r1.x, r1.y, r1.x
mov x0[1].x, r3.z
div r3.z, r3.z, r1.x
mul r1.x, r1.y, r1.x
...
loop 
  ...
  if_nz r0.y
    itof r4.z, r1.y
    mad r4.zw, r3.xxxy, r4.zzzz, v1.xxxy
    ...
    add r5.x, -r0.x, r5.x
    div_sat r5.x, r5.x, r1.x
    mul r5.x, r3.w, r5.x
    add r5.y, r2.x, -r5.w
    ge r5.z, |r5.y|, cb0[0].w
    add r5.y, |r5.y|, -cb0[0].w
    div r5.y, r5.y, r0.w
...
loop 
  ...
  if_nz r0.y
    itof r4.w, r3.z
    mad r5.xy, r3.xyxx, r4.wwww, v1.xyxx
    ...
    add r6.x, -r0.x, r6.x
    div_sat r6.x, r6.x, r1.x
    log r6.x, r6.x
    mul r6.x, r6.x, cb0[2].w
    exp r6.x, r6.x
    ...
    mul r5.y, r5.y, r5.x
    movc r5.x, r5.z, r5.y, r5.x
    mad r5.yz, -r3.xxyx, r4.wwww, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r4.w, r5.yzyy, t12.yzwx, s0, l(0.000000)
