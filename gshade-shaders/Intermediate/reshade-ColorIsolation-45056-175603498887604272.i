...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\ColorIsolation.fx"
...
#line 39 "C:\Program Files\GShade\gshade-shaders\Shaders\ColorIsolation.fx"
#line 47
...
#line 184
const float2 overlayPos = pos * (float2(3840, 2137) - size);
#line 186
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos + size))
{
x = Map(texcoord.x, float2(overlayPos.x, overlayPos.x + size.x) / 3840, float2(0.0, 1.0));
y = Map(texcoord.y, float2(overlayPos.y, overlayPos.y + size.y) / 2137, float2(0.0, 1.0));
