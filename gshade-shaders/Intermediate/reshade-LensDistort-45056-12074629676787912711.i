...
#line 372
if ((3840 * (1.0 / 2137))>1f) 
borderCoord.x = borderCoord.x*(3840 * (1.0 / 2137))+(1f-(3840 * (1.0 / 2137)));
else if ((3840 * (1.0 / 2137))<1f) 
borderCoord.y = borderCoord.y*(2137*(1.0 / 3840))+(1f-(2137*(1.0 / 3840)));
#line 377
...
#line 402
viewCoord *= normalize(float2(3840, 2137));
#line 404
...
#line 418
const float2 aspectScalar = 0.5/normalize(float2(3840, 2137));
#line 420
...
{
#line 531
float2 orygTexCoord = (pixelPos.xy+0.5)*float2((1.0 / 3840), (1.0 / 2137));
#line 533
float2 distortion = texCoord-orygTexCoord;
#line 535
uint evenSampleCount = min(ChromaticSamplesLimit-ChromaticSamplesLimit%2u, 64u); 
#line 537
uint totalPixelOffset = uint(ceil(length(T*(distortion*float2(3840, 2137)))));
#line 539
