...
loop 
  ...
  loop 
    ...
    mad r4.yw, r6.xxxy, l(0.000000, 0.016667, 0.000000, 0.029949), v1.xxxy
    sample_l_aoffimmi_indexable(6,0,0)(texture2d)(float,float,float,float) r6.x, r4.ywyy, t8.yxzw, s0, l(0.000000)
    sample_l_aoffimmi_indexable(0,0,0)(texture2d)(float,float,float,float) r7.xyzw, r4.ywyy, t16.xyzw, s0, l(0.000000)
    add r4.y, -r1.y, r6.x
...
ige r0.y, l(5), cb0[0].x
if_nz r0.y
  add r3.xyzw, v1.xyxy, l(-0.008333, -0.014974, -0.008333, 0.000000)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r0.yz, r3.xyxx, t8.zxyw, s0, l(0.000000)
  add r4.xyzw, r2.xyxy, r3.xyzw
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.zw, r4.xyxx, t10.zwxy, s0, l(0.000000)
  mov x0[0].xy, r0.yzyy
  mul r5.yz, r1.zzwz, r1.zzwz
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r3.zw, r3.zwzz, t8.zwxy, s0, l(0.000000)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r4.xy, r4.zwzz, t10.xyzw, s0, l(0.000000)
  mov x0[1].xy, r3.zwzz
  ...
  add r6.xyzw, v1.xyxy, l(-0.008333, 0.014974, 0.000000, -0.014974)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.zw, r6.xyxx, t8.zwxy, s0, l(0.000000)
  add r7.xyzw, r2.xyxy, r6.xyzw
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r3.zw, r7.xyxx, t10.zwxy, s0, l(0.000000)
  mov x0[2].xy, r1.zwzz
  ...
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.zw, r6.zwzz, t8.zwxy, s0, l(0.000000)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r3.zw, r7.zwzz, t10.zwxy, s0, l(0.000000)
  mov x0[3].xy, r1.zwzz
  ...
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.zw, r1.zwzz, t10.zwxy, s0, l(0.000000)
  mov x0[4].xy, r1.xyxx
  ...
  add r1.xyzw, v1.xyxy, l(0.000000, 0.014974, 0.008333, -0.014974)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r5.xy, r1.xyxx, t8.xyzw, s0, l(0.000000)
  add r6.xyzw, r2.xyxy, r1.xyzw
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.xy, r6.xyxx, t10.xyzw, s0, l(0.000000)
  mov x0[5].xy, r5.xyxx
  ...
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.xy, r1.zwzz, t8.xyzw, s0, l(0.000000)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.zw, r6.zwzz, t10.zwxy, s0, l(0.000000)
  mov x0[6].xy, r1.xyxx
  ...
  add r4.xyz, r4.xyzx, r5.xyzx
  mad r0.yz, r1.xxyx, r1.zzwz, r0.yyzy
  add r1.xyzw, v1.xyxy, l(0.008333, 0.000000, 0.008333, 0.014974)
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r5.xy, r1.xyxx, t8.xyzw, s0, l(0.000000)
  add r6.xyzw, r2.xyxy, r1.xyzw
  sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r1.xy, r6.xyxx, t10.xyzw, s0, l(0.000000)
  mov x0[7].xy, r5.xyxx
  ...
  mov r6.w, r4.x
  mov r3.zw, r2.xxxy
  mov r4.yz, l(0,0.008333,0.014974,0)
  mov r1.w, r0.y
  mov r4.w, |r0.z|
  mov r7.x, l(0)
  mov r7.y, r0.w
  loop 
    ...
    loop 
      ...
      loop 
        ...
        utof r14.x, r14.x
        utof r14.y, r15.x
        mad r13.zw, r14.xxxy, l(0.000000, 0.000000, 0.008333, 0.014974), r10.zzzw
        sample_l_aoffimmi_indexable(5,0,0)(texture2d)(float,float,float,float) r13.zw, r13.zwzz, t10.zwxy, s0, l(0.000000)
