...
// __V__ArcaneBloom_____tArcaneBloom_Bloom1Alt    texture  float4          2d            t16      1 
//
//
//
// Input signature:
...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(-0.000000, -0.011231, 0.000000, -0.009359)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.zwzz, t16.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t16.xyzw, s0
mul r1.xyz, r1.xyzx, l(0.033159, 0.033159, 0.033159, 0.000000)
mad r0.xyz, r0.xyzx, l(0.017997, 0.017997, 0.017997, 0.000000), r1.xyzx
add r1.xyzw, v1.xyxy, l(0.000000, -0.007487, 0.000000, -0.005615)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t16.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t16.xyzw, s0
