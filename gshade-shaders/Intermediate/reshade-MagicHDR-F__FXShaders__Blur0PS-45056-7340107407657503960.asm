...
dcl_output o0.xyzw
dcl_temps 10
add r0.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.001042, 0.000000)
...
add r2.xyzw, v1.xyxy, l(-0.002083, 0.000000, -0.001042, 0.000000)
...
add r4.xyzw, v1.xyxy, l(-0.004167, 0.000000, -0.003125, 0.000000)
...
add r6.xyzw, v1.xyxy, l(-0.006250, -0.000000, -0.005208, 0.000000)
...
add r1.xyzw, v1.xyxy, l(0.002083, 0.000000, 0.003125, 0.000000)
...
add r1.xyzw, v1.xyxy, l(0.004167, 0.000000, 0.005208, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t4.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t4.xyzw, s0
mad r0.xyzw, r2.xyzw, r9.zzzz, r0.xyzw
mad r0.xyzw, r1.xyzw, r9.yyyy, r0.xyzw
add r1.xy, v1.xyxx, l(0.006250, 0.000000, 0.000000, 0.000000)
