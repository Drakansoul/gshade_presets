...
#line 42
texture normalTex { Width = 3840; Height = 2137; Format = RGBA8; };
sampler normalSampler { Texture = normalTex;};
#line 45
texture previousDepthTex { Width = 3840; Height = 2137; Format = RGBA8; };
sampler previousDepthSampler { Texture = previousDepthTex; };
#line 48
texture lightPassTex { Width = 3840*0.5; Height = 2137*0.5; Format = RGBA8; MipLevels = 4; };
sampler lightPassSampler { Texture = lightPassTex; MinLOD = 0.0f; MaxLOD = 3.0f;};
#line 51
texture lightPassHitTex { Width = 3840*0.5; Height = 2137*0.5; Format = RGBA8; };
sampler lightPassHitSampler { Texture = lightPassHitTex; };
#line 54
texture lightPassAOTex { Width = 3840*0.5; Height = 2137*0.5; Format = RGBA8; MipLevels = 4; };
sampler lightPassAOSampler { Texture = lightPassAOTex; MinLOD = 0.0f; MaxLOD = 3.0f;};
#line 57
texture smoothPassTex { Width = 3840*0.5; Height = 2137*0.5; Format = RGBA8; MipLevels = 4; };
sampler smoothPassSampler { Texture = smoothPassTex; MinLOD = 0.0f; MaxLOD = 3.0f;};
#line 60
texture smoothAOPassTex { Width = 3840*0.5; Height = 2137*0.5; Format = RGBA8; MipLevels = 4; };
sampler smoothAOPassSampler { Texture = smoothAOPassTex; MinLOD = 0.0f; MaxLOD = 3.0f; };
#line 63
texture smoothPass2Tex { Width = 3840; Height = 2137; Format = RGBA8; MipLevels = 4; };
sampler smoothPass2Sampler { Texture = smoothPass2Tex; MinLOD = 0.0f; MaxLOD = 3.0f; };
#line 66
texture smoothAOPass2Tex { Width = 3840; Height = 2137; Format = RGBA8; MipLevels = 4; };
sampler smoothAOPass2Sampler { Texture = smoothAOPass2Tex; MinLOD = 0.0f; MaxLOD = 3.0f; };
#line 69
texture smoothPass3Tex { Width = 3840; Height = 2137; Format = RGBA8; MipLevels = 4; };
sampler smoothPass3Sampler { Texture = smoothPass3Tex; MinLOD = 0.0f; MaxLOD = 3.0f; };
#line 72
texture smoothAOPass3Tex { Width = 3840; Height = 2137; Format = RGBA8; };
sampler smoothAOPass3Sampler { Texture = smoothAOPass3Tex; MinLOD = 0.0f; MaxLOD = 3.0f; };
#line 75
texture resultTex { Width = 3840; Height = 2137; Format = RGBA8; };
...
float2 result = 1.0;
return result/float2(3840,2137);
}
#line 392
float2 RenderPixelSize() {
float2 result = 1.0;
return result/float2(3840*0.5,2137*0.5);
}
#line 397
...
result *= int3(3840,2137,3840*1000.0*fDepthMultiplier/1024);
return result;
}
#line 415
float3 getScreenPosition(float3 wp) {
float3 result = wp/int3(3840,2137,3840*1000.0*fDepthMultiplier/1024);
result.xy /= result.z;
...
float3 jitter = normalize(tex2D(blueNoiseSampler,(offset+coords*int2(3840,2137))%((float)512)/((float)512)).rgb-0.5);
...
float weaponLimit = fWeaponDepth*int3(3840,2137,3840*1000.0*fDepthMultiplier/1024).z;
#line 492
do {
...
#line 649
int2 coordsInt = coords*int2(3840*0.5,2137*0.5);
#line 651
...
int2 currentCoordsInt = currentCoords*int2(3840*0.5,2137*0.5);
#line 674
