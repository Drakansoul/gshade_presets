...
if_nz r2.x
  ...
  loop 
    breakc_z r1.w
    itof r2.x, icb[r0.w + 0].x
    mul r5.x, r2.x, cb0[0].y
    itof r2.x, icb[r0.w + 0].y
    mul r5.y, r2.x, cb0[0].y
    mad r2.xw, r5.xxxy, l(0.000260, 0.000000, 0.000000, 0.000468), v1.xxxy
...
if_nz r2.y
  ...
  loop 
    breakc_z r1.w
    itof r3.xz, icb[r0.w + 0].xxyx
    mul r3.xy, r3.xzxx, cb0[0].yyyy
    mad r3.zw, r3.xxxy, l(0.000000, 0.000000, 0.000260, 0.000468), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r3.zwzz, t0.xyzw, s0, l(0.000000)
    mov r3.z, x0[r0.w + 0].x
    mad r5.xyz, r5.xyzx, r3.zzzz, r4.xyzx
    mad r3.xy, -r3.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000), v1.xyxx
