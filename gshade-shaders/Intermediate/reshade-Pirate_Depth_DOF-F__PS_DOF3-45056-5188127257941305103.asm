...
if_nz r1.y
  if_z cb0[0].x
    ...
    mul r1.yz, r2.xxxx, l(0.000000, 0.580611, -0.500000, 0.000000)
    mad r2.x, r3.x, l(-0.500000), -r1.y
    mad r2.y, r3.x, l(0.580611), r1.z
  else 
    mov r2.xy, l(-0.500000,0.580611,0,0)
  endif 
  mul r1.y, r1.x, cb0[0].y
  ge r1.z, r1.y, l(0.000521)
  if_nz r1.z
    ...
    mul r1.yz, r1.yyzy, l(0.000000, 0.000521, 0.000936, 0.000000)
    mov r4.xyz, r3.xyzx
    mov r5.xyz, r0.xyzx
    mov r1.w, r1.x
    mov r5.w, r1.x
    ...
    loop 
      breakc_z r2.y
      itof r3.w, r2.x
      mad r6.xy, r1.yzyy, r3.wwww, v1.xyxx
      sample_l_indexable(texture2d)(float,float,float,float) r7.xyz, r6.xyxx, t14.xyzw, s0, l(0.000000)
      sample_l_indexable(texture2d)(float,float,float,float) r4.w, r6.xyxx, t10.yzwx, s0, l(0.000000)
      dp3 r6.x, r7.xyzx, l(0.333300, 0.333300, 0.333300, 0.000000)
      max r6.y, r7.y, r7.x
      max r6.y, r7.z, r6.y
      min r6.z, r7.y, r7.x
      min r6.z, r7.z, r6.z
      ...
      dp3 r6.w, r7.xyzx, l(0.210000, 0.720000, 0.070000, 0.000000)
      movc r6.z, r2.w, r6.z, r6.w
      movc r6.y, r2.z, r6.y, r6.z
      movc r6.x, cb0[4].y, r6.y, r6.x
      mul r7.w, r4.w, r6.x
      lt r6.y, r5.w, r7.w
      and r6.y, r6.y, l(0x3f800000)
      mul r6.y, r7.w, r6.y
      add r8.xyzw, -r5.xyzw, r7.xyzw
      mad r8.xyzw, r6.yyyy, r8.xyzw, r5.xyzw
      mad r6.yzw, r7.xxyz, r7.wwww, r4.xxyz
      mad r4.w, r4.w, r6.x, r1.w
      mad r7.xy, -r1.yzyy, r3.wwww, v1.xyxx
      sample_l_indexable(texture2d)(float,float,float,float) r9.xyz, r7.xyxx, t14.xyzw, s0, l(0.000000)
      sample_l_indexable(texture2d)(float,float,float,float) r3.w, r7.xyxx, t10.yzwx, s0, l(0.000000)
      dp3 r6.x, r9.xyzx, l(0.333300, 0.333300, 0.333300, 0.000000)
      max r7.x, r9.y, r9.x
      max r7.x, r9.z, r7.x
      min r7.y, r9.y, r9.x
      min r7.y, r9.z, r7.y
      ...
      dp3 r7.z, r9.xyzx, l(0.210000, 0.720000, 0.070000, 0.000000)
      movc r7.y, r2.w, r7.y, r7.z
      movc r7.x, r2.z, r7.x, r7.y
      movc r6.x, cb0[4].y, r7.x, r6.x
      mul r9.w, r3.w, r6.x
      lt r7.x, r8.w, r9.w
      and r7.x, r7.x, l(0x3f800000)
      mul r7.x, r9.w, r7.x
      add r10.xyzw, -r8.xyzw, r9.xyzw
      mad r5.xyzw, r7.xxxx, r10.xyzw, r8.xyzw
      mad r4.xyz, r9.xyzx, r9.wwww, r6.yzwy
      mad r1.w, r3.w, r6.x, r4.w
      iadd r2.x, r2.x, l(1)
      ige r2.y, l(4), r2.x
    endloop 
