...
if_nz r1.y
  ...
  if_nz r1.y
    movc r2.xyzw, cb0[8].xxxx, l(1.400000,0.000365,0.000655,-1.400000), l(0.500000,0.000130,0.000234,-0.500000)
    add r1.yz, r2.yyzy, v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t1.wxyz, s0
    movc r2.yz, cb0[8].xxxx, l(0,-0.000365,-0.000655,0), l(0,-0.000130,-0.000234,0)
    add r2.yz, r2.yyzy, v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.yzyy, t1.xyzw, s0
    mad r2.xyzw, r2.xwwx, l(0.000260, 0.000468, 0.000260, 0.000468), v1.xyxy
    ...
    if_nz r2.w
      ...
      movc r9.xyzw, r2.wwww, l(-0.000911,0,0.000911,0), l(0,0.001638,0,-0.001638)
  ...
  if_nz cb0[3].z
    if_nz cb0[4].w
      ...
      mov r5.zw, l(0,0,0.000026,0.000047)
  ...
  if_nz r0.w
    ...
    mul r7.xyzw, r7.xyzw, l(0.000260, 0.000468, 0.000260, 0.000468)
    movc r8.xyzw, r0.wwww, l(0.296198,1.986356,1.105428,0.532242), l(-0.296198,1.986356,0.809229,1.454113)
    ...
    movc r10.xyzw, r0.wwww, l(0.809229,-1.454113,-0.296198,-1.986356), l(1.105428,-0.532243,0.296198,-1.986356)
    ...
    movc r10.xyzw, r0.wwww, l(-1.105428,-0.532242,-0.809229,1.454114), l(-0.809229,-1.454113,-1.105428,0.532242)
