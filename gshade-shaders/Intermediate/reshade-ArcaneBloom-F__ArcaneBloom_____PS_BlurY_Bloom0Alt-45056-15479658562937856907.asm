...
// __V__ArcaneBloom_____tArcaneBloom_Bloom0Alt    texture  float4          2d            t14      1 
//
//
//
// Input signature:
...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(-0.000000, -0.002808, 0.000000, -0.002340)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.zwzz, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t14.xyzw, s0
mul r1.xyz, r1.xyzx, l(0.033159, 0.033159, 0.033159, 0.000000)
mad r0.xyz, r0.xyzx, l(0.017997, 0.017997, 0.017997, 0.000000), r1.xyzx
add r1.xyzw, v1.xyxy, l(0.000000, -0.001872, 0.000000, -0.001404)
...
add r1.xyzw, v1.xyxy, l(0.000000, -0.000936, 0.000000, -0.000468)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t14.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.000000, 0.000468, 0.000000, 0.000936)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t14.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.000000, 0.001404, 0.000000, 0.001872)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t14.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.000000, 0.002340, 0.000000, 0.002808)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t14.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t14.xyzw, s0
