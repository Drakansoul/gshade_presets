...
and r1.z, r1.w, r1.z
ge r1.w, r0.w, l(1.796912)
div r2.y, l(3840.000000), r0.w
mul r2.z, r0.w, l(2137.000000)
mov r2.xw, l(3840.000000,0,0,2137.000000)
...
mul r3.y, r0.w, r1.w
mov r3.xz, l(1.000000,0,3840.000000,0)
movc r2.xy, cb0[0].wwww, r3.xyxx, r2.xyxx
div r2.xy, l(3840.000000, 2137.000000, 0.000000, 0.000000), r2.xyxx
...
endswitch 
ge r1.w, r0.w, l(1.796912)
div r3.w, l(3840.000000), r0.w
mul r5.x, r0.w, l(2137.000000)
...
ge r2.w, r1.w, r0.w
div r0.w, r1.w, r0.w
div r0.w, l(3840.000000), r0.w
movc r0.w, r2.w, r0.w, l(3840.000000)
movc r0.w, cb0[0].w, l(3840.000000), r0.w
...
endswitch 
ge r1.w, r0.w, l(1.796912)
div r5.w, l(3840.000000), r0.w
mul r6.x, r0.w, l(2137.000000)
...
div r0.w, l(2137.000000), r0.w
mul r4.zw, r0.wwww, cb0[11].zzzw
mul r4.zw, r4.zzzw, l(0.000000, 0.000000, 0.010000, 0.010000)
div r4.zw, r4.zzzw, r0.zzzz
lt r0.w, r0.x, l(1.796912)
div r6.z, l(1.796912), r0.x
mul r5.xy, r2.xyxx, r6.zwzz
div r5.xy, r5.xyxx, r0.yzyy
add r5.xy, -r5.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000)
mul r5.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mul r2.z, r0.x, r2.y
mul r2.xy, r2.xzxx, l(1.000000, 0.556510, 0.000000, 0.000000)
div r2.xy, r2.xyxx, r0.yzyy
add r2.xy, -r2.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000)
...
if_z cb0[0].w
  mul r2.xy, r0.wxww, l(0.000468, 0.000260, 0.000000, 0.000000)
  lt r2.xy, r2.xyxx, v1.yxyy
  add r2.zw, -r0.wwwx, l(0.000000, 0.000000, 2137.000000, 3840.000000)
  mul r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.000468, 0.000260)
  lt r2.zw, v1.yyyx, r2.zzzw
  and r2.xy, r2.zwzz, r2.xyxx
  not r4.x, r2.y
  mad r2.zw, r3.yyyy, l(0.000000, 0.000000, 0.500000, 0.500000), r4.zzzw
  mul r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.000468, 0.000468)
  lt r1.w, r2.z, v1.y
  lt r2.z, v1.y, r2.w
  and r1.w, r1.w, r2.z
  mad r2.zw, r3.xxxx, l(0.000000, 0.000000, 0.500000, 0.500000), r3.zzzw
  mul r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.000260, 0.000260)
  lt r2.z, r2.z, v1.x
  lt r2.w, v1.x, r2.w
  and r2.z, r2.w, r2.z
  not r2.z, r2.z
  ...
  mul r4.xy, r0.xwxx, l(0.000260, 0.000468, 0.000000, 0.000000)
  add r1.w, -v1.y, l(1.000000)
  lt r4.x, r4.x, r1.w
  add r0.xw, -r0.xxxw, l(3840.000000, 0.000000, 0.000000, 2137.000000)
  mul r0.xw, r0.xxxw, l(0.000260, 0.000000, 0.000000, 0.000468)
  lt r0.x, r1.w, r0.x
  and r0.x, r0.x, r4.x
  lt r4.x, r4.y, v1.x
  lt r0.w, v1.x, r0.w
  ...
  mul r3.xz, r3.xxzx, l(0.000260, 0.000000, 0.000260, 0.000000)
  lt r3.x, r3.x, r1.w
  lt r1.w, r1.w, r3.z
  and r1.w, r1.w, r3.x
  mad r3.xy, r3.yyyy, l(0.500000, 0.500000, 0.000000, 0.000000), r4.zwzz
  mul r3.xy, r3.xyxx, l(0.000468, 0.000468, 0.000000, 0.000000)
  lt r3.x, r3.x, v1.x
  lt r3.y, v1.x, r3.y
  and r3.x, r3.y, r3.x
  not r3.x, r3.x
...
div r4.y, l(3840.000000), r1.w
mul r4.z, r1.w, l(2137.000000)
...
endswitch 
ge r1.w, r0.w, l(1.796912)
div r4.y, l(3840.000000), r0.w
mul r4.z, r0.w, l(2137.000000)
mov r4.xw, l(3840.000000,0,0,2137.000000)
...
div r4.y, l(3840.000000), r3.z
mul r4.z, r3.z, l(2137.000000)
mov r4.xw, l(3840.000000,0,0,2137.000000)
...
switch cb0[0].z
  ...
  break 
endswitch 
ge r4.y, r3.w, l(1.796912)
div r5.y, l(3840.000000), r3.w
mul r5.z, r3.w, l(2137.000000)
...
if_nz r0.x
  ...
  div r0.w, r1.w, r0.w
  div r0.w, l(3840.000000), r0.w
  movc r0.x, r0.x, r0.w, l(3840.000000)
  ...
  div r1.xz, l(3840.000000, 0.000000, 2137.000000, 0.000000), r1.xxzx
  add r1.xz, -r1.xxzx, l(3840.000000, 0.000000, 2137.000000, 0.000000)
  ...
  mad r0.y, r0.y, l(3840.000000), -r0.x
  mad r0.y, -r1.x, l(0.500000), r0.y
  mad r0.x, r0.w, l(0.010000), -r0.x
  div r0.x, r0.y, r0.x
  mad r0.z, r0.z, l(2137.000000), -r1.y
