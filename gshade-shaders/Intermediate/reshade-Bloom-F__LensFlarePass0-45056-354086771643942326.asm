...
if_nz cb0[3].w
  ...
  loop 
    breakc_z r1.x
    itof r1.w, r0.w
    mad r1.z, r1.w, l(0.000936), v1.y
    mad r3.yz, r1.yyzy, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
    div r3.x, r3.y, -cb0[11].x
    mad r1.zw, r3.xxxz, l(0.000000, 0.000000, 0.500000, 0.500000), l(0.000000, 0.000000, 0.500000, 0.500000)
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r1.zwzz, t18.xyzw, s0, l(0.000000)
    add r4.xyz, r3.xyzx, -cb0[10].wwww
    max r4.xyz, r4.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
    dp3 r1.z, r4.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    add r1.z, r1.z, r1.z
