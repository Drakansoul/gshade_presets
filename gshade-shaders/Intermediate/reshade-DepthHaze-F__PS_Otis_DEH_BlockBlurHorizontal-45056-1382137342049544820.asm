...
loop 
  ...
  mul r4.y, r4.z, r4.y
  mul r4.w, r4.x, r4.y
  sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r2.zwzz, t0.xyzw, s0
  mad r5.xyzw, r5.xyzw, r4.wwww, r3.xyzw
  mad r2.z, r4.y, r4.x, r1.y
  add r2.xw, -r2.xxxy, v1.xxxy
  sample_l_indexable(texture2d)(float,float,float,float) r4.x, r2.xwxx, t2.xyzw, s0, l(0.000000)
  mad r4.y, -r4.x, l(999.000000), l(1000.000000)
  div r4.x, r4.x, r4.y
  add r4.y, r1.x, -r4.x
  add r4.y, -|r4.y|, l(1.000000)
  mul r4.y, r4.z, r4.y
  mul r4.z, r4.x, r4.y
  sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r2.xwxx, t0.xyzw, s0
