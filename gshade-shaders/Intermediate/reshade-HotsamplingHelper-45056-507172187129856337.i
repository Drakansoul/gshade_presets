...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\HotsamplingHelper.fx"
...
#line 44 "C:\Program Files\GShade\gshade-shaders\Shaders\HotsamplingHelper.fx"
#line 45
...
#line 61
const float2 overlayPos = fUIOverlayPos * (1.0 - fUIOverlayScale) * float2(3840, 2137);
#line 63
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos + float2(3840, 2137) * fUIOverlayScale))
{
texcoord = frac((texcoord - overlayPos / float2(3840, 2137)) / fUIOverlayScale);
}
#line 68
