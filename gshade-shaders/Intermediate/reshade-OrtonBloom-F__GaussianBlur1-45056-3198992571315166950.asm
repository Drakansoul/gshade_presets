...
exp r0.y, r0.y
movc r0.w, cb0[0].x, r0.y, r0.x
mov r0.yz, cb0[0].yyyy
mov r2.xyz, r1.xyzx
mov r1.w, l(1)
mov r2.w, l(-1)
loop 
  breakc_z r2.w
  mul r0.x, r0.w, icb[r1.w + 0].x
  mul r3.xy, r0.zwzz, r0.xyxx
  mad r3.zw, r3.xxxy, l(0.000000, 0.000000, 0.000260, 0.000000), v1.xxxy
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.zwzz, t0.xyzw, s0
  mad r4.xyz, r4.xyzx, icb[r1.w + 0].yyyy, r2.xyzx
  mad r3.xy, -r3.xyxx, l(0.000260, 0.000000, 0.000000, 0.000000), v1.xyxx
