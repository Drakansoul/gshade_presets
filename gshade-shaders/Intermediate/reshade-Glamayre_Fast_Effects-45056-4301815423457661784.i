...
float3 ne = getBackBufferLinear( texcoord + float2((1.0 / 3840), (1.0 / 2137))*float2(offset,offset)).rgb;
float3 sw = getBackBufferLinear( texcoord + float2((1.0 / 3840), (1.0 / 2137))*float2(-offset,-offset)).rgb;
float3 se = getBackBufferLinear( texcoord + float2((1.0 / 3840), (1.0 / 2137))*float2(offset,-offset)).rgb;
float3 nw = getBackBufferLinear( texcoord + float2((1.0 / 3840), (1.0 / 2137))*float2(-offset,offset)).rgb;
#line 1277
...
#line 1308
float3 ww = getBackBufferLinear( texcoord + float2((1.0 / 3840), (1.0 / 2137))*wwpos).rgb;
float3 ee = getBackBufferLinear( texcoord + float2((1.0 / 3840), (1.0 / 2137))*eepos).rgb;
#line 1317
...
#line 1406
float4 local_slope = float4(ddx(depth), ddy(depth), 0.1*float2((1.0 / 3840), (1.0 / 2137)));
#line 1408
...
#line 1495
texcoord = (floor((vpos.xy)/2)*2+0.5)*float2((1.0 / 3840), (1.0 / 2137));
#line 1499
float2x3 ao_point ;
ao_point[0]=0;
ao_point[1]=0;
...
for(i = 0; i< 2; i++) {
#line 1509
float2 outer_circle = 1/normalize(float2(3840, 2137))*float2( sin((i*2+.5)*angle), cos((i*2+.5)*angle) );
float2 inner_circle = 1/normalize(float2(3840, 2137))*float2( sin((i*2-.5)*angle), cos((i*2-.5)*angle) );
#line 1512
