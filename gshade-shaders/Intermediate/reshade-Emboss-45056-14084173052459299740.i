...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Emboss.fx"
#line 6
...
#line 23 "C:\Program Files\GShade\gshade-shaders\Shaders\Emboss.fx"
#line 28
...
const float3 col1 = tex2D(ReShade::BackBuffer, texcoord - float2((1.0 / 3840), (1.0 / 2137))*fEmbossOffset*offset).rgb;
const float3 col3 = tex2D(ReShade::BackBuffer, texcoord + float2((1.0 / 3840), (1.0 / 2137))*fEmbossOffset*offset).rgb;
#line 37
