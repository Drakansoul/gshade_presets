    ...
    loop 
      ...
      loop 
        ...
        loop 
          ...
          rsq r9.y, r9.y
          mul r9.yzw, r7.xxyz, r9.yyyy
          mul r8.y, r2.x, r8.y
          mul r9.yzw, r8.yyyy, r9.yyzw
          dp3 r10.x, r9.yzwy, r3.xzwx
          dp3 r10.y, r9.yzwy, r4.xyzx
          dp3 r7.z, r9.yzwy, r1.xyzx
          mul r10.z, r0.z, r7.z
          add r9.yzw, r0.xxyz, r10.xxyz
          sample_l_indexable(texture2d)(float,float,float,float) r7.z, r9.yzyy, t2.yzxw, s0, l(0.000000)
          mad r9.y, -r7.z, l(999.000000), l(1000.000000)
          div r7.z, r7.z, r9.y
          ge r9.y, r7.z, l(10000000.000000)
          add r9.z, r8.z, l(1.000000)
          add r10.x, r0.z, -r7.z
          mul_sat r10.x, r2.y, |r10.x|
          lt r7.z, r9.w, r7.z
          and r9.w, r7.z, l(0x3f800000)
          movc r7.z, r7.z, l(-0.500000), l(0.500000)
          mad r7.z, r10.x, r7.z, r9.w
          add r7.z, r7.z, r8.z
          movc r8.z, r9.y, r9.z, r7.z
          iadd r8.w, r8.w, l(2)
          ige r9.x, l(1), r8.w
        endloop 
        mov r6.zw, r8.yyyz
