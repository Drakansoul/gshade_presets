...
dcl_output o0.xyzw
dcl_temps 6
mad r0.xy, -cb0[1].yyyy, l(0.000000, 0.007487, 0.000000, 0.000000), v1.xyxx
mad r0.zw, cb0[1].yyyy, l(0.000000, 0.000000, 0.000000, 0.001872), r0.xxxy
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.xyxx, t4.xyzw, s0
mad r0.xy, cb0[1].yyyy, l(0.000000, 0.001872, 0.000000, 0.000000), r0.zwzz
...
mad r0.xy, cb0[1].yyyy, l(0.000000, 0.001872, 0.000000, 0.000000), r0.xyxx
