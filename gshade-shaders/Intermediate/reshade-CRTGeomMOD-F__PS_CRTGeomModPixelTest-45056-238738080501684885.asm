...
if_nz cb0[14].z
  ...
  and r0.w, r1.y, r1.x
  ge r1.x, r0.x, l(1.796912)
  div r2.yw, l(0.000000, 3840.000000, 0.000000, 3840.000000), r0.xxxx
  mul r3.xz, r0.xxxx, l(2137.000000, 0.000000, 2137.000000, 0.000000)
  mov r2.xz, l(3840.000000,0,3840.000000,0)
  mov r3.yw, l(0,2137.000000,0,2137.000000)
  ...
  mad r1.xyzw, r1.xyzw, l(-0.500000, -0.500000, 0.000521, 0.000926), l(1920.000000, 1068.500000, 0.000000, 0.000000)
  movc r0.xyzw, r0.wwww, r1.xyzw, l(0,0,1.000000,1.000000)
  itof r1.xy, cb0[15].xyxx
  mad r1.xy, r1.xyxx, r0.zwzz, r0.xyxx
  mul r1.xy, r1.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000)
