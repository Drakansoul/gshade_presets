...
#line 459
if ((3840 * (1.0 / 2137))>1f) 
borderCoord.x = mad(borderCoord.x, (3840 * (1.0 / 2137)), 1f-(3840 * (1.0 / 2137)));
else if ((3840 * (1.0 / 2137))<1f) 
borderCoord.y = mad(borderCoord.y, (2137*(1.0 / 3840)), 1f-(2137*(1.0 / 3840)));
#line 464
...
#line 487
texCoord = (texCoord*2f-1f)*normalize(float2(3840, 2137));
#line 489
if (GridTilt!=0f) 
{
#line 492
...
#line 563
texCoord *= float2(3840, 2137)*ResScaleVirtual/float(ResScaleScreen);
texCoord = float2(
...
#line 649
const float2 viewProportions = normalize(float2(3840, 2137));
#line 651
