...
loop 
  breakc_z r3.x
  itof r3.y, r2.w
  mul r2.y, r3.y, l(0.002574)
  add r3.yz, r2.xxyx, v1.xxyx
  sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r3.yzyy, t28.xyzw, s0
  add r5.xyzw, -r0.xyzw, r4.xyzw
  dp4 r2.y, l(0.333000, 0.333000, 0.333000, 2500.000000), |r5.xyzw|
  dp2 r2.y, r2.yyyy, r1.xxxx
  min r2.y, r2.y, l(1.000000)
  add r2.y, -r2.y, l(1.000000)
  mad r1.yzw, r4.xxyz, r2.yyyy, r1.yyzw
  add r2.z, r2.y, r2.z
  iadd r2.w, r2.w, l(1)
  ige r3.x, l(1), r2.w
endloop 
div r0.xyz, r1.yzwy, r2.zzzz
add r1.xyzw, v1.xyxy, l(0.000260, 0.000000, 0.000000, 0.000468)
