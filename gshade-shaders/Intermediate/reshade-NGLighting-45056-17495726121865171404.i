...
#line 62
static const float2 pix = float2((1.0 / 3840), (1.0 / 2137));
#line 69
...
#line 85
texture texMotionVectors { Width = 3840; Height = 2137; Format = RG16F; };
...
#line 88
texture SSSR_ReflectionTex  { Width = 3840*0.67; Height = 2137*0.67; Format = RGBA16f; };
sampler sSSSR_ReflectionTex { Texture = SSSR_ReflectionTex; };
#line 91
texture SSSR_HitDistTex { Width = 3840*0.67; Height = 2137*0.67; Format = R16f; MipLevels = 7; };
sampler sSSSR_HitDistTex { Texture = SSSR_HitDistTex; };
#line 94
texture SSSR_POGColTex  { Width = 3840; Height = 2137; Format = R16f; };
sampler sSSSR_POGColTex { Texture = SSSR_POGColTex; };
#line 97
texture SSSR_FilterTex0  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_FilterTex0 { Texture = SSSR_FilterTex0; };
#line 100
texture SSSR_FilterTex1  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_FilterTex1 { Texture = SSSR_FilterTex1; };
#line 103
texture SSSR_FilterTex2  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_FilterTex2 { Texture = SSSR_FilterTex2; };
#line 106
texture SSSR_FilterTex3  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_FilterTex3 { Texture = SSSR_FilterTex3; };
#line 109
texture SSSR_PNormalTex  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_PNormalTex { Texture = SSSR_PNormalTex; };
#line 112
texture SSSR_NormTex  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_NormTex { Texture = SSSR_NormTex; };
#line 116
texture SSSR_NormTex1  { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sSSSR_NormTex1 { Texture = SSSR_NormTex1; };
#line 122
texture SSSR_LowResDepthTex  { Width = 3840*0.67*0.5; Height = 2137*0.67*0.5; Format = R16f; };
sampler sSSSR_LowResDepthTex { Texture = SSSR_LowResDepthTex; };
#line 125
texture SSSR_LowResNormTex  { Width = 3840*0.67*0.5; Height = 2137*0.67*0.5; Format = RGBA16f; };
sampler sSSSR_LowResNormTex { Texture = SSSR_LowResNormTex; };
#line 129
texture SSSR_HLTex0 { Width = 3840; Height = 2137; Format = R16f; };
sampler sSSSR_HLTex0 { Texture = SSSR_HLTex0; };
#line 132
texture SSSR_HLTex1 { Width = 3840; Height = 2137; Format = R16f; };
sampler sSSSR_HLTex1 { Texture = SSSR_HLTex1; };
#line 135
texture SSSR_RoughTex { Width = 3840; Height = 2137; Format = R8; };
...
float2 GetPixelSize()
{
float2 DepthSize = tex2Dsize(sTexDepth) / float2(3840, 2137);
...
{
float3 OutColor;
float2 seed = texcoord*float2(3840, 2137)+(Frame%HL)*5.588238;
OutColor.r = IGN(seed);
...
#line 755
Current = tex2Dcatrom(sSSSR_ReflectionTex, texcoord, float2(3840, 2137)*0.67).rgba;
...
float4 history = tex2Dcatrom(sSSSR_FilterTex2, texcoord +  MotionVectors, float2(3840, 2137));
#line 919
