...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\HQ4X.fx"
#line 4
uniform float s <
ui_type = "slider";
...
#line 37 "C:\Program Files\GShade\gshade-shaders\Shaders\HQ4X.fx"
#line 42
float3 PS_HQ4X(float4 pos : SV_Position, float2 uv : TexCoord) : SV_Target
{
const float x = s * (1.0 / 3840);
const float y = s * (1.0 / 2137);
#line 47
