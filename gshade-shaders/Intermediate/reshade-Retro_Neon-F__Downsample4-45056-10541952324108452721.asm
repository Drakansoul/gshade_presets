...
dcl_output o0.xyzw
dcl_temps 4
add r0.xyzw, v1.xyxy, l(0.008333, 0.014974, -0.008333, -0.014974)
...
add r1.xyzw, v1.xyxy, l(0.016667, 0.029949, -0.016667, -0.029949)
...
add r1.xyzw, v1.xyxy, l(0.016667, 0.000000, -0.016667, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t14.xyzw, s0, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t14.xyzw, s0, l(0.000000)
add r1.xyzw, r1.xyzw, r2.xyzw
add r2.xyzw, v1.xyxy, l(0.000000, 0.029949, 0.000000, -0.029949)
