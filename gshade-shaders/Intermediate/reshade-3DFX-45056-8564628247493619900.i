...
#line 6 "C:\Program Files\GShade\gshade-shaders\Shaders\3DFX.fx"
#line 7
...
#line 68
float2 res;
res.x = float2(3840, 2137).x;
res.y = float2(3840, 2137).y;
#line 72
...
float2 pixel;
#line 177
pixel.x = 1 / float2(3840, 2137).x;
pixel.y = 1 / float2(3840, 2137).y;
#line 180
