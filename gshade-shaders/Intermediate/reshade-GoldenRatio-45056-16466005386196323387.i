...
float idealWidth = 2137 * phiValue;
float idealHeight = 3840 / phiValue;
...
{
#line 87
sourceCoordFactor = float4(1.0, 2137/idealHeight, 1.0, idealHeight/2137);
}
else
{
#line 92
sourceCoordFactor = float4(3840/idealWidth, 1.0, idealWidth/3840, 1.0);
}
}
#line 96
