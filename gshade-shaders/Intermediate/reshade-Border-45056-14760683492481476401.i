...
if ((3840 * (1.0 / 2137)) < border_ratio)
border_width_variable = float2(0.0, (2137 - (3840 / border_ratio)) * 0.5);
else
border_width_variable = float2((3840 - (2137 * border_ratio)) * 0.5, 0.0);
#line 52
const float2 border = (float2((1.0 / 3840), (1.0 / 2137)) * border_width_variable); 
#line 54
