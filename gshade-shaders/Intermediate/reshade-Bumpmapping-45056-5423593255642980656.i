...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Bumpmapping.fx"
...
#line 22 "C:\Program Files\GShade\gshade-shaders\Shaders\Bumpmapping.fx"
#line 27
...
> = 0.75;
#line 68
texture SmoothTexture01 { Width = 3840; Height = 2137; Format = RGBA8; };
sampler Texture01S { Texture = SmoothTexture01; };
#line 72
static const float2 g10 = float2( 0.333,-1.0)*float2((1.0 / 3840), (1.0 / 2137));
static const float2 g01 = float2(-1.0,-0.333)*float2((1.0 / 3840), (1.0 / 2137));
static const float2 g12 = float2(-0.333, 1.0)*float2((1.0 / 3840), (1.0 / 2137));
static const float2 g21 = float2( 1.0, 0.333)*float2((1.0 / 3840), (1.0 / 2137));
#line 77
...
#line 101
const float2 inv_size = RANGE * float2((1.0 / 3840), (1.0 / 2137));
#line 103
