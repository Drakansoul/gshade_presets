...
dcl_output o0.xyzw
dcl_temps 10
add r0.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.004167, 0.000000)
...
add r2.xyzw, v1.xyxy, l(-0.008333, 0.000000, -0.004167, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.zwzz, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t6.xyzw, s0
add r4.xyzw, v1.xyxy, l(-0.016667, 0.000000, -0.012500, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t6.xyzw, s0
add r6.xyzw, v1.xyxy, l(-0.025000, -0.000000, -0.020833, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r6.xyxx, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.zwzz, t6.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.008333, 0.000000, 0.012500, 0.000000)
...
add r1.xyzw, v1.xyxy, l(0.016667, 0.000000, 0.020833, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t6.xyzw, s0
mad r0.xyzw, r2.xyzw, r9.zzzz, r0.xyzw
mad r0.xyzw, r1.xyzw, r9.yyyy, r0.xyzw
add r1.xy, v1.xyxx, l(0.025000, 0.000000, 0.000000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t6.xyzw, s0
