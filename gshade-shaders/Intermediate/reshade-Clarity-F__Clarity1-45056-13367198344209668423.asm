...
if_z cb0[0].x
  ...
  loop 
    breakc_z r1.w
    mul r2.w, cb0[0].y, icb[r0.w + 0].x
    mul r3.x, r2.w, l(0.000260)
...
if_nz r1.y
  ...
  loop 
    breakc_z r2.z
    mul r2.w, cb0[0].y, icb[r0.w + 4].x
    mul r2.x, r2.w, l(0.000260)
    ...
    add r2.xw, -r2.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t0.xyzw, s0, l(0.000000)
...
if_nz r1.z
  ...
  loop 
    breakc_z r1.w
    mul r2.z, cb0[0].y, icb[r0.w + 6].z
    mul r2.x, r2.z, l(0.000260)
...
if_nz r0.w
  ...
  loop 
    breakc_z r1.w
    mul r2.z, cb0[0].y, icb[r0.w + 15].x
    mul r2.x, r2.z, l(0.000260)
    add r2.zw, r2.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t0.xyzw, s0, l(0.000000)
