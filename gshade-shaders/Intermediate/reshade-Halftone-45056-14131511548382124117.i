...
#line 79
float2 scaledTexcoord = mul((texcoord) * float2(float(3840) / float(2137), 1), rot);
scaledTexcoord = (round(scaledTexcoord / scale)) * scale;
scaledTexcoord = mul(scaledTexcoord, transpose(rot)) / float2(float(3840) / float(2137), 1);
#line 83
...
#line 100
float2 fromCenter = (pixelCenter - dotCenter) * float2(float(3840) / float(2137), 1);
#line 102
...
#line 116
output = 0;
float2 rotatedCoord = mul(texcoord * float2(float(3840) / float(2137), 1), rotationMatrix(3.14159265/4)) / float2(float(3840) / float(2137), 1);
...
offset *= float2((1.0 / 3840), (1.0 / 2137));
