...
loop 
  breakc_z r3.y
  itof r3.z, r3.x
  mad r4.xyzw, r3.zzzz, l(0.000260, 0.000000, 0.000260, 0.000000), v1.xyxy
  sample_l_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t8.xyzw, s0, l(0.000000)
  ...
  if_nz cb0[0].z
    ...
    dp3 r1.x, r4.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
    mul r3.z, r1.x, l(0.100000)
  endif 
  imax r1.x, -r3.x, r3.x
  iadd r1.x, -r1.x, cb0[0].w
  itof r1.x, r1.x
  add r1.y, -r0.x, r3.z
  mad_sat r1.y, -r0.w, |r1.y|, l(1.000000)
  mul r3.z, r1.y, r1.x
  mad r2.xyzw, r5.xyzw, r3.zzzz, r2.xyzw
  mad r1.w, r1.x, r1.y, r1.w
  iadd r3.x, r3.x, l(1)
  ige r3.y, cb0[0].w, r3.x
endloop 
