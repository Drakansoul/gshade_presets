...
#line 121
float2 distortion = viewCoord*(rcp(1f+dot(K, pow_radius))-1f)/normalize(float2(3840, 2137))*0.5; 
#line 123
viewCoord = pixelPos.xy*float2((1.0 / 3840), (1.0 / 2137));
#line 125
uint evenSampleCount = min(ChromaticSamplesLimit-ChromaticSamplesLimit%2u, 128u); 
#line 127
uint totalPixelOffset = uint(ceil(length(distortion*float2(3840, 2137))));
#line 129
