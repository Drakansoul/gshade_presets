...
#line 29
texture TexRim { Width = 3840; Height = 2137; Format = RGBA16f; };
sampler sTexRim {Texture = TexRim; SRGBTexture = false;};
#line 32
texture TexHBlur { Width = 3840; Height = 2137; Format = RGBA16f; };
...
{
float3 p = float3(float2((1.0 / 3840), (1.0 / 2137)), 0.0);
float3 h;
float3 v;
#line 135
float3 Sample[6];
...
{
float2 p = float2((1.0 / 3840), (1.0 / 2137));;
