...
//   float iRingDOFSamples;             // Offset:   44 Size:     4
//   float iRingDOFRings;               // Offset:   48 Size:     4
//   float fRingDOFThreshold;           // Offset:   52 Size:     4
//   float fRingDOFGain;                // Offset:   56 Size:     4
//   float fRingDOFBias;                // Offset:   60 Size:     4
...
loop 
  breakc_z r4.x
  itof r4.y, r3.w
  mul r4.z, r4.y, cb0[2].w
  ftoi r4.w, r4.z
  ilt r5.x, l(0), r4.w
  round_z r4.z, r4.z
  div r4.z, l(6.283000), r4.z
  div r5.y, r4.y, cb0[3].x
  add r5.y, r5.y, l(-1.000000)
  mad r5.y, cb0[3].w, r5.y, l(1.000000)
  mov r6.xyz, r3.xyzx
  mov r5.z, r2.w
  mov r5.w, l(0)
  mov r6.w, r5.x
  loop 
    ...
    mov r8.y, r7.x
    mul r7.xy, r1.yyyy, r8.xyxx
    mul r7.xy, r4.yyyy, r7.xyxx
    mul r7.xy, r7.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000)
    div r7.xy, r7.xyxx, cb0[3].xxxx
    add r7.xy, r7.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r7.xyzw, r7.xyxx, t2.xyzw, s0, l(0.000000)
    dp3 r8.x, r7.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
    add r8.x, r8.x, -cb0[3].y
    mul r8.x, r8.x, cb0[3].z
    ...
    mul r7.w, |r7.w|, |r7.w|
    mul r7.w, r7.w, r7.w
    movc r7.w, r8.x, l(1.000000), r7.w
    mul r8.x, r5.y, r7.w
    mad r6.xyz, r7.xyzx, r8.xxxx, r6.xyzx
    mad r5.z, r7.w, r5.y, r5.z
    iadd r5.w, r5.w, l(1)
    ilt r6.w, r5.w, r4.w
  endloop 
  mov r3.xyz, r6.xyzx
  ...
  iadd r3.w, r3.w, l(1)
  itof r4.y, r3.w
  ge r4.x, cb0[3].x, r4.y
endloop 
div r1.xzw, r3.xxyz, r2.wwww
