...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\HighPassSharpen.fx"
#line 7
...
#line 64 "C:\Program Files\GShade\gshade-shaders\Shaders\HighPassSharpen.fx"
#line 65
...
[loop]
for(int i = 1; i < 5; ++i) {
color += tex2Dlod(ReShade::BackBuffer, float4(texcoord + float2(sampleOffsetsX[i] * (1.0 / 3840), sampleOffsetsY[i] * (1.0 / 2137)) * HighPassSharpOffset, 0.0, 0.0)).rgb * sampleWeights[i];
color += tex2Dlod(ReShade::BackBuffer, float4(texcoord - float2(sampleOffsetsX[i] * (1.0 / 3840), sampleOffsetsY[i] * (1.0 / 2137)) * HighPassSharpOffset, 0.0, 0.0)).rgb * sampleWeights[i];
}
}
#line 88
