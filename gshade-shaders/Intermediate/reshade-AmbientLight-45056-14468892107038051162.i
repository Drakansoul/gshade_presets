...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\AmbientLight.fx"
#line 33
...
#line 108 "C:\Program Files\GShade\gshade-shaders\Shaders\AmbientLight.fx"
#line 133
uniform float2 AL_t < source = "pingpong"; min = 0.0f; max = 6.28f; step = float2(0.1f, 0.2f); >;
#line 137
texture alInTex  { Width = 3840 / 16; Height = 2137 / 16; Format = RGBA32F; };
texture alOutTex { Width = 3840 / 16; Height = 2137 / 16; Format = RGBA32F; };
...
#line 252
[flatten]
if ((texcoord.x + sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) < 1.05)
hgb += tex2D(alInColor, texcoord + float2(sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[1] * stepMult;
[flatten]
if ((texcoord.x - sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) > -0.05)
hgb += tex2D(alInColor, texcoord - float2(sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[1] * stepMult;
#line 259
[flatten]
if ((texcoord.x + sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) < 1.05)
hgb += tex2D(alInColor, texcoord + float2(sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[2] * stepMult;
[flatten]
if ((texcoord.x - sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) > -0.05)
hgb += tex2D(alInColor, texcoord - float2(sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[2] * stepMult;
#line 266
[flatten]
if ((texcoord.x + sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) < 1.05)
hgb += tex2D(alInColor, texcoord + float2(sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[3] * stepMult;
[flatten]
if ((texcoord.x - sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) > -0.05)
hgb += tex2D(alInColor, texcoord - float2(sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[3] * stepMult;
#line 273
[flatten]
if ((texcoord.x + sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) < 1.05)
hgb += tex2D(alInColor, texcoord + float2(sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[4] * stepMult;
[flatten]
if ((texcoord.x - sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x) > -0.05)
hgb += tex2D(alInColor, texcoord - float2(sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).x, 0.0)) * sampleWeights[4] * stepMult;
}
...
#line 289
[flatten]
if ((texcoord.y + sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) < 1.05)
vgb += tex2D(alOutColor, texcoord + float2(0.0, sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[1] * stepMult;
[flatten]
if ((texcoord.y - sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) > -0.05)
vgb += tex2D(alOutColor, texcoord - float2(0.0, sampleOffsets[1] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[1] * stepMult;
#line 296
[flatten]
if ((texcoord.y + sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) < 1.05)
vgb += tex2D(alOutColor, texcoord + float2(0.0, sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[2] * stepMult;
[flatten]
if ((texcoord.y - sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) > -0.05)
vgb += tex2D(alOutColor, texcoord - float2(0.0, sampleOffsets[2] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[2] * stepMult;
#line 303
[flatten]
if ((texcoord.y + sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) < 1.05)
vgb += tex2D(alOutColor, texcoord + float2(0.0, sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[3] * stepMult;
[flatten]
if ((texcoord.y - sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) > -0.05)
vgb += tex2D(alOutColor, texcoord - float2(0.0, sampleOffsets[3] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[3] * stepMult;
#line 310
[flatten]
if ((texcoord.y + sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) < 1.05)
vgb += tex2D(alOutColor, texcoord + float2(0.0, sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[4] * stepMult;
[flatten]
if ((texcoord.y - sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y) > -0.05)
vgb += tex2D(alOutColor, texcoord - float2(0.0, sampleOffsets[4] * float2(1.0f / (3840 / 16.0f), 1.0f / (2137 / 16.0f)).y)) * sampleWeights[4] * stepMult;
}
#line 318
...
dither = lerp(2.0 * dither, -2.0 * dither, frac(dot(texcoord, float2(3840, 2137) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
}
#line 458
if (all(base.xyz == 1.0))
{
