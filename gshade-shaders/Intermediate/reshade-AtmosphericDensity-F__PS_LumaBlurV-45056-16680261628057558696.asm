...
if_nz r0.y
  ...
  if_z r0.z
    ...
    loop 
      breakc_z r1.z
      itof r1.w, r0.z
      mad r2.x, r1.w, l(0.000468), v1.y
      lt r2.x, l(0.575000), r2.x
      mad r1.w, -r1.w, l(0.000468), v1.y
      lt r1.w, r1.w, l(0.425000)
      or r1.w, r1.w, r2.x
      if_nz r1.w
        iadd r1.w, r0.z, l(1)
        ilt r1.z, r1.w, l(18)
      ...
      mov r1.w, x0[r0.z + 0].x
      mul r1.y, r1.w, l(0.000468)
      add r2.xy, r1.xyxx, v1.xyxx
      sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t12.xyzw, s1, l(0.000000)
      mov r2.y, x1[r0.z + 0].x
      mad r2.x, r2.x, r2.y, r0.w
      add r1.yw, -r1.xxxy, v1.xxxy
      sample_l_indexable(texture2d)(float,float,float,float) r1.y, r1.ywyy, t12.yxzw, s1, l(0.000000)
      mad r0.w, r1.y, r2.y, r2.x
      iadd r0.z, r0.z, l(1)
      ilt r1.z, r0.z, l(18)
    endloop 
  endif 
