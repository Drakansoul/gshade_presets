...
#line 2 "C:\Program Files\GShade\gshade-shaders\Shaders\dh_undither.fx"
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\DH.fxh"
#line 21
namespace DH
{
#line 25
...
return getWorldPosition(coords, depth, int3(3840, 2137, 1000.0));
}
#line 88
float3 getWorldPosition(float3 coords) {
return getWorldPosition(coords.xy, coords.z, int3(3840, 2137, 1000.0));
}
#line 92
...
#line 3 "C:\Program Files\GShade\gshade-shaders\Shaders\dh_undither.fx"
#line 4
namespace DH {
#line 8
uniform int iPS <
