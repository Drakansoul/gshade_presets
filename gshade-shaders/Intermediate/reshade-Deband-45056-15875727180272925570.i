...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Deband.fx"
...
#line 61 "C:\Program Files\GShade\gshade-shaders\Shaders\Deband.fx"
#line 62
...
dist = rand(h) * range * i;
pt = dist * float2((1.0 / 3840), (1.0 / 2137));
#line 178
h = permute(h);
}
#line 182
...
#line 231
const float grid_position = frac(dot(texcoord, (float2(3840, 2137) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 234
