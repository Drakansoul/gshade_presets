...
loop 
  breakc_z r1.w
  itof r2.z, r1.z
  mul r2.x, r2.z, l(0.000651)
  add r2.xz, r2.xxyx, v1.xxyx
  sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r2.xzxx, t8.xyzw, s0
  add r5.xyzw, -r0.xyzw, r4.xyzw
  dp4 r2.x, l(0.333000, 0.333000, 0.333000, 500.000000), |r5.xyzw|
  mul r2.x, r1.x, r2.x
