...
mad r1.xy, r0.zwzz, l(0.572211, 1.028213, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
ne r1.z, cb0[2].z, l(0.000000)
and r0.y, r0.y, r1.z
and r0.x, r0.x, r0.y
if_nz r0.x
  add r0.xy, v0.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  mul r1.zw, r0.xxxy, l(0.000000, 0.000000, 0.000260, 0.000468)
  mad r0.xy, -r0.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000), r1.xyxx
  and r2.x, cb0[9].w, l(1)
  iadd r2.x, -r2.x, cb0[9].w
  utof r2.x, r2.x
  min r2.x, r2.x, l(64.000000)
  mul r2.yz, r0.xxyx, cb0[2].zzzz
  mul r2.yz, r2.yyzy, l(0.000000, 3840.000000, 2137.000000, 0.000000)
  ...
  loop 
    ...
    mad r4.z, cb0[2].z, r4.z, l(1.000000)
    mad r4.zw, r4.zzzz, r0.xxxy, r1.zzzw
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r4.zwzz, t1.xyzw, s2, l(0.000000)
    div r4.y, r4.y, r2.w
    mad r4.yzw, r4.yyyy, l(0.000000, 4.000000, 4.000000, 4.000000), l(0.000000, -3.500000, -1.000000, -2.000000)
    add_sat r6.yz, -|r4.zzwz|, l(0.000000, 1.500000, 1.500000, 0.000000)
    mov_sat r4.y, r4.y
    add r6.x, r4.y, r6.y
...
if_z cb0[0].x
  mul r0.xy, r1.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000)
  deriv_rtx_coarse r0.x, r0.x
  deriv_rty_coarse r0.y, r0.y
  mul r0.x, r0.y, r0.x
  movc r0.x, cb0[2].y, r0.x, l(1.000000)
  mul r0.yz, r0.zzwz, l(0.000000, 1.144423, 2.056427, 0.000000)
  ftou r1.xy, v0.xyxx
  mov r1.zw, l(0,0,0,0)
  ...
  if_nz r0.y
    ...
    mad r3.z, r3.x, l(1.796911), l(-0.796911)
  ...
  if_nz r0.y
    ...
    mad r3.w, r3.x, l(1.796911), l(-0.796911)
