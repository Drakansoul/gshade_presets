...
//   float feedbackAmount;              // Offset:  208 Size:     4
//   float feedbackFade;                // Offset:  212 Size:     4
//   float feedbackThresh;              // Offset:  216 Size:     4
//   float3 feedbackColor;              // Offset:  224 Size:    12
...
mad r0.xyz, -r0.xyzx, l(0.333333, 0.333333, 0.333333, 0.000000), l(1.000000, 1.000000, 1.000000, 0.000000)
...
lt r1.w, r0.w, cb0[13].z
movc r0.w, r1.w, l(0), r0.w
mul r1.xyz, r0.wwww, r1.xyzx
mad r1.xyz, -r1.xyzx, cb0[13].xxxx, l(1.000000, 1.000000, 1.000000, 0.000000)
mad r0.xyz, -r1.xyzx, r0.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mul o1.xyz, r0.xyzx, cb0[14].xyzx
mov o1.w, l(1.000000)
ret 
