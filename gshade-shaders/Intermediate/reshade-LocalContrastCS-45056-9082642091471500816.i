...
texture Luma <Pooled = true;>{Width = 3840; Height = 2137; Format = R8;};
texture Blur0 <Pooled = true;>{Width = 3840 * 2; Height = 2137; Format = R8;};
#line 46
...
if(i <= 0)
{
tex2Dstore(wBlur0, int2(3840 + coord.x + i, coord.y), prev.xxxx);
}
}
}
}
...
if(i <= 0)
{
tex2Dstore(wBlur0, int2(3840 + coord.x, coord.y + i), prev.xxxx);
}
}
}
}
