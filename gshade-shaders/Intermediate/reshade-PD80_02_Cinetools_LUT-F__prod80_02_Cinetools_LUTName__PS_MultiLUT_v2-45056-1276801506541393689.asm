...
// __V__prod80_02_Cinetools_LUTName__prod80_02_Cinetools_LUTTex    texture  float4          2d            t10      1 
...
dcl_output o0.xyzw
dcl_temps 6
mul r0.xy, v1.xyxx, l(7.500000, 4.173828, 0.000000, 0.000000)
...
mul r4.xy, r4.xyxx, l(0.000244, 0.000504, 0.000000, 0.000000)
mad r5.x, r2.w, l(0.015625), r4.x
add r5.z, r5.x, l(0.015625)
itof r2.w, cb0[1].x
mad r5.y, r2.w, l(0.032258), r4.y
