...
#line 1 "C:\Program Files\GShade\gshade-shaders\ComputeShaders\computeGravity.fx"
#line 28
...
#line 141 "C:\Program Files\GShade\gshade-shaders\ComputeShaders\computeGravity.fx"
#line 161
texture texGravitySeedMap{ Width = 3840/1; Height = 768; Format = R16F; };
texture texGravitySeedMapCopy{ Width = 3840/1; Height = 768; Format = R16F; };
...
texture texGravityMain{ Width = 3840/1; Height = 768; Format = RGBA8; };
texture texGravityDepth{ Width = 3840/1; Height = 768; Format = R32F; };
#line 172
...
#line 295
finalist[y] = y;
depthlist[y] = depthlistU[y] = ReShade::GetLinearizedDepth(float2((id.x*1 + 0.5) / 3840, (y * 2137/768 + 0.5) / 2137));
}
...
#line 304
float4 rgbval =  tex2Dfetch(ReShade::BackBuffer, int2(id.x*1, yi*2137/768)); 
float scenedepth = depthlist[yi]; 
float strength = tex2Dfetch(SamplerGravitySeedMap, int2(id.x, yi)).r; 
strength = strength * GravityIntensity * inFocus(rgbval, scenedepth, float2((id.x*1 + 0.5) / 3840, (yi * 2137/768 + 0.5) / 2137)); 
...
{
if (y != finalist[y]) {
float4 storeVal = tex2Dfetch(ReShade::BackBuffer, int2(id.x, finalist[y] * 2137/768)); 
...
pass GravityMain { ComputeShader = gravityMain<1, 1>; DispatchSizeX = 3840/1; DispatchSizeY = 1; }
