...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\ReflectiveBumpMapping.fx"
#line 11
...
#line 101 "C:\Program Files\GShade\gshade-shaders\Shaders\ReflectiveBumpMapping.fx"
#line 105
...
const float2 offs = float2((1.0 / 3840), (1.0 / 2137))*1.0;
...
const float3 TextureNormals 		= GetNormalFromColor(texcoord.xy, 0.01 * float2((1.0 / 3840), (1.0 / 2137)) / scenedepth, 0.0002 / scenedepth + 0.1, 1000.0);
...
{
const float2 currentOffset 	= texcoord.xy + SceneNormals.xy * float2((1.0 / 3840), (1.0 / 2137)) * i/(float)iRBM_SampleCount * fRBM_BlurWidthPixels;
