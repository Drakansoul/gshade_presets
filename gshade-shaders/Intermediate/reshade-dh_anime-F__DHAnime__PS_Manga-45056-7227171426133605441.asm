...
if_nz r0.x
  ineg r0.x, cb0[0].x
  ige r0.y, cb0[0].x, r0.x
  imul null, r0.z, cb0[0].x, cb0[0].x
  itof r0.z, r0.z
  ...
  loop 
    ...
    loop 
      ...
      ge r2.w, r0.z, r2.w
      if_nz r2.w
        mad r3.yz, r3.xxyx, l(0.000000, 0.000260, 0.000468, 0.000000), v1.xxyx
        ...
        div r2.w, r0.w, r2.w
        ge r2.w, cb0[0].y, r2.w
        mad r3.yzw, r1.xxyz, l(0.000000, 2.000000, 2.000000, 2.000000), -r3.yyzw
        lt r3.yzw, l(0.000000, 0.100000, 0.100000, 0.100000), |r3.yyzw|
        or r3.y, r3.z, r3.y
        or r3.y, r3.w, r3.y
        and r2.w, r2.w, r3.y
        if_nz r2.w
      ...
      iadd r2.y, r2.y, l(1)
      ige r2.z, cb0[0].x, r2.y
    endloop 
    iadd r1.w, r1.w, l(1)
    ige r2.x, cb0[0].x, r1.w
  endloop 
endif 
