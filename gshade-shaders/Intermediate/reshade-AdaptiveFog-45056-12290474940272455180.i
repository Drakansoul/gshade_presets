...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\AdaptiveFog.fx"
#line 14
...
#line 61 "C:\Program Files\GShade\gshade-shaders\Shaders\AdaptiveFog.fx"
#line 69
texture   Otis_BloomTarget < pooled = true; > { Width = 3840; Height = 2137; Format = RGBA8;};
#line 74
...
const float2 blurtempvalue = texcoord * float2((1.0 / 3840), (1.0 / 2137)) * BloomWidth;
