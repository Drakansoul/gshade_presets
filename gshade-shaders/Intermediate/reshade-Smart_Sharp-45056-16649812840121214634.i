...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Smart_Sharp.fx"
#line 60
...
{
#line 255
const float Up = LI(BB(texcoord, float2( 0,-float2((1.0 / 3840), (1.0 / 2137)).y)));
const float Left = LI(BB(texcoord, float2(-float2((1.0 / 3840), (1.0 / 2137)).x, 0)));
const float Center = LI(BB(texcoord, 0));
const float Right = LI(BB(texcoord, float2( float2((1.0 / 3840), (1.0 / 2137)).x, 0)));
const float Down = LI(BB(texcoord, float2( 0, float2((1.0 / 3840), (1.0 / 2137)).y)));
#line 261
