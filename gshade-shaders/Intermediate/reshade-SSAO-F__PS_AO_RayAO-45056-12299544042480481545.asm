...
if_nz r0.w
  ...
  ilt r0.w, l(0), cb0[3].w
  div r1.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[4].y
  mov r2.w, l(0)
  mov r3.x, l(0)
  mov r3.y, r0.w
  loop 
    breakc_z r3.y
    dp3 r3.z, icb[r3.x + 0].zxyz, r2.xyzx
    add r3.z, r3.z, r3.z
    mad r4.xyz, r2.xyzx, -r3.zzzz, icb[r3.x + 0].zxyz
    dp3 r3.z, r1.zxyz, r4.xyzx
    lt r3.w, l(0.000000), r3.z
    lt r3.z, r3.z, l(0.000000)
    iadd r3.z, -r3.w, r3.z
    itof r3.z, r3.z
    mul r4.xyz, r3.zzzz, r4.xyzx
    mul r3.zw, r4.yyyz, cb0[4].xxxx
    mad r4.x, -r4.x, cb0[4].x, r0.z
    div r3.zw, r3.zzzw, r0.zzzz
    add_sat r3.zw, r0.xxxy, r3.zzzw
    ...
    mul_sat r3.w, r1.w, r3.z
    mad r4.x, r3.w, l(-2.000000), l(3.000000)
    mul r3.w, r3.w, r3.w
    mad r3.w, -r4.x, r3.w, l(1.000000)
    mul r4.x, r3.w, r3.z
    lt r4.y, cb0[4].z, r4.x
    lt r4.x, r4.x, cb0[4].y
    and r4.x, r4.x, r4.y
    mad r3.z, -r3.z, r3.w, l(1.000000)
    log r3.z, r3.z
    mul r3.z, r3.z, l(2.500000)
    exp r3.z, r3.z
    add r3.z, r2.w, r3.z
    movc r2.w, r4.x, r3.z, r2.w
    iadd r3.x, r3.x, l(1)
    ilt r3.y, r3.x, cb0[3].w
  endloop 
  itof r0.x, cb0[3].w
  div r0.x, r2.w, r0.x
