...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\MagicBloom.fx"
...
#line 67 "C:\Program Files\GShade\gshade-shaders\Shaders\MagicBloom.fx"
#line 98
...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 3840 / 2; Height = 2137 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 3840 / 4; Height = 2137 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 3840 / 8; Height = 2137 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 3840 / 16; Height = 2137 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 3840 / 32; Height = 2137 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 3840 / 64; Height = 2137 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 3840 / 128; Height = 2137 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 3840 / 256; Height = 2137 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 3840; Height = 2137; };
#line 269
...
float2 ps = float2((1.0 / 3840), (1.0 / 2137)) * scale;
#line 303
