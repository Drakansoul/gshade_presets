...
//   float GaussianBlurStrength;        // Offset:    8 Size:     4
//
// }
//
//
...
// __V__GaussianBlurTex              texture  float4          2d             t4      1 
...
if_z cb0[0].x
  ...
  loop 
    breakc_z r1.w
    mul r3.y, cb0[0].y, icb[r0.w + 0].x
    mad r3.zw, r3.xxxy, l(0.000000, 0.000000, 0.000000, 0.000468), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r3.zwzz, t4.xyzw, s0, l(0.000000)
    mad r4.xyz, r4.xyzx, icb[r0.w + 0].yyyy, r0.xyzx
    mad r3.yz, -r3.xxyx, l(0.000000, 0.000000, 0.000468, 0.000000), v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r3.yzw, r3.yzyy, t4.wxyz, s0, l(0.000000)
...
if_nz r1.x
  ...
  loop 
    breakc_z r1.x
    mul r3.y, cb0[0].y, icb[r0.w + 0].z
    mad r3.zw, r3.xxxy, l(0.000000, 0.000000, 0.000000, 0.000468), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r3.zwzz, t4.xyzw, s0, l(0.000000)
    mad r4.xyz, r4.xyzx, icb[r0.w + 0].wwww, r0.xyzx
    mad r3.yz, -r3.xxyx, l(0.000000, 0.000000, 0.000468, 0.000000), v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r3.yzw, r3.yzyy, t4.wxyz, s0, l(0.000000)
    mad r0.xyz, r3.yzwy, icb[r0.w + 0].wwww, r4.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r1.x, r0.w, l(6)
  endloop 
endif 
if_nz r1.y
  ...
  loop 
    breakc_z r2.z
    mul r2.y, cb0[0].y, icb[r0.w + 4].x
    mad r3.xy, r2.xyxx, l(0.000000, 0.000468, 0.000000, 0.000000), v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t4.xyzw, s0, l(0.000000)
    mad r3.xyz, r3.xyzx, icb[r0.w + 4].yyyy, r0.xyzx
    mad r2.yw, -r2.xxxy, l(0.000000, 0.000000, 0.000000, 0.000468), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r2.ywyy, t4.xyzw, s0, l(0.000000)
    mad r0.xyz, r4.xyzx, icb[r0.w + 4].yyyy, r3.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r2.z, r0.w, l(11)
  endloop 
endif 
if_nz r1.z
  ...
  loop 
    breakc_z r1.w
    mul r2.y, cb0[0].y, icb[r0.w + 6].z
    mad r2.zw, r2.xxxy, l(0.000000, 0.000000, 0.000000, 0.000468), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t4.xyzw, s0, l(0.000000)
    ...
    mad r0.xyz, r2.yzwy, icb[r0.w + 6].wwww, r3.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r1.w, r0.w, l(15)
  endloop 
endif 
...
if_nz r0.w
  ...
  loop 
    breakc_z r1.w
    mul r2.y, cb0[0].y, icb[r0.w + 15].x
    mad r2.zw, r2.xxxy, l(0.000000, 0.000000, 0.000000, 0.000468), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t4.xyzw, s0, l(0.000000)
    mad r3.xyz, r3.xyzx, icb[r0.w + 15].yyyy, r0.xyzx
    mad r2.yz, -r2.xxyx, l(0.000000, 0.000000, 0.000468, 0.000000), v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r2.yzw, r2.yzyy, t4.wxyz, s0, l(0.000000)
    mad r0.xyz, r2.yzwy, icb[r0.w + 15].yyyy, r3.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r1.w, r0.w, l(18)
  endloop 
endif 
...
mad_sat o0.xyz, cb0[0].zzzz, r0.xyzx, r1.xyzx
ret 
