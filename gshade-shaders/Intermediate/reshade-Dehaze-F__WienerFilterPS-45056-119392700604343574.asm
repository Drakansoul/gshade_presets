...
sample_l_indexable(texture2d)(float,float,float,float) r0.w, v1.xyxx, t8.yzwx, s0, l(8.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, v1.xyxx, t4.xyzw, s0
min r1.w, r1.y, r1.x
min r1.w, r1.z, r1.w
sample_l_indexable(texture2d)(float,float,float,float) r2.x, v1.xyxx, t6.xyzw, s0, l(8.000000)
max r2.y, r1.y, r1.x
max r2.y, r1.z, r2.y
...
add r2.z, r2.w, r2.z
sample_l_indexable(texture2d)(float,float,float,float) r2.w, v1.xyxx, t14.yzwx, s0, l(8.000000)
add r2.z, r2.w, r2.z
