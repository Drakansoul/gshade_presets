...
switch cb0[1].z
  ...
  add r3.xyzw, r1.xyxy, l(0.500000, 0.500000, 0.500000, 64.500000)
  min r0.zw, r3.zzzw, l(0.000000, 0.000000, 3839.000000, 2136.000000)
  ftoi r4.xy, r0.zwzz
  mov r4.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyzw, t2.xyzw
  ...
  loop 
    ...
    ftoi r5.xy, r1.zwzz
    ld_indexable(texture2d)(float,float,float,float) r6.xyzw, r5.xyzw, t2.xyzw
    ...
    if_nz r1.z
      ...
      min r1.y, r1.z, r1.y
      min r1.y, r1.w, r1.y
      lt r1.y, l(8.000000), r1.y
      and r8.w, r1.y, l(0x3f800000)
      movc r1.y, r1.y, l(8.000000), l(1.000000)
      mov r7.z, r5.x
      mov r7.w, r6.x
      mul r8.xyz, r1.yyyy, r7.xzwx
      store_uav_typed u1.xyzw, r4.xyzw, r8.xyzw
    endif 
    iadd r0.z, r0.z, l(-1)
    ilt r0.w, l(-256), r0.z
  endloop 
  ...
  add r3.y, r0.x, l(-3.000000)
  div r0.xy, r3.xyxx, r0.zzzz
  add r3.xyzw, r1.xyxy, l(0.500000, 0.500000, 0.500000, 128.500000)
  min r0.zw, r3.zzzw, l(0.000000, 0.000000, 3839.000000, 2136.000000)
  ftoi r4.xy, r0.zwzz
  mov r4.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyzw, t2.xyzw
  ...
  add r3.y, r0.x, l(-3.000000)
  div r0.xy, r3.xyxx, r0.zzzz
  add r3.xyzw, r1.xyxy, l(0.500000, 0.500000, 0.500000, 512.500000)
  min r0.zw, r3.zzzw, l(0.000000, 0.000000, 3839.000000, 2136.000000)
  ftoi r4.xy, r0.zwzz
  mov r4.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyzw, t2.xyzw
  ...
  add r3.y, r0.x, l(-3.000000)
  div r0.xy, r3.xyxx, r0.zzzz
  add r3.xyzw, r1.xyxy, l(0.500000, 0.500000, 0.500000, 256.500000)
  min r0.zw, r3.zzzw, l(0.000000, 0.000000, 3839.000000, 2136.000000)
  ftoi r4.xy, r0.zwzz
  mov r4.zw, l(0,0,0,0)
  ld_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyzw, t2.xyzw
