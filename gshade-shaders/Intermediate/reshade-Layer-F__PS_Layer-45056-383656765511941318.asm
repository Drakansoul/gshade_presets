...
// {
//
//   int Layer_Quantity;                // Offset:    0 Size:     4 [unused]
...
// __V__Layer_Texture                texture  float4          2d             t4      1 
...
mul r0.xy, r0.xyxx, l(-0.796912, 0.443490, 0.000000, 0.000000)
switch cb0[2].x
  case l(1)
  mov r0.z, l(-1.570796)
  break 
...
mul r1.x, r1.x, l(-0.796911)
sincos r0.z, null, -r0.z
mul r1.w, r0.z, l(0.443490)
mul r1.yz, r2.xxxx, l(0.000000, -0.796911, 0.443490, 0.000000)
mov r2.xz, v1.xxyx
