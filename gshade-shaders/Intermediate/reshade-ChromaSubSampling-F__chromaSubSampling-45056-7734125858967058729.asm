...
if_z cb0[0].x
  add r1.xy, v1.xyxx, l(0.000260, 0.000000, 0.000000, 0.000000)
  ...
  if_nz r0.w
    ...
    add r2.zw, v1.xxxy, l(0.000000, 0.000000, 0.000000, 0.000468)
    ...
    if_nz r0.w
      add r2.xyzw, v1.xyxy, l(0.000260, 0.000000, 0.000521, 0.000000)
      ...
      add r3.xy, v1.xyxx, l(0.000781, 0.000000, 0.000000, 0.000000)
      sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t4.xyzw, s0
      add r1.xyz, r2.xyzx, r3.xyzx
    else 
      add r2.xyzw, v1.xxyy, l(0.000260, -0.000260, 0.000468, -0.000468)
      add r3.xyzw, v1.xyxy, l(0.000260, 0.000000, -0.000260, 0.000000)
      ...
      add r3.xyzw, v1.xyxy, l(0.000000, 0.000468, 0.000000, -0.000468)
      sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t4.xyzw, s0
      add r0.xyz, r0.xyzx, r4.xyzx
      sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.zwzz, t4.xyzw, s0
      add r0.xyz, r0.xyzx, r3.xyzx
