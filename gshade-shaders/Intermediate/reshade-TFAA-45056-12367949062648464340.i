...
texture texInCurBackup < pooled = true; > { Width = 3840; Height = 2137; Format = RGBA8; };
#line 43
texture texExpColor < pooled = true; > { Width = 3840; Height = 2137; Format = RGBA16F; };
texture texExpColorBackup { Width = 3840; Height = 2137; Format = RGBA16F; };
#line 46
texture texDepthBackup < pooled = true; > { Width = 3840; Height = 2137; Format = R16f; };
#line 49
...
#line 59
texture texMotionVectors < pooled = false; > { Width = 3840; Height = 2137; Format = RG16F; };
