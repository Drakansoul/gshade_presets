...
#line 31
OneBitLumaShift = ceil(1.0 - step(dot(tex2Dlod(ReShade::BackBuffer, float4(texcoord.x + (1.0 / 3840), texcoord.y, 0.0, 0.0)).rgb, 1.0 / 3.0), i));
lines += OneBitLumaShift - OneBitLuma;
#line 34
OneBitLumaShift = ceil(1.0 - step(dot(tex2Dlod(ReShade::BackBuffer, float4(texcoord.x - (1.0 / 3840), texcoord.y, 0.0, 0.0)).rgb, 1.0 / 3.0), i));
lines += OneBitLumaShift - OneBitLuma;
#line 37
OneBitLumaShift = ceil(1.0 - step(dot(tex2Dlod(ReShade::BackBuffer, float4(texcoord.x, texcoord.y + (1.0 / 2137), 0.0, 0.0)).rgb, 1.0 / 3.0), i));
lines += OneBitLumaShift - OneBitLuma;
#line 40
OneBitLumaShift = ceil(1.0 - step(dot(tex2Dlod(ReShade::BackBuffer, float4(texcoord.x, texcoord.y - (1.0 / 2137), 0.0, 0.0)).rgb, 1.0 / 3.0), i));
lines += OneBitLumaShift - OneBitLuma;
