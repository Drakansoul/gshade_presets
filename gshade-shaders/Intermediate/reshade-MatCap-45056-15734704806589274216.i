...
static const float2 offset = float2((1.0 / 3840), 0.0); 
return (get_depth(uv + offset) - get_depth(uv - offset)) * 3840 * 0.5;
}
#line 33
float get_depth_ddy(float2 uv) {
static const float2 offset = float2(0.0, (1.0 / 2137)); 
return (get_depth(uv - offset) - get_depth(uv + offset)) * 2137 * 0.5;
}
#line 38
