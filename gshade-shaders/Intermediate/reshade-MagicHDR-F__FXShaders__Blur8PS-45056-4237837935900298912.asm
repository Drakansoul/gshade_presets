...
dcl_output o0.xyzw
dcl_temps 10
add r0.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.016667, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.xyxx, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.zwzz, t10.xyzw, s0
add r2.xyzw, v1.xyxy, l(-0.033333, 0.000000, -0.016667, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.zwzz, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t10.xyzw, s0
add r4.xyzw, v1.xyxy, l(-0.066667, 0.000000, -0.050000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t10.xyzw, s0
add r6.xyzw, v1.xyxy, l(-0.100000, -0.000000, -0.083333, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r6.xyxx, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.zwzz, t10.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(0.033333, 0.000000, 0.050000, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t10.xyzw, s0
mad r0.xyzw, r2.xyzw, r8.xxxx, r0.xyzw
mad r0.xyzw, r1.xyzw, r9.wwww, r0.xyzw
add r1.xyzw, v1.xyxy, l(0.066667, 0.000000, 0.083333, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t10.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t10.xyzw, s0
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t10.xyzw, s0
