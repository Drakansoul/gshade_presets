...
#line 31
texture2D FogTex { Width = 3840;   Height = 2137;   Format = RGBA8;};
sampler2D sFogTex { Texture = FogTex;};
#line 34
texture2D BlurTex 	{ Width = 3840;   Height = 2137;   Format = RGBA8; MipLevels = 2+1; };
...
{
float depth = ReShade::GetLinearizedDepth(texcoord);
float2 p = float2((1.0 / 3840), (1.0 / 2137));; p *= pow(2, 2);
#line 198
