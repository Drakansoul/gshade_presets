...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\BIAA.fx"
#line 20
...
const float2 Offset = float2((1.0 / 3840), (1.0 / 2137));
const float2 X = float2(float2((1.0 / 3840), (1.0 / 2137)).x, 0.0), Y = float2(0.0, float2((1.0 / 3840), (1.0 / 2137)).y);
#line 94
