...
#line 144
viewCoord.x = (texCoord.x =   vertexPos.x = vertexPosList[vertexId].x)*(3840 * (1.0 / 2137));
...
#line 160
uint blurPixelCount = uint(ceil(blurRadius*2137));
#line 162
...
float2x2(-rotationMtx[0]*(3840 * (1.0 / 2137)), rotationMtx[1]), 
float2(0f, BlurOffset) 
);
#line 251
const float2x2 pixelRoationMtx = rotationMtx*2137*0.5; 
#line 254
