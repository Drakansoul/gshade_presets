...
loop 
  ...
  loop 
    ...
    mul r2.w, icb[r4.x + 0].x, icb[r1.y + 0].x
    itof r2.y, r1.w
    mad r4.xz, r2.xxyx, l(0.033333, 0.000000, 0.059897, 0.000000), v1.xxyx
    sample_indexable(texture2d)(float,float,float,float) r4.xzw, r4.xzxx, t16.xwyz, s0
