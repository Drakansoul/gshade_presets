...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Bloom.fx"
#line 4
...
#line 246 "C:\Program Files\GShade\gshade-shaders\Shaders\Bloom.fx"
#line 254
...
{
#line 290
float axis = float2((1.0 / 3840), (1.0 / 2137)).y * mult;
#line 292
for (int i = -10; i < 11; i++)
{
...
{
#line 301
float axis = float2((1.0 / 3840), (1.0 / 2137)).x * mult;
#line 303
for (int i = -10; i < 11; i++)
{
...
{
#line 360
const float2 bps = float2((1.0 / 3840), (1.0 / 2137)) * 2;
#line 363
...
{
#line 400
const float2 bps = float2((1.0 / 3840), (1.0 / 2137)) * 4;
#line 406
const float2 tcP = texcoord + bps;
const float2 tcN = texcoord - bps;
...
{
#line 438
const float2 bps = float2((1.0 / 3840), (1.0 / 2137)) * 8;
...
float2 lfcoord = 0;
float3 lenstemp = 0;
const float2 distfact = float2((texcoord.x - 0.5) * (3840 * (1.0 / 2137)), texcoord.y - 0.5);
#line 548
...
#line 746
float2 bpsPP = float2((1.0 / 3840), (1.0 / 2137)) * 0.5;
