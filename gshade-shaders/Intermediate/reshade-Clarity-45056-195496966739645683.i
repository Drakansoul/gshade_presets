...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Clarity.fx"
#line 7
...
#line 78 "C:\Program Files\GShade\gshade-shaders\Shaders\Clarity.fx"
#line 79
texture ClarityTex < pooled = true; > { Width = 3840 * 0.5; Height = 2137 * 0.5; Format = R8; };
texture ClarityTex2 { Width = 3840 * 0.5; Height = 2137 * 0.5; Format = R8; };
texture ClarityTex3 < pooled = true; > { Width = 3840 * 0.25; Height = 2137 * 0.25; Format = R8; };
#line 83
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ClaritySampler3, float4(texcoord + float2(0.0, offset[i] * float2((1.0 / 3840), (1.0 / 2137)).y) * ClarityOffset, 0.0, 0.0)).r * weight[i];
color += tex2Dlod(ClaritySampler3, float4(texcoord - float2(0.0, offset[i] * float2((1.0 / 3840), (1.0 / 2137)).y) * ClarityOffset, 0.0, 0.0)).r * weight[i];
}
}
#line 107
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ReShade::BackBuffer, float4(texcoord + float2(offset[i] * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0) * ClarityOffset, 0.0, 0.0)).rgb * weight[i];
color += tex2Dlod(ReShade::BackBuffer, float4(texcoord - float2(offset[i] * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0) * ClarityOffset, 0.0, 0.0)).rgb * weight[i];
}
}
#line 283
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ClaritySampler, float4(texcoord + float2(0.0, offset[i] * float2((1.0 / 3840), (1.0 / 2137)).y) * ClarityOffset, 0.0, 0.0)).r* weight[i];
color += tex2Dlod(ClaritySampler, float4(texcoord - float2(0.0, offset[i] * float2((1.0 / 3840), (1.0 / 2137)).y) * ClarityOffset, 0.0, 0.0)).r* weight[i];
}
}
#line 365
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(ClaritySampler2, float4(texcoord + float2(offset[i] * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0) * ClarityOffset, 0.0, 0.0)).r* weight[i];
color += tex2Dlod(ClaritySampler2, float4(texcoord - float2(offset[i] * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0) * ClarityOffset, 0.0, 0.0)).r* weight[i];
}
}
#line 447
