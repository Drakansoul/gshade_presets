...
#line 49 "C:\Program Files\GShade\gshade-shaders\Shaders\ASCII.fx"
#line 55
...
const float2 cursor_position = trunc((float2(3840, 2137) / Ascii_block) * tex) * (Ascii_block / float2(3840, 2137));
#line 208
const float2 cp15 = cursor_position + float2((1.0 / 3840), (1.0 / 2137)) * 1.5;
const float2 cp35 = cursor_position + float2((1.0 / 3840), (1.0 / 2137)) * 3.5;
const float2 cp55 = cursor_position + float2((1.0 / 3840), (1.0 / 2137)) * 5.5;
#line 212
...
#line 249
const float2 p = trunc(frac((float2(3840, 2137) / Ascii_block) * tex) * Ascii_block); 
#line 251
