...
#line 1 "C:\Program Files\GShade\gshade-shaders\ComputeShaders\GaussianBlurCS.fx"
#line 53
texture BackBuffer : COLOR;
texture PlaceHolder {Width = 3840; Height = 2137; Format = RGB10A2;};
texture Convolution {Width = 3840; Height = 2137; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(3840, 2137));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(2137, 3840));
...
DispatchSizeX = (int(3840 + 32 * 4 - 1) / int(32 * 4));
DispatchSizeY = (int(2137 + 2 - 1) / int(2));
}
pass
{
ComputeShader = VerticalPassCS<32, 2>;
DispatchSizeX = (int(2137 + 32 * 4 - 1) / int(32 * 4));
DispatchSizeY = (int(3840 + 2 - 1) / int(2));
}
pass
{
