...
dcl_output o0.xyz
dcl_temps 5
add r0.xyzw, v1.xyxy, l(0.000521, 0.000000, 0.001563, 0.000000)
...
mov r2.w, l(2.000000)
mov r3.w, l(1.000000)
add r4.xyzw, v1.xyxy, l(0.000000, 0.000936, 0.000000, 0.002808)
...
add r2.xyzw, v1.xyxy, l(0.000000, -0.000936, 0.000000, -0.002808)
...
add r2.xyzw, v1.xyxy, l(-0.000521, 0.000000, -0.001563, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t8.xyzw, s0, l(2.000000)
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r2.zwzz, t2.xyzw, s0, l(0.000000)
mov r3.w, l(1.000000)
add r2.xyzw, r1.xyzw, r3.xyzw
...
lt r0.x, |r0.x|, l(0.010000)
movc r1.xyzw, r0.xxxx, r2.xyzw, r1.xyzw
add r2.xyzw, v1.xyxy, l(0.000521, 0.000936, 0.001563, 0.002808)
sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t8.xyzw, s0, l(2.000000)
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r2.zwzz, t2.xyzw, s0, l(0.000000)
mov r3.w, l(1.000000)
add r2.xyzw, r1.xyzw, r3.xyzw
