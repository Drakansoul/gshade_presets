...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Depth_Cues.fx"
#line 35
...
#line 137
texture texHB { Width = 3840  * 0.5 ; Height = 2137 * 0.5 ; Format = R8; MipLevels = 1;};
#line 139
sampler SamplerHB
{
Texture = texHB;
...
#line 144
texture texDC { Width = 3840; Height = 2137; Format = R8; MipLevels = 3;};
#line 146
sampler SamplerDC
{
Texture = texDC;
...
float W = 12;
#line 195
sum += BB(texcoord , + float2(float2((1.0 / 3840), (1.0 / 2137)).x * S,0) * j ) * W;
#line 197
total += W;
}
...
{
float2 S = Spread * 2 * 0.75f * float2((1.0 / 3840), (1.0 / 2137));
#line 207
...
{
const float DCB = tex2Dlod(SamplerDC,float4(texcoord,0,Blur_Cues * 2)).x;
