...
if_nz r0.y
  ...
  if_z r0.z
    ...
    loop 
      breakc_z r1.z
      itof r1.w, r0.z
      mad r2.x, r1.w, l(0.000260), v1.x
      lt r2.x, l(0.575000), r2.x
      mad r1.w, -r1.w, l(0.000260), v1.x
      ...
      sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t10.xyzw, s1, l(0.000000)
      mov r2.y, x1[r0.z + 0].x
      mad r2.x, r2.x, r2.y, r0.w
      add r1.xw, -r1.xxxy, v1.xxxy
      sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xwxx, t10.xyzw, s1, l(0.000000)
      mad r0.w, r1.x, r2.y, r2.x
      iadd r0.z, r0.z, l(1)
      ilt r1.z, r0.z, l(18)
    endloop 
  endif 
