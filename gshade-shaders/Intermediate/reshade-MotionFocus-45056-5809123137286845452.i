...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\MotionFocus.fx"
#line 5
...
#line 28 "C:\Program Files\GShade\gshade-shaders\Shaders\MotionFocus.fx"
#line 43
texture2D Ganossa_MF_NormTex { Width = 3840/2; Height = 2137/2; Format = RGBA8; };
texture2D Ganossa_MF_PrevTex { Width = 3840/2; Height = 2137/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullTex { Width = 3840/2; Height = 2137/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullPrevTex { Width = 3840/2; Height = 2137/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadTex { Width = 3840/2; Height = 2137/2; Format = RGBA16F; };
#line 49
...
#line 93
if (!(texcoord.x <= (1.0 / 3840)*2 && texcoord.y <= (1.0 / 2137)*2))
discard;
#line 96
float2 coord = float2(0.0,0.0);
#line 98
for (float i = 2.0f; i < 3840/2; i=i+3840/192f)
{
coord.x = (1.0 / 3840)*i*2;
#line 102
[unroll]
for (float j = 2.0f; j < 2137/2; j=j+2137/108f )
{
coord.y = (1.0 / 2137)*j*2;
float3 quadFull = tex2D(Ganossa_MF_QuadFullColor, coord).xyz;
float quadFullPow = quadFull.x+quadFull.y+quadFull.z;
#line 109
if(i < 3840/2/2 && j < 2137/2/2)
quadR.x += quadFullPow;
else if(i > 3840/2/2 && j < 2137/2/2)
quadR.y += quadFullPow;
else if(i < 3840/2/2 && j > 2137/2/2)
quadR.z += quadFullPow;
else
...
{
float4 Ganossa_MF_Quad = saturate(tex2D(Ganossa_MF_QuadColor, float2((1.0 / 3840), (1.0 / 2137)))-0.1f);
#line 126
if (mfDebug)
{
#line 129
