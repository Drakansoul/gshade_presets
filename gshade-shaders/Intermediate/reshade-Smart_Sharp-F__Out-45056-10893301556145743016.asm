...
movc r1.yz, r1.yyyy, l(0,0.000326,0.000585,0), l(0,0.000260,0.000468,0)
movc r1.xy, r1.xxxx, l(0.000391,0.000702,0,0), r1.yzyy
mov r0.w, cb0[2].y
mov r1.zw, l(0,0,0,-2)
...
loop 
  ...
  if_nz r0.w
    ...
    loop 
      breakc_z r4.w
      itof r3.y, r3.w
      mul r5.xy, r1.xyxx, r3.xyxx
      mad r5.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), v1.xyxx
      ...
      exp r3.y, r3.y
      mul r5.w, r3.y, l(1.595760)
      mad r3.z, r3.y, l(1.595760), r3.z
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyw, r3.xyxx, t2.xywz, s0, l(0.000000)
    add r5.xyz, -r0.xyzx, r3.xywx
    dp3 r4.w, r5.xyzx, r5.xyzx
    mul r4.w, r4.w, l(-11.541560)
    exp r4.w, r4.w
    mul r5.x, r4.w, l(1.595760)
    mad r1.z, r4.w, l(1.595760), r1.z
    mad r2.xyz, r5.xxxx, r3.xywx, r2.xyzx
  endif 
  iadd r1.w, r1.w, l(1)
  ige r2.w, l(2), r1.w
endloop 
...
if_z cb0[2].z
  ...
  add r6.xyzw, v1.xyxy, l(0.000000, -0.000468, -0.000260, 0.000000)
  ...
  add r6.xyzw, v1.xyxy, l(0.000260, 0.000000, 0.000000, 0.000468)
  sample_l_indexable(texture2d)(float,float,float,float) r7.xyz, r6.xyxx, t2.xyzw, s0, l(0.000000)
  ...
  if_nz r0.x
    ...
    loop 
      ...
      if_nz r0.z
        ...
        loop 
          ...
          mul r7.w, r7.w, l(-11.541560)
          exp r7.w, r7.w
          mul r8.x, r7.w, l(1.595760)
          mad r4.y, r7.w, l(1.595760), r4.y
          mad r7.xyz, r8.xxxx, r6.yzwy, r7.xyzx
          iadd r4.w, r4.w, l(1)
          ige r5.w, l(2), r4.w
        endloop 
        mov r5.xyz, r7.xyzx
        ...
        itof r4.w, r4.w
        mad r6.y, -r4.w, l(0.500000), l(1.000000)
        itof r6.x, r1.w
        mul r6.xy, r1.xyxx, r6.xyxx
        mad r6.xy, r6.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), r0.xyxx
    ...
    if_nz r0.y
      ...
      mad r6.xyzw, v1.xyxy, l(2.000000, 2.000000, 2.000000, 2.000000), l(0.000000, -0.000468, -0.000260, 0.000000)
      ...
      mad r6.xyzw, v1.xyxy, l(2.000000, 2.000000, 2.000000, 2.000000), l(0.000260, 0.000000, 0.000000, 0.000468)
