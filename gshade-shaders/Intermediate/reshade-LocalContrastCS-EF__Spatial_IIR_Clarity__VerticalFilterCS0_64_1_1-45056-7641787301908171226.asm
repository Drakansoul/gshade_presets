...
if_nz r0.x
  ...
  lt r0.w, r0.x, l(3840.000000)
  ftoi r2.x, r0.x
  mov r2.zw, l(0,0,0,0)
  mov r0.x, r0.z
  mov r1.yz, l(0,-127,-1,0)
  loop 
    breakc_z r1.z
    itof r3.x, r1.y
    add r3.x, r0.y, r3.x
  ...
  utof r1.x, vThreadID.x
  utof r1.y, r0.x
  add r0.xyzw, r1.xyyx, l(0.500000, 0.500000, 128.500000, 3840.500000)
  ftoi r1.xy, r0.xzxx
  mov r1.zw, l(0,0,0,0)
  ...
  loop 
    ...
    log r3.z, |r3.z|
    mul r3.z, r3.z, cb0[0].y
    exp r3.z, r3.z
    add r3.w, r0.x, -r2.y
    mad r0.x, r3.z, r3.w, r2.y
    ige r2.y, l(0), r0.w
    if_nz r2.y
      ftoi r1.yzw, r3.yyyy
