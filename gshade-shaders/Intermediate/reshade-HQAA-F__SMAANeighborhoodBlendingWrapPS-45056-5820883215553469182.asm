...
// __V__blendTex                     texture  float4          2d             t6      1 
//
//
//
// Input signature:
...
dcl_output o0.xyz
dcl_temps 3
sample_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t6.wxyz, s0
sample_indexable(texture2d)(float,float,float,float) r0.y, v2.zwzz, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r0.zw, v1.xyxx, t6.ywzx, s0
...
if_nz r1.x
  ...
  mad r1.xyzw, r2.xyzw, l(0.000260, 0.000468, -0.000260, -0.000468), v1.xyxy
