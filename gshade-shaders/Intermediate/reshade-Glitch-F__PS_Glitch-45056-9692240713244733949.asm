...
//   float Amount;                      // Offset:    4 Size:     4
//   bool bUseUV;                       // Offset:    8 Size:     4 [unused]
//
// }
//
//
...
dcl_output o0.xyzw
dcl_temps 6
mad r0.xyzw, v1.xyxy, l(1.000000, 1.000000, 1.000000, 1.000000), l(-0.002083, -0.000000, 0.002083, 0.000000)
mul r1.xyzw, r0.xyzw, l(479.999969, 267.125000, 479.999969, 267.125000)
frc r1.xyzw, |r1.xyzw|
mul r1.xyzw, r1.xyzw, l(0.002083, 0.003744, 0.002083, 0.003744)
...
mul r3.xyzw, v1.xyxy, l(1.000000, 1.000000, 480.000000, 267.125000)
frc r2.zw, |r3.zzzw|
mul r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.002083, 0.003744)
movc r2.xy, r2.xyxx, -r2.zwzz, r2.zwzz
mul r2.xy, r2.xyxx, l(479.999969, 267.125000, 0.000000, 0.000000)
mad r0.xyz, r2.xxxx, r1.xyzx, r0.xyzx
mad r1.xyzw, v1.xyxy, l(1.000000, 1.000000, 1.000000, 1.000000), l(-0.000000, -0.003744, 0.000000, 0.003744)
mul r4.xyzw, r1.xyzw, l(479.999969, 267.125000, 479.999969, 267.125000)
frc r4.xyzw, |r4.xyzw|
mul r4.xyzw, r4.xyzw, l(0.002083, 0.003744, 0.002083, 0.003744)
...
mad r0.xyz, r0.zyxz, l(0.500000, 0.500000, 0.500000, 0.000000), -r1.zyxz
ge r1.x, r0.y, r0.x
...
mul r0.zw, r0.zzzw, l(0.000000, 0.000000, 133.562500, 240.000000)
round_ni r0.zw, r0.zzzw
mul r0.zw, r0.zzzw, cb0[0].xxxx
mul r0.zw, r0.zzzw, l(0.000000, 0.000000, 0.000007, 0.000004)
...
dp2 r0.z, r4.xyxx, l(12.989800, 4.141400, 0.000000, 0.000000)
dp2 r0.w, r4.zwzz, l(12.989800, 4.141400, 0.000000, 0.000000)
...
dp2 r3.z, r4.zwzz, l(12.989800, 4.141400, 0.000000, 0.000000)
dp2 r3.w, r4.xyxx, l(12.989800, 4.141400, 0.000000, 0.000000)
sincos r3.zw, null, r3.zzzw
mul r3.zw, r3.zzzw, l(0.000000, 0.000000, 43758.542969, 43758.542969)
frc r3.zw, r3.zzzw
add r0.z, r0.z, -r3.z
...
mul r1.x, r0.z, r0.z
add r4.xyzw, r1.zwzw, l(1.000000, 0.000000, 0.000000, 1.000000)
dp2 r0.z, r1.zwzz, l(12.989800, 4.141400, 0.000000, 0.000000)
sincos r0.z, null, r0.z
mul r0.z, r0.z, l(43758.542969)
frc r0.z, r0.z
dp2 r1.z, r4.xyxx, l(12.989800, 4.141400, 0.000000, 0.000000)
dp2 r1.w, r4.zwzz, l(12.989800, 4.141400, 0.000000, 0.000000)
...
mul r1.y, r0.z, r0.z
mul r0.zw, r1.xxxy, l(0.000000, 0.000000, 0.000130, 0.000234)
mad r1.z, cb0[0].y, l(100.000000), l(50.000000)
mul r0.zw, r0.zzzw, r1.zzzz
mad r0.xy, r0.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000), r0.zwzz
mad r0.xy, r0.xyxx, cb0[0].yyyy, r3.xyxx
...
div r1.w, r1.z, r1.w
mad r1.z, r1.z, l(6.000000), l(0.000000)
mul r2.x, cb0[0].y, cb0[0].y
mul r2.x, r2.x, r2.x
mul r2.x, r2.x, cb0[0].y
mul r1.y, r1.y, r2.x
mad r1.y, r1.y, l(0.250000), r1.w
frc r1.w, |r1.y|
...
mul r0.x, r0.x, r0.x
mul r0.x, r1.x, r0.x
mad r0.x, r0.x, l(64.000000), l(-252.000000)
add r1.x, -cb0[0].y, l(1.000000)
mul r1.y, r1.x, r1.x
mul r1.y, r1.y, r1.y
mad r1.x, -r1.x, r1.y, l(1.000000)
mad r0.x, r1.x, r0.x, l(256.000000)
round_ni r0.x, r0.x
