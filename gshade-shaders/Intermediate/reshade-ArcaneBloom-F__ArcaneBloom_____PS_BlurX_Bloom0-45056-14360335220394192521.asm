...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(-0.001563, -0.000000, -0.001302, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.001042, 0.000000, -0.000781, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.000521, 0.000000, -0.000260, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.000260, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, l(0.132981, 0.132981, 0.132981, 0.000000), r0.xyzx
mad r0.xyz, r1.xyzx, l(0.125794, 0.125794, 0.125794, 0.000000), r0.xyzx
add r1.xyzw, v1.xyxy, l(0.000521, 0.000000, 0.000781, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, l(0.106483, 0.106483, 0.106483, 0.000000), r0.xyzx
mad r0.xyz, r1.xyzx, l(0.080657, 0.080657, 0.080657, 0.000000), r0.xyzx
add r1.xyzw, v1.xyxy, l(0.001042, 0.000000, 0.001302, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
mad r0.xyz, r2.xyzx, l(0.054670, 0.054670, 0.054670, 0.000000), r0.xyzx
mad r0.xyz, r1.xyzx, l(0.033159, 0.033159, 0.033159, 0.000000), r0.xyzx
add r1.xy, v1.xyxx, l(0.001563, 0.000000, 0.000000, 0.000000)
