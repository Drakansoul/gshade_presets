...
#line 56
texture Image0 {Width = int((3840 + 7) / 8) * 8; Height = int((2137 + 7) / 8) * 8; Format = RGBA16f;};
texture Image1 {Width = int((3840 + 7) / 8) * 8; Height = int((2137 + 7) / 8) * 8; Format = RGBA16f;};
#line 59
...
{
uint2 coord = uint2(texcoord * float2(int((3840 + 7) / 8) * 8, int((2137 + 7) / 8) * 8));
