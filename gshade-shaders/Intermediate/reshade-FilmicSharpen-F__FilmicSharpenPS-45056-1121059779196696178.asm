...
dcl_output o0.xyz
dcl_temps 3
mad r0.xy, v1.xyxx, l(2.000000, 1.113021, 0.000000, 0.000000), l(-1.000000, -0.556510, 0.000000, 0.000000)
dp2 r0.x, r0.xyxx, r0.xyxx
min r0.x, r0.x, l(1.000000)
utof r0.y, cb0[0].x
mad r0.x, -r0.x, r0.y, r0.y
movc r0.x, cb0[0].z, r0.x, r0.y
mad r1.xy, cb0[0].yyyy, l(0.000468, 0.000260, 0.000000, 0.000000), v1.yxyy
mov r1.zw, v1.xxxy
