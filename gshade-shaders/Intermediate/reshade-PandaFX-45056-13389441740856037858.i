...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\PandaFX.fx"
...
#line 17 "C:\Program Files\GShade\gshade-shaders\Shaders\PandaFX.fx"
#line 26
...
texture prePassLayer { Width = 3840; Height = 2137; Format = RGBA8; };
texture blurLayerHorizontal { Width = 3840 / 2; Height = 2137 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 3840 / 2; Height = 2137 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 3840 / 16; Height = 2137 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 3840 / 16; Height = 2137 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 3840 / 64; Height = 2137 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 3840 / 64; Height = 2137 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 3840 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 2137 * sampling;
float divisor = 0.000001;
#line 410
