...
#line 41 "C:\Program Files\GShade\gshade-shaders\Shaders\Vignette.fx"
#line 45
...
#line 55
distance_xy *= float2(((1.0 / 2137) / (1.0 / 3840)), Ratio);
#line 58
distance_xy /= Radius;
...
{
tex = -tex * tex + tex;
color.rgb = saturate((((1.0 / 2137) / (1.0 / 3840))*((1.0 / 2137) / (1.0 / 3840)) * Ratio * tex.x + tex.y) * 4.0) * color.rgb;
}
#line 71
if (Type == 2) 
{
