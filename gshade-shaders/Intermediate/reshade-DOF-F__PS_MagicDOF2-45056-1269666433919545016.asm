...
//   float fMagicDOFColorCurve;         // Offset:   72 Size:     4
...
ftoi r0.w, -cb0[4].y
round_z r1.y, -cb0[4].y
ge r1.y, cb0[4].y, r1.y
...
loop 
  breakc_z r2.w
  itof r3.x, r1.z
  mul r3.xy, r3.xxxx, l(0.500000, 0.866000, 0.000000, 0.000000)
  mul r4.xy, r1.xxxx, r3.xyxx
  mul r4.xy, r4.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000)
  div r4.xy, r4.xyxx, cb0[4].yyyy
  ...
  log r3.xyz, |r3.xyzx|
  mul r3.xyz, r3.xyzx, cb0[4].zzzz
  exp r3.xyz, r3.xyzx
  add r2.xyz, r2.xyzx, r3.xyzx
  add r1.w, r1.w, l(1.000000)
  iadd r1.z, r1.z, l(1)
  itof r3.x, r1.z
  ge r2.w, cb0[4].y, r3.x
endloop 
div_sat r2.xyz, r2.xyzx, r1.wwww
div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[4].z
log r2.xyz, r2.xyzx
