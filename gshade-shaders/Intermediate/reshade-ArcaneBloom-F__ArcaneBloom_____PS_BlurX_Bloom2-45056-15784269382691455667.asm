...
dcl_output o0.xyzw
dcl_temps 3
add r0.xyzw, v1.xyxy, l(-0.012500, -0.000000, -0.010417, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r0.zwzz, t4.xyzw, s0
...
add r1.xyzw, v1.xyxy, l(-0.008333, 0.000000, -0.006250, 0.000000)
...
add r1.xyzw, v1.xyxy, l(-0.000000, 0.000000, 0.002083, 0.000000)
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t4.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t4.xyzw, s0
