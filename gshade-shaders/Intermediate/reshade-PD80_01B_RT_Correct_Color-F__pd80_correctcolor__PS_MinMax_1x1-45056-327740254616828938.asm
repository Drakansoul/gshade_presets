...
mov r0.y, l(0)
mov r2.xyzw, l(1.000000,1.000000,1.000000,-1)
loop 
  breakc_z r2.w
  mov r6.xyz, r1.xyzx
  mov r7.xyz, r2.xyzx
  ...
  loop 
    ...
    max r5.w, r11.z, r5.w
    dp3 r6.w, r11.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    add r5.w, r5.w, r6.w
    max r6.w, r8.y, r8.x
    max r6.w, r8.z, r6.w
    dp3 r7.w, r8.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    add r6.w, r6.w, r7.w
    ge r5.w, r6.w, r5.w
    movc r8.xyz, r5.wwww, r11.xyzx, r8.xyzx
    ...
    dp3 r5.w, r11.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    dp3 r6.w, r10.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    ge r5.w, r5.w, r6.w
    movc r10.xyz, r5.wwww, r11.xyzx, r10.xyzx
    iadd r0.x, r0.x, l(1)
    ilt r4.w, r0.x, l(32)
  endloop 
  mov r1.xyz, r6.xyzx
