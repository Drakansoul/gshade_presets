...
#line 32 "C:\Program Files\GShade\gshade-shaders\Shaders\pkd_Sketchbook.fx"
#line 55
...
> = 0;
#line 84
texture tSketchMask_Backup { Width = 3840; Height = 2137; };
#line 86
texture tSketchMask_Mask <source="SketchMask.png";> { Width = 3840; Height = 2137; Format=R8; };
texture tSketchMask_Mask2 <source="SketchMask2.png";> { Width = 3840; Height = 2137; Format=R8; };
#line 89
...
> = 0.5;
#line 180
texture Layer_PencilHatch_texture <source="SketchPencil.png";> { Width = 3840; Height = 2137; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(3840, 2137) / float2(3840, 2137) * Layer_PencilHatch_Scale);
...
> = 0.5;
#line 230
texture Layer_PaperBase_texture <source="SketchPaperBase.png";> { Width = 3840; Height = 2137; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(3840, 2137) / float2(3840, 2137) * Layer_PaperBase_Scale);
...
> = 0.5;
#line 280
texture Layer_PaperOverlay_texture <source="SketchPaperOverlay.png";> { Width = 3840; Height = 2137; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(3840, 2137) / float2(3840, 2137) * Layer_PaperOverlay_Scale);
