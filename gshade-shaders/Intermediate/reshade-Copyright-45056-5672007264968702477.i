...
#line 622
return float3x3 (
(cos(Rotate) * float(1.0 - (3840) * (1.0 / 2137))), (sin(Rotate) * float(1.0 - (3840) * (1.0 / 2137))), 0,
(-sin(Rotate) * float(1.0 - (2137) * (1.0 / 3840))), (cos(Rotate) * float(1.0 - (2137) * (1.0 / 3840))), 0,
0, 0, 1
);
}
#line 629
...
return float3x3 (
(cos(angle) * float(1.0 - (3840) * (1.0 / 2137))), (sin(angle) * float(1.0 - (3840) * (1.0 / 2137))), 0,
(-sin(angle) * float(1.0 - (2137) * (1.0 / 3840))), (cos(angle) * float(1.0 - (2137) * (1.0 / 3840))), 0,
0, 0, 1
);
}
#line 638
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(Copyright_Sampler_Gauss_V, float4(texCoord + float2(sampleOffsets[i] * (GaussWeight * (GaussWeightH + 0.5)) * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_Gauss_V, float4(texCoord - float2(sampleOffsets[i] * (GaussWeight * (GaussWeightH + 0.5)) * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
}
break;
case 1:
...
#line 690
const float3 SumUV = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(0.5 + float(cLayer_PosX_Gauss * 0.1), 0.5 + float(cLayer_PosY_Gauss * 0.1))), rotateMatrix_Alt(0)), scaleMatrix(float(float(1.0 - (3840) * (1.0 / 2137)) * float2(float2(1450.0, 100.0) * ((cLayer_Scale) + (-1 + cLayer_Scale_Gauss)) / float2(3840, 2137)).x), float(float(1.0 - (2137) * (1.0 / 3840)) * float2(float2(1450.0, 100.0) * ((cLayer_Scale) + (-1 + cLayer_Scale_Gauss)) / float2(3840, 2137)).y)));
...
for(int i = 1; i < 4; ++i)
{
color += tex2Dlod(Copyright_Sampler_Gauss_H, float4(texCoord + float2(0.0, sampleOffsets[i] * (GaussWeight * (GaussWeightV + 0.5)) * float2((1.0 / 3840), (1.0 / 2137)).y), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_Gauss_H, float4(texCoord - float2(0.0, sampleOffsets[i] * (GaussWeight * (GaussWeightV + 0.5)) * float2((1.0 / 3840), (1.0 / 2137)).y), 0.0, 0.0)) * sampleWeights[i];
}
break;
case 1:
...
for(int i = 1; i < 6; ++i)
{
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_V, float4(texCoord + float2(sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_V, float4(texCoord - float2(sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 3840), (1.0 / 2137)).x, 0.0), 0.0, 0.0)) * sampleWeights[i];
}
return color;
}
...
#line 755
const float3 SumUV = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(0.5, 0.5)), rotateMatrix_Alt(0)), scaleMatrix(float(float2(float2(1450.0, 100.0) * cLayer_Scale / float2(3840, 2137)).x * float(1.0 - (3840) * (1.0 / 2137)) * cLayer_ScaleX), float(float2(float2(1450.0, 100.0) * cLayer_Scale / float2(3840, 2137)).y * float(1.0 - (2137) * (1.0 / 3840)) * cLayer_ScaleY)));
...
for(int i = 1; i < 6; ++i)
{
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_H, float4(texCoord + float2(0.0, sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 3840), (1.0 / 2137)).y), 0.0, 0.0)) * sampleWeights[i];
color += tex2Dlod(Copyright_Sampler_CAb_Gauss_H, float4(texCoord - float2(0.0, sampleOffsets[i] * cLayer_CAb_Blur * float2((1.0 / 3840), (1.0 / 2137)).y), 0.0, 0.0)) * sampleWeights[i];
}
return color;
}
...
{
const float3 SumUV = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(float(cLayer_Mouse && RightMouseDown? MouseCoords.x * float2((1.0 / 3840), (1.0 / 2137)).x : cLayer_PosX), float(cLayer_Mouse && RightMouseDown? MouseCoords.y * float2((1.0 / 3840), (1.0 / 2137)).y : cLayer_PosY))), rotateMatrix(cLayer_Rotate)), scaleMatrix(float(float2(float2(1450.0, 100.0) * cLayer_Scale / float2(3840, 2137)).x * float(1.0 - (3840) * (1.0 / 2137)) * cLayer_ScaleX), float(float2(float2(1450.0, 100.0) * cLayer_Scale / float2(3840, 2137)).y * float(1.0 - (2137) * (1.0 / 3840)) * cLayer_ScaleY)));
const float3 SumUV_Gauss = mul (mul (mul (float3(texCoord.x, texCoord.y, 1), positionMatrix(float(cLayer_Mouse && RightMouseDown? MouseCoords.x * float2((1.0 / 3840), (1.0 / 2137)).x : cLayer_PosX), float(cLayer_Mouse && RightMouseDown? MouseCoords.y * float2((1.0 / 3840), (1.0 / 2137)).y : cLayer_PosY))), rotateMatrix(cLayer_Rotate)), scaleMatrix(float(1.0 - (3840) * (1.0 / 2137)), float(1.0 - (2137) * (1.0 / 3840))));
