...
mul r0.xy, r0.xyxx, l(0.000260, 0.000468, 0.000000, 0.000000)
...
if_nz r0.x
  ...
  loop 
    ...
    loop 
      breakc_z r1.w
      itof r4.z, r1.z
      mad r4.y, r4.z, r0.x, r1.y
      add r4.yz, r4.xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
      mul r4.yz, r4.yyzy, l(0.000000, 0.000260, 0.000468, 0.000000)
      sample_l_indexable(texture2d)(float,float,float,float) r6.xyzw, r4.yzyy, t0.xyzw, s0, l(0.000000)
...
if_nz cb0[0].z
  div r0.xy, l(3840.000000, 2137.000000, 0.000000, 0.000000), r0.zzzz
  mov x0[0].x, l(16)
  mov x0[1].x, l(17)
  mov x0[2].x, l(18)
  mov x0[3].x, l(19)
  ...
  mov x0[11].x, l(0)
  mov x0[12].x, l(14)
  mad r1.xyzw, v1.xyxy, l(3840.000000, 2137.000000, 3840.000000, 2137.000000), l(-3584.000000, -128.000000, -3584.000000, -192.000000)
  ...
  if_z r1.x
    ...
    itof r1.y, r1.y
    ge r1.y, r0.z, r1.y
    mul r2.y, r3.x, l(10.000000)
    ge r2.y, r2.y, -r2.y
    movc r2.yw, r2.yyyy, l(0,10.000000,0,0.100000), l(0,-10.000000,0,-0.100000)
    mul r2.w, r2.w, r3.x
    frc r2.w, r2.w
    mul r2.y, r2.w, r2.y
  ...
  if_z r1.z
    ...
    itof r0.z, r0.z
    ge r0.z, r0.w, r0.z
    mul r1.x, r1.y, l(10.000000)
    ge r1.x, r1.x, -r1.x
    movc r1.xz, r1.xxxx, l(10.000000,0,0.100000,0), l(-10.000000,0,-0.100000,0)
    mul r1.y, r1.z, r1.y
    frc r1.y, r1.y
    mul r1.x, r1.y, r1.x
