...
if_nz r2.w
  ...
  ge r2.w, |r2.y|, |r2.z|
  max r2.y, |r2.z|, |r2.y|
  movc r3.xyzw, r1.yyyy, l(0.000468,-0.000468,0,-0.000260), l(0.000260,-0.000260,0.000468,-0.000000)
  movc r2.z, r2.w, r3.y, r3.x
  mul_sat r1.z, r1.w, |r1.z|
  and r3.xy, r1.yyyy, l(0x39888889, 0x39ccccce, 0, 0)
  mad r4.xy, r2.zzzz, l(0.500000, 0.500000, 0.000000, 0.000000), v1.xyxx
  movc r1.w, r1.y, v1.x, r4.x
  movc r4.x, r1.y, r4.y, v1.y
  add r5.x, r3.w, r1.w
  movc r6.xyzw, r1.yyyy, l(-0.000000,-0.000391,0,-0.000000), l(-0.000468,-0.000000,0.000702,-0.000702)
  add r5.y, r4.x, r6.x
  add r7.x, r3.x, r1.w
  add r7.y, r3.z, r4.x
  ...
  if_nz r4.z
    ...
    movc r4.zw, r1.yyyy, l(0,0,0,-0.000000), l(0,0,0.000936,-0.000936)
    add r3.w, r4.w, r4.y
      ...
      if_nz r3.w
        ...
        if_nz r3.w
          ...
          if_nz r3.w
            ...
            and r3.z, r1.y, l(0x3a888889)
            movc r6.xyz, r1.yyyy, l(-0.001042,0,-0.000000,0), l(-0.000000,0.001872,-0.001872,0)
            ...
            if_nz r3.w
              ...
              ge r3.xy, |r2.ywyy|, r2.xxxx
              and r1.x, r1.y, l(0x3b4cccce)
              movc r6.xyz, r1.yyyy, l(-0.003125,0,-0.000000,0), l(-0.000000,0.005615,-0.005615,0)
