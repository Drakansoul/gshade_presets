...
#line 15 "C:\Program Files\GShade\gshade-shaders\Shaders\Sketch.fx"
#line 48
...
{
#line 320
return float4(blur(SRGBBackBuffer, uv, float2((1.0 / 3840), 0.0)), 1.0);
#line 322
}
#line 324
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return float4(blur(ReShade::BackBuffer, uv, float2(0.0, (1.0 / 2137))), 1.0);
}
#line 331
void MainVS(
uint id : SV_VERTEXID,
