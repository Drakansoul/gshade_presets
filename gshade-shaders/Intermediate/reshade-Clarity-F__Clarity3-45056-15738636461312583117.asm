...
// __V__ClarityTex2                  texture  float4          2d             t6      1 
...
if_z cb0[0].x
  ...
  loop 
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xzxx, t6.xyzw, s0, l(0.000000)
    mad r0.x, r2.x, icb[r1.y + 0].y, r1.w
    iadd r1.y, r1.y, l(1)
    ilt r1.z, r1.y, l(4)
  endloop 
endif 
if_nz r0.y
  ...
  loop 
    breakc_z r1.w
    mul r2.x, cb0[0].y, icb[r1.z + 0].z
    mul r1.x, r2.x, l(0.000260)
    add r2.xy, r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t6.xyzw, s0, l(0.000000)
    mad r2.x, r2.x, icb[r1.z + 0].w, r0.x
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.yzyy, t6.xyzw, s0, l(0.000000)
    mad r0.x, r1.x, icb[r1.z + 0].w, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(6)
  endloop 
endif 
if_nz r0.z
  ...
  loop 
    ...
    add r2.xy, -r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.xyxx, t6.xyzw, s0, l(0.000000)
    mad r0.x, r1.x, icb[r0.z + 4].y, r1.w
    iadd r0.z, r0.z, l(1)
    ilt r1.z, r0.z, l(11)
  endloop 
endif 
if_nz r0.w
  ...
  loop 
    breakc_z r0.w
    mul r1.z, cb0[0].y, icb[r0.z + 6].z
    mul r1.x, r1.z, l(0.000260)
    ...
    mad r0.x, r1.x, icb[r0.z + 6].w, r1.z
    iadd r0.z, r0.z, l(1)
    ilt r0.w, r0.z, l(15)
  endloop 
endif 
...
if_nz r0.y
  ...
  loop 
    ...
    add r2.xy, -r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.xyxx, t6.xyzw, s0, l(0.000000)
    mad r0.z, r1.x, icb[r0.w + 15].y, r1.w
    iadd r0.w, r0.w, l(1)
    ilt r1.z, r0.w, l(18)
  endloop 
  mov o0.x, r0.z
