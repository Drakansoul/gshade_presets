...
#line 89
const float4 red_efhi = tex2DgatherR(sTexCASColor, texcoord + 0.5 * float2((1.0 / 3840), (1.0 / 2137)));
const float4 green_efhi = tex2DgatherG(sTexCASColor, texcoord + 0.5 * float2((1.0 / 3840), (1.0 / 2137)));
const float4 blue_efhi = tex2DgatherB(sTexCASColor, texcoord + 0.5 * float2((1.0 / 3840), (1.0 / 2137)));
#line 93
