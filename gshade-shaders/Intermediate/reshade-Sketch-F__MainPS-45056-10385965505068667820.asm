...
// {
//
//   float4 PatternColor;               // Offset:    0 Size:    16
//   float2 PatternRange;               // Offset:   16 Size:     8
//   float OutlineThreshold;            // Offset:   24 Size:     4
//   float Posterization;               // Offset:   28 Size:     4
//   float SmoothingScale;              // Offset:   32 Size:     4 [unused]
//
// }
//
//
...
div r0.w, r0.w, r1.x
add r0.y, -r0.w, r0.z
mul r0.xy, |r0.xyxx|, l(1920.000000, 1068.500000, 0.000000, 0.000000)
...
mul r2.x, r0.w, cb0[1].w
add r1.xyz, -r0.wwww, r1.xyzx
mov o0.w, r1.w
round_ne r0.w, r2.x
div r0.w, r0.w, cb0[1].w
add r1.w, r0.w, -cb0[1].x
