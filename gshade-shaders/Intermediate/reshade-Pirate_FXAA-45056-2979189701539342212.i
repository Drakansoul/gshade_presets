...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Pirate_FXAA.fx"
...
#line 3 "C:\Program Files\GShade\gshade-shaders\Shaders\Pirate_FXAA.fx"
#line 5
...
#line 41
for(int i=0; i < 8; i++) {
ret = tex2D(ReShade::BackBuffer, coord + tap[i] * float2((1.0 / 3840), (1.0 / 2137)) * FXAA_RADIUS);
