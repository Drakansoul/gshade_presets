...
mul r1.xy, v1.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000)
resinfo_indexable(texture2d)(float,float,float,float)_uint r1.zw, l(0), t12.zwxy
itof r1.zw, r1.zzzw
add r2.xy, -r1.zwzz, l(3840.000000, 2137.000000, 0.000000, 0.000000)
...
and r0.w, r1.y, r0.w
if_nz r0.w
  mad r1.xy, v1.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000), -r2.xyxx
