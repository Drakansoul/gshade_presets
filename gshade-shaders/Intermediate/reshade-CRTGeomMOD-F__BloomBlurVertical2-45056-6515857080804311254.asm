...
// __V__BloomBlurTex                 texture  float4          2d            t20      1 
...
loop 
  breakc_z r1.w
  mul r2.x, cb0[9].y, icb[r0.w + 0].x
  mad r2.yz, r2.xxxx, l(0.000000, 0.000000, 0.000468, 0.000000), v1.xxyx
  sample_l_indexable(texture2d)(float,float,float,float) r2.yzw, r2.yzyy, t20.wxyz, s0, l(0.000000)
  mad r2.yzw, r2.yyzw, icb[r0.w + 0].yyyy, r1.xxyz
  mad r3.xy, -r2.xxxx, l(0.000000, 0.000468, 0.000000, 0.000000), v1.xyxx
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t20.xyzw, s0, l(0.000000)
  mad r1.xyz, r3.xyzx, icb[r0.w + 0].yyyy, r2.yzwy
  iadd r0.w, r0.w, l(1)
  ilt r1.w, r0.w, l(3)
endloop 
mov o0.xyz, r1.xyzx
