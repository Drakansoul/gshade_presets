...
switch cb0[4].z
  ...
  loop 
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t10.wxyz, s0, l(0.000000)
    mad r2.x, r2.x, icb[r1.z + 0].y, r0.y
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.yzyy, t10.wxyz, s0, l(0.000000)
    mad r0.y, r1.x, icb[r1.z + 0].y, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(6)
  endloop 
  break 
  ...
  loop 
    ...
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.yzyy, t10.wxyz, s0, l(0.000000)
    mad r0.y, r1.x, icb[r1.z + 0].w, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(11)
  endloop 
  break 
  ...
  loop 
    ...
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.yzyy, t10.wxyz, s0, l(0.000000)
    mad r0.y, r1.x, icb[r1.z + 6].y, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(6)
  endloop 
  break 
  ...
  loop 
    ...
    mad r0.y, r1.x, icb[r0.w + 11].w, r1.w
    iadd r0.w, r0.w, l(1)
    ilt r1.z, r0.w, l(4)
  endloop 
  break 
