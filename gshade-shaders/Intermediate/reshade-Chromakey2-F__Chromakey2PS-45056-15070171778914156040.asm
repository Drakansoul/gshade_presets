...
// {
//
//   float Threshold2;                  // Offset:    0 Size:     4
//   bool RadialX2;                     // Offset:    4 Size:     4
//   bool RadialY2;                     // Offset:    8 Size:     4
//   float FOV2;                        // Offset:   12 Size:     4
//   int CKPass2;                       // Offset:   16 Size:     4
//   bool Floor2;                       // Offset:   20 Size:     4
//   float FloorAngle2;                 // Offset:   24 Size:     4
//   int Precision2;                    // Offset:   28 Size:     4
//   int Color2;                        // Offset:   32 Size:     4
//   float3 CustomColor2;               // Offset:   36 Size:    12
//   bool AntiAliased2;                 // Offset:   48 Size:     4
//   bool InvertDepth2;                 // Offset:   52 Size:     4
//
// }
//
//
...
mul r1.x, cb0[0].w, l(0.008727)
sincos r1.x, r2.x, r1.x
div r1.x, r1.x, r2.x
mul r1.y, r1.x, l(0.556510)
...
lt r0.x, cb0[0].x, r0.w
ieq r0.y, cb0[2].x, l(6)
and r0.x, r0.y, r0.x
