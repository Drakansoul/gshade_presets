...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\PPFX_SSDO.fx"
...
#line 12 "C:\Program Files\GShade\gshade-shaders\Shaders\PPFX_SSDO.fx"
#line 34
...
> = 0;
#line 153
texture texColorLOD { Width = 3840; Height = 2137; Format = RGBA8; MipLevels = 4; };
...
#line 239
static const float2 pxSize = float2((1.0 / 3840),(1.0 / 2137));
...
float3	ssdo = 0.0;
#line 296
const float	randomDir = tex2Dlod(SamplerSSDONoise,float4(frac(txCoords*float2((3840*1.0)/4.0,(2137*1.0)/4.0)), 0.0, 0.0)).x;
