...
#line 62 "C:\Program Files\GShade\gshade-shaders\Shaders\Emphasize.fx"
#line 71
...
if(Spherical == true)
{
texcoord.x = (texcoord.x-Sphere_FocusHorizontal)*3840;
texcoord.y = (texcoord.y-Sphere_FocusVertical)*2137;
const float degreePerPixel = Sphere_FieldOfView*(1.0 / 3840);
