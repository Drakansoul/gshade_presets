...
#line 7 "C:\Program Files\GShade\gshade-shaders\Shaders\AspectRatioComposition.fx"
#line 27
...
#line 64
if(aspectRatio < (3840 * (1.0 / 2137)))
{
borderSize = (3840 - 2137 * aspectRatio) / 2.0;
fractionWidth = (3840 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (3840 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (2137 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (2137 - 3840 / aspectRatio) / 2.0;
fractionWidth = (2137 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (2137 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (3840 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 3840-1 || vpos.y <= 1 || vpos.y >= 2137-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio, 1.6180339887, float4(3840, 2137, 0, 0) - vpos);
}
#line 125
