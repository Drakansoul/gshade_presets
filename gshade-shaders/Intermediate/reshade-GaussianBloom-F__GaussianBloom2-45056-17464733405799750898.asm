...
if_nz r1.x
  ...
  loop 
    breakc_z r1.x
    mul r3.x, l(0.000260), icb[r0.w + 0].x
...
if_nz r1.y
  ...
  loop 
    breakc_z r2.w
    mul r1.x, l(0.000260), icb[r0.w + 0].z
...
if_nz r1.z
  ...
  loop 
    breakc_z r2.z
    mul r2.x, l(0.000260), icb[r0.w + 6].x
    add r3.xy, r2.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t6.xyzw, s1, l(0.000000)
    mad r3.xyz, r3.xyzx, icb[r0.w + 6].yyyy, r0.xyzx
    add r2.xw, -r2.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xwxx, t6.xyzw, s1, l(0.000000)
    mad r0.xyz, r4.xyzx, icb[r0.w + 6].yyyy, r3.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r2.z, r0.w, l(15)
  endloop 
endif 
if_nz r1.w
  ...
  loop 
    breakc_z r1.w
    mul r2.x, l(0.000260), icb[r0.w + 11].z
