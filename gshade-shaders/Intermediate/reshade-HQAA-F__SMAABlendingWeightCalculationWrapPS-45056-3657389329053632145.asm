...
// __V__edgesTex                     texture  float4          2d             t4      1 
// __V__areaTex                      texture  float4          2d             t8      1 
// __V__searchTex                    texture  float4          2d            t10      1 
//
//
//
// Input signature:
...
dcl_output o0.xyzw
dcl_temps 5
sample_indexable(texture2d)(float,float,float,float) r0.xy, v1.xyxx, t4.xyzw, s0
...
if_nz r0.y
  ...
  if_nz r0.y
    ...
    loop 
      ...
      sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r1.xyxx, t4.zyxw, s0, r1.y
  ...
  loop 
    breakc_z r0.y
    add r3.xyz, r3.xyzx, l(0.000260, -0.000468, 1.000000, 0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r0.zw, r3.xyxx, t4.zwxy, s0, r3.y
  ...
  if_nz r0.y
    ...
    mad r3.xyzw, r1.yxzw, l(0.000260, 0.000468, 0.000260, 0.000468), v1.xyxy
    sample_l_aoffimmi_indexable(-1,0,0)(texture2d)(float,float,float,float) r0.yz, r3.xyxx, t4.wxyz, s0, r3.y
    sample_l_aoffimmi_indexable(1,0,0)(texture2d)(float,float,float,float) r1.yw, r3.zwzz, t4.zxwy, s0, r3.w
    mov r0.w, r1.y
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t8.zxyw, s0, r0.z
  else 
    mov r0.yz, l(0,0,0,0)
  endif 
  ...
  loop 
    breakc_z r1.w
    add r1.xyz, r1.xyzx, l(-0.000260, -0.000468, 1.000000, 0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r2.zw, r1.xyxx, t4.zwxy, s0, r1.y
    ...
    and r1.w, r2.w, r2.z
  endloop 
  sample_l_aoffimmi_indexable(1,0,0)(texture2d)(float,float,float,float) r1.y, v1.xyxx, t4.yxzw, s0, v1.y
  ...
  if_nz r1.y
    ...
    loop 
      breakc_z r2.z
      add r3.xyz, r3.xyzx, l(0.000260, 0.000468, 1.000000, 0.000000)
      sample_l_indexable(texture2d)(float,float,float,float) r4.xy, r3.xyxx, t4.xyzw, s0, r3.y
  ...
  if_nz r0.w
    mad r3.xyzw, r1.zzxx, l(-0.000260, -0.000468, 0.000260, 0.000468), v1.xyxy
    sample_l_aoffimmi_indexable(-1,0,0)(texture2d)(float,float,float,float) r4.x, r3.xyxx, t4.yxzw, s0, r3.y
    sample_l_aoffimmi_indexable(0,-1,0)(texture2d)(float,float,float,float) r4.z, r3.xyxx, t4.yzxw, s0, r3.y
    sample_l_aoffimmi_indexable(1,0,0)(texture2d)(float,float,float,float) r4.yw, r3.zwzz, t4.zywx, s0, r3.w
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r1.xy, r1.xyxx, t8.xyzw, s0, r1.y
  ...
  if_nz r0.w
    ...
    loop 
      breakc_z r1.z
      sample_l_indexable(texture2d)(float,float,float,float) r1.xy, r2.xyxx, t4.xyzw, s0, r2.y
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t10.yzwx, s2, r1.y
    mad r0.w, r0.w, l(-2.007874), l(3.250000)
    mad r1.x, r0.w, l(0.000260), r2.x
    mov r1.y, v3.y
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r1.xyxx, t4.xyzw, s0, v3.y
    lt r0.w, v2.z, v4.y
    ...
    loop 
      breakc_z r3.z
      sample_l_indexable(texture2d)(float,float,float,float) r2.zw, r3.xyxx, t4.zwxy, s0, r3.y
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r0.w, r2.zwzz, t10.yzwx, s2, r2.w
    mad r0.w, r0.w, l(-2.007874), l(3.250000)
    mad r1.z, r0.w, l(-0.000260), r3.x
    mad r2.zw, r1.zzzx, l(0.000000, 0.000000, 3840.000000, 3840.000000), -v1.zzzz
    round_ne r2.zw, r2.zzzw
    sqrt r3.xy, |r2.wzww|
    sample_l_aoffimmi_indexable(1,0,0)(texture2d)(float,float,float,float) r2.y, r1.zyzz, t4.yxzw, s0, v3.y
    mul r2.xy, r2.xyxx, l(4.000000, 4.000000, 0.000000, 0.000000)
    round_ne r2.xy, r2.xyxx
    mad r2.xy, r2.xyxx, l(16.000000, 16.000000, 0.000000, 0.000000), r3.xyxx
    mad r2.xy, r2.xyxx, l(0.006250, 0.001786, 0.000000, 0.000000), l(0.003125, 0.000893, 0.000000, 0.000000)
    sample_l_indexable(texture2d)(float,float,float,float) r2.xy, r2.xyxx, t8.xyzw, s0, r2.y
    ge r2.zw, |r2.zzzw|, |r2.wwwz|
    and r2.zw, r2.zzzw, l(0, 0, 0x3f800000, 0x3f800000)
    add r0.w, r2.w, r2.z
    div r2.zw, r2.zzzw, r0.wwww
    mov r1.w, v1.y
    sample_l_aoffimmi_indexable(0,1,0)(texture2d)(float,float,float,float) r0.w, r1.xwxx, t4.yzwx, s0, v1.y
    mad r0.w, -r2.z, r0.w, l(1.000000)
    sample_l_aoffimmi_indexable(1,1,0)(texture2d)(float,float,float,float) r1.y, r1.zwzz, t4.yxzw, s0, v1.y
    mad_sat r3.x, -r2.w, r1.y, r0.w
    sample_l_aoffimmi_indexable(0,-2,0)(texture2d)(float,float,float,float) r0.w, r1.xwxx, t4.yzwx, s0, v1.y
    mad r0.w, -r2.z, r0.w, l(1.000000)
    sample_l_aoffimmi_indexable(1,-2,0)(texture2d)(float,float,float,float) r1.x, r1.zwzz, t4.xyzw, s0, v1.y
...
if_nz r0.x
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t10.xyzw, s2, r0.y
  mad r0.x, r0.x, l(-2.007874), l(3.250000)
  mad r0.x, r0.x, l(0.000468), r1.y
  mov r0.y, v2.x
  sample_l_indexable(texture2d)(float,float,float,float) r1.x, r0.yxyy, t4.yxzw, s0, r0.x
  lt r1.z, v3.w, v4.w
  ...
  loop 
    breakc_z r1.w
    sample_l_indexable(texture2d)(float,float,float,float) r2.xy, r3.xyxx, t4.yxzw, s0, r3.y
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r1.z, r1.zwzz, t10.yzxw, s2, r1.w
  ...
  sqrt r2.xy, |r1.wzww|
  sample_l_aoffimmi_indexable(0,1,0)(texture2d)(float,float,float,float) r1.y, r0.yzyy, t4.xyzw, s0, r0.z
  ...
  add r0.y, r1.w, r1.z
  div r1.zw, r1.zzzw, r0.yyyy
  mov r0.w, v1.x
  sample_l_aoffimmi_indexable(1,0,0)(texture2d)(float,float,float,float) r0.y, r0.wxww, t4.xyzw, s0, r0.x
  mad r0.y, -r1.z, r0.y, l(1.000000)
  sample_l_aoffimmi_indexable(1,1,0)(texture2d)(float,float,float,float) r2.x, r0.wzww, t4.yxzw, s0, r0.z
  mad_sat r2.z, -r1.w, r2.x, r0.y
  sample_l_aoffimmi_indexable(-2,0,0)(texture2d)(float,float,float,float) r0.x, r0.wxww, t4.yxzw, s0, r0.x
  mad r0.x, -r1.z, r0.x, l(1.000000)
  sample_l_aoffimmi_indexable(-2,1,0)(texture2d)(float,float,float,float) r0.y, r0.wzww, t4.xyzw, s0, r0.z
