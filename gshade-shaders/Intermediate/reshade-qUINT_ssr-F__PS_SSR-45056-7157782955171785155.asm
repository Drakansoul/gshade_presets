...
mov r2.w, l(0)
mov r3.xyz, l(1.000000,3.000000,-1,0)
loop 
  breakc_z r3.z
  mul r3.x, r3.x, l(4.000000)
  add r3.w, -r3.y, l(1.000000)
  exp r3.w, r3.w
  mul r4.xy, r3.wwww, v0.xyxx
  round_ni r4.xy, r4.xyxx
  add r5.xyzw, r4.xyxy, r4.xyxy
  ...
  add r3.w, r4.x, r4.x
  mad r4.x, r4.x, l(-4.000000), l(3.000000)
  mad r3.w, r4.y, r4.x, r3.w
  mul r3.w, r3.x, r3.w
  mad r2.w, r3.w, l(0.333333), r2.w
...
div r4.xy, l(0.010417, 0.018718, 0.000000, 0.000000), r0.wwww
