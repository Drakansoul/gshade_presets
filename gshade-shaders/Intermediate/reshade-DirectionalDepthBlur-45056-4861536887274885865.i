...
#line 241
texture texDownsampledBackBuffer { Width = 3840; Height = 2137; Format = RGBA16F; };
texture texBlurDestination { Width = 3840; Height = 2137; Format = RGBA16F; };
texture texFilterCircle { Width = 3840; Height = 2137; Format = R16F; };
#line 245
...
{
float2 mouseCoords = MouseCoords * float2((1.0 / 3840), (1.0 / 2137));
#line 273
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length(float2((1.0 / 3840), (1.0 / 2137)));
}
#line 276
...
pixelInfo.blurLengthInPixels = length(float2(3840, 2137)) * BlurLength;
