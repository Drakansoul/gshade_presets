...
if_nz r1.z
  ...
  ilt r1.z, l(0), r1.y
  if_nz r1.z
    add r2.xyzw, v1.xyxy, l(0.000000, -0.000468, 0.000260, -0.000468)
    ...
    mad r2.x, -r1.w, l(999.000000), l(1000.000000)
    div r3.y, r1.w, r2.x
    add r2.xyzw, v1.xyxy, l(0.000260, 0.000000, 0.000260, 0.000468)
    sample_l_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t2.yzwx, s0, l(0.000000)
    mad r2.x, -r1.w, l(999.000000), l(1000.000000)
    div r3.z, r1.w, r2.x
    sample_l_indexable(texture2d)(float,float,float,float) r1.w, r2.zwzz, t2.yzwx, s0, l(0.000000)
  ...
  and r1.z, r1.w, r1.z
  if_nz r1.z
    add r2.xyzw, v1.xyxy, l(0.000000, -0.000936, 0.000521, -0.000936)
    ...
    mad r2.y, -r2.x, l(999.000000), l(1000.000000)
    div r3.y, r2.x, r2.y
    add r2.xyzw, v1.xyxy, l(0.000521, 0.000000, 0.000521, 0.000936)
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t2.xyzw, s0, l(0.000000)
    mad r2.y, -r2.x, l(999.000000), l(1000.000000)
    div r3.z, r2.x, r2.y
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.zwzz, t2.xyzw, s0, l(0.000000)
  ...
  and r1.y, r1.w, r1.z
  if_nz r1.y
    add r2.xyzw, v1.xyxy, l(0.000000, -0.001404, 0.000781, -0.001404)
    ...
    mad r1.z, -r1.y, l(999.000000), l(1000.000000)
    div r3.y, r1.y, r1.z
    add r2.xyzw, v1.xyxy, l(0.000781, 0.000000, 0.000781, 0.001404)
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t2.yxzw, s0, l(0.000000)
    mad r1.z, -r1.y, l(999.000000), l(1000.000000)
    div r3.z, r1.y, r1.z
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.zwzz, t2.yxzw, s0, l(0.000000)
  ...
  if_nz r1.y
    ...
    mov r5.xz, r2.xxzx
    mov r5.yw, r3.xxxz
    div r5.xyzw, r5.xyzw, r1.wwww
    mov r3.xz, r2.yywy
    div r2.xyzw, r3.xyzw, r1.wwww
    add r3.xyzw, -r4.xxxx, r5.xyzw
    ...
    mul r2.x, r2.y, r2.x
    mul r1.w, r1.w, r2.x
    ge r1.w, r1.w, l(0.900000)
    or r1.z, r1.z, r1.w
    lt r1.w, l(1.000000), cb0[3].x
  else 
    mov r1.w, l(0)
  endif 
  and r1.y, r1.w, r1.y
  if_nz r1.y
    ...
    or r1.z, r1.z, r2.x
    lt r1.w, l(2.000000), cb0[3].x
  endif 
  and r1.y, r1.w, r1.y
  if_nz r1.y
    mov r2.xyzw, x0[2].xyzw
    mov r3.xyzw, x1[2].xyzw
    min r1.yw, r2.zzzw, r3.zzzw
    min r1.yw, r1.yyyw, r3.xxxy
    min r1.yw, r1.yyyw, r2.xxxy
