...
mul r0.xyzw, r0.xyzw, l(-0.796911, 0.443490, -0.300917, 0.020753)
...
loop 
  breakc_z r1.w
  mul r3.x, cb0[10].w, icb[r1.z + 0].x
  mul r1.y, r3.x, l(0.000468)
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t12.xyzw, s0, l(0.000000)
