...
lt r1.yz, |r0.xxxx|, l(0.000000, 0.200000, 0.000536, 0.000000)
...
if_z r1.x
  ...
  mul r2.xy, cb0[6].xxxx, l(0.000000, 0.000468, 0.000000, 0.000000)
  mov r3.xyz, r1.xywx
  mov r2.zw, l(0,0,1,-1)
  loop 
    breakc_z r2.w
    mad r4.xy, r2.xyxx, icb[r2.z + 0].xxxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r3.w, r4.xyxx, t8.yzwx, s2, l(0.000000)
    lt r3.w, |r3.w|, l(0.200000)
    and r4.z, r3.w, l(0x3f800000)
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r3.w, r5.xyxx, t8.yzwx, s2, l(0.000000)
    lt r3.w, |r3.w|, l(0.200000)
    and r4.w, r3.w, l(0x3f800000)
    mul r6.xyz, r0.yzwy, r4.wwww
...
mul r2.xy, v1.xyxx, l(7.500000, 4.173828, 0.000000, 0.000000)
...
if_nz r0.y
  ...
  mul r2.xy, cb0[9].xyxx, l(0.000260, 0.000468, 0.000000, 0.000000)
  movc r2.xy, cb0[0].yyyy, r2.xyxx, cb0[0].zwzz
  add r2.xy, -r2.xyxx, v1.xyxx
  mul r2.xy, |r2.xyxx|, l(-5539.948730, -3083.039307, 0.000000, 0.000000)
  exp r2.xy, r2.xyxx
