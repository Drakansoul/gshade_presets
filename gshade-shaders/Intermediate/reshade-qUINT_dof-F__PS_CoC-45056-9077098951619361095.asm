...
dcl_immediateConstantBuffer { { 0.000391, 0.000234, 0, 0},
                              { 0.000130, -0.000702, 0, 0},
                              { -0.000391, -0.000234, 0, 0},
                              { -0.000130, 0.000702, 0, 0} }
...
loop 
  ...
  add r5.xyzw, r3.zwzw, l(0.000260, 0.000000, -0.000260, -0.000000)
  ...
  add r3.xyzw, r3.xyzw, l(0.000000, 0.000468, -0.000000, -0.000468)
