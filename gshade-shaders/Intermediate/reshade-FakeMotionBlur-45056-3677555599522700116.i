...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\FakeMotionBlur.fx"
#line 31
...
#line 43 "C:\Program Files\GShade\gshade-shaders\Shaders\FakeMotionBlur.fx"
#line 44
texture2D currTex { Width = 3840; Height = 2137; Format = RGBA8; };
texture2D prevSingleTex { Width = 3840; Height = 2137; Format = RGBA8; };
texture2D prevTex { Width = 3840; Height = 2137; Format = RGBA8; };
#line 48
...
prev *= weight[0];
#line 64
const float pixelBlur = (mbSoftness * 13 * (diff)) * ((1.0 / 3840));
const float pixelBlur2 = (mbSoftness * 11 * (diff)) * ((1.0 / 2137));
#line 67
[unroll]
for (int z = 1; z < 11; z++)
{
