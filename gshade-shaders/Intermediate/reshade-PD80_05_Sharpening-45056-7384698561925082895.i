...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\PD80_05_Sharpening.fx"
...
#line 30 "C:\Program Files\GShade\gshade-shaders\Shaders\PD80_05_Sharpening.fx"
#line 31
...
> = 1.0;
#line 112
texture texGaussianH { Width = 3840; Height = 2137; };
texture texGaussian { Width = 3840; Height = 2137; };
#line 116
...
float loops      = max( 3840, 2137 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 3840, 2137 ) / 1920.0f ); 
