...
#line 1 "C:\Program Files\GShade\gshade-shaders\ComputeShaders\VRS_Map.fx"
#line 1 "C:\Program Files\GShade\gshade-shaders\ComputeShaders\VRS_Map.fxh"
#line 134
uniform int VRS_FrameCount < source = "framecount";>;
#line 146
texture VRS {Width = (uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))).x; Height = (uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))).y; Format = RGBA8;};
...
{
return uint(tex2Dfetch(sVRS, int2(texcoord * (uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))))).w * 255);
}
}
#line 184
...
{
float3 variances = (tex2Dfetch(sVRS, int2(texcoord * (uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))))).xyz / 4);
...
int2 grid = uint2(texcoord.xy * float2(3840, 2137)) % 8;
...
#line 53 "C:\Program Files\GShade\gshade-shaders\ComputeShaders\VRS_Map.fx"
#line 73
...
#line 80
static const int2 g_Resolution = int2(3840, 2137);
...
float2 texcoord = input.vPosition.xy * float2((1.0 / 3840), (1.0 / 2137));
...
DispatchSizeX = (uint2((uint(uint((uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))).x + 2 - 1) / uint(2))), (uint(uint((uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))).y + 2 - 1) / uint(2))))).x;
DispatchSizeY = (uint2((uint(uint((uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))).x + 2 - 1) / uint(2))), (uint(uint((uint2((uint(uint(3840 + 8 - 1) / uint(8))), (uint(uint(2137 + 8 - 1) / uint(8))))).y + 2 - 1) / uint(2))))).y;
}
pass
{
VertexShader = mainVS;
