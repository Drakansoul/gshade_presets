...
if_z r1.y
  ...
  mul r1.z, r1.x, v1.w
  mul r1.zw, r1.zzzz, l(0.000000, 0.000000, 0.000260, 0.000468)
  ...
  loop 
    breakc_z r6.y
    div r6.z, l(6.283185), r5.w
    div r6.w, r6.x, v1.z
    add r7.x, -r6.w, l(1.000000)
    mad r6.w, r1.y, r7.x, r6.w
    mul r7.x, r1.x, r6.x
    ...
    loop 
      ...
      mul r11.y, r3.z, r10.x
      dp2 r10.x, r11.yxyy, r5.xyxx
      dp2 r10.y, r11.yxyy, r5.yzyy
      mad r9.yz, r10.xxyx, r3.xxwx, v1.xxyx
      ...
      mul r10.x, r6.w, r10.x
      mad r9.w, r9.w, cb0[5].x, -r7.x
      add_sat r9.w, r9.w, l(0.500000)
      mul r10.y, r9.w, r10.x
      sample_l_indexable(texture2d)(float,float,float,float) r11.xyz, r9.yzyy, t20.xyzw, s1, l(0.000000)
      mad r8.xyz, r11.xyzx, r10.yyyy, r8.xyzx
      mad r7.z, r10.x, r9.w, r7.z
      add r7.w, r6.z, r7.w
