...
sampler tex) {
#line 2697
return tex2DgatherR(tex, texcoord + float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy * float2(-0.5, -0.5)).grb;
#line 2704
}
#line 2709
...
out float4 offset[3]) {
offset[0] = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, float4(-1.0, 0.0, 0.0, -1.0), texcoord.xyxy);
offset[1] = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, float4( 1.0, 0.0, 0.0,  1.0), texcoord.xyxy);
offset[2] = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, float4(-2.0, 0.0, 0.0, -2.0), texcoord.xyxy);
}
#line 2749
void SMAABlendingWeightCalculationVS(float2 texcoord,
out float2 pixcoord,
out float4 offset[3]) {
pixcoord = texcoord * float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).zw;
#line 2755
offset[0] = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, float4(-0.25, -0.125,  1.25, -0.125), texcoord.xyxy);
offset[1] = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, float4(-0.125, -0.25, -0.125,  1.25), texcoord.xyxy);
#line 2759
offset[2] = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xxyy,
...
out float4 offset) {
offset = mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, float4( 1.0, 0.0, 0.0,  1.0), texcoord.xyxy);
}
#line 2783
...
const float3 t = float3(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy, 1.0);
...
float4 coord = float4(texcoord, -1.0, 1.0);
coord.x += 0.25 * float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).x; 
const float3 t = float3(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy, 1.0);
while (coord.z < float(20 - 1) &&
coord.w > 0.9) {
coord.xyz = mad(t, float3(dir, 1.0), coord.xyz);
...
if (d.x + d.y > 2.0) { 
#line 3120
const float4 coords = mad(float4(-d.x + 0.25, d.x, d.y, -d.y - 0.25), float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, texcoord.xyxy);
float4 c;
...
if (d.x + d.y > 2.0) { 
#line 3155
const float4 coords = mad(float4(-d.x, -d.x, d.y, d.y), float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xyxy, texcoord.xyxy);
float4 c;
...
texcoord = mad(-float2(2.0, 0.0), float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy, texcoord);
}
#line 3220
const float offset = mad(-(255.0 / 127.0), SMAASearchLength(searchTex, e, 0.0), 3.25);
return mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).x, offset, texcoord.x);
#line 3234
}
#line 3236
...
e.g == 0.0) { 
e = tex2Dlod(edgesTex, float4(texcoord, texcoord)).rg;
texcoord = mad(-float2(0.0, 2.0), float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy, texcoord);
}
const float offset = mad(-(255.0 / 127.0), SMAASearchLength(searchTex, e.gr, 0.0), 3.25);
return mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).y, offset, texcoord.y);
}
#line 3260
...
d.y = coords.z;
#line 3373
d = abs(round(mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).zz, d, -pixcoord.xx)));
#line 3377
...
d.y = coords.z;
#line 3414
d = abs(round(mad(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).ww, d, -pixcoord.yy)));
#line 3418
const float2 sqrt_d = sqrt(d);
#line 3421
...
#line 3475
const float4 blendingCoord = mad(blendingOffset, float4(float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy, -float4((1.0 / 3840), (1.0 / 2137), 3840, 2137).xy), texcoord.xyxy);
#line 3479
...
#line 376
return FxaaPixelShader(texcoord,0,FXAATexture,FXAATexture,FXAATexture,float2((1.0 / 3840), (1.0 / 2137)),0,0,0,TotalSubpix,0.925 - (Subpix * 0.125),0.004,0,0,0,0); 
}
#line 379
...
#line 389
return FxaaPixelShader(texcoord,0,FXAATexture,FXAATexture,FXAATexture,float2((1.0 / 3840), (1.0 / 2137)),0,0,0,TotalSubpix,0.85 - (Subpix * 0.15),0.004,0,0,0,0); 
}
#line 392
...
#line 403
return FxaaPixelShader(texcoord,0,FXAATexture,FXAATexture,FXAATexture,float2((1.0 / 3840), (1.0 / 2137)),0,0,0,TotalSubpix,max(0.1,0.7 * EdgeThreshold),0.004,0,0,0,0); 
}
#line 408
technique HQAA <
