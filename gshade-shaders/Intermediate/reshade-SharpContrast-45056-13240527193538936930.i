...
texture Temp<pooled = true;>{Width = 3840; Height = 2137; Format = R8;};
#line 79
...
{
output = dot(tex2Dfetch(sBackBuffer, texcoord * float2(3840, 2137)).rgb, float3(0.299, 0.587, 0.114));
}
#line 339
void OutputPS(float4 vpos : SV_POSITION, float2 texcoord : TEXCOORD, out float4 output : SV_TARGET0)
{
float2 coord = texcoord * float2(3840, 2137);
