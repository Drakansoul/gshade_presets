...
//   int Diffusion_2_Radius;            // Offset:   60 Size:     4
//   float Diffusion_2_Gamma;           // Offset:   64 Size:     4 [unused]
//   float Diffusion_2_Quality;         // Offset:   68 Size:     4
...
loop 
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r3.xyzw, r3.xyxx, t10.xyzw, s0, l(0.000000)
  div r1.x, |r1.z|, r0.x
