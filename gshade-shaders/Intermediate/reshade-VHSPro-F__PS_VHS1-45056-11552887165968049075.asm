...
movc r0.z, r0.z, l(2137.000000), r0.x
lt r1.x, r0.z, r0.y
or r0.w, r0.w, r1.x
...
mul r0.x, r0.y, l(1.796911)
mad r0.y, -r0.y, l(1.796911), l(3840.000000)
...
if_nz cb0[4].z
  mul r1.xyz, r3.yzyy, l(3840.000000, 2137.000000, 3840.000000, 0.000000)
  if_z cb0[4].w
...
if_nz cb0[1].x
  mul r0.w, cb0[1].w, l(0.000260)
  mul r1.xyz, cb0[2].xyzx, l(0.000468, 0.000260, 0.000468, 0.000000)
  ge r1.w, r0.w, v1.x
  mad r2.x, -cb0[1].w, l(0.000260), l(1.000000)
  ge r2.y, v1.x, r2.x
  or r1.w, r1.w, r2.y
  ge r2.y, r1.x, v1.y
  or r1.w, r1.w, r2.y
  mad r2.y, -cb0[2].x, l(0.000468), l(1.000000)
  ge r2.z, v1.y, r2.y
  or r1.w, r1.w, r2.z
  lt r2.z, r0.w, v1.x
  mad r0.w, cb0[2].y, l(0.000260), r0.w
  lt r2.w, v1.x, r0.w
  and r2.z, r2.w, r2.z
  add r0.w, -r0.w, l(1.000000)
  lt r0.w, r0.w, v1.x
  ...
  mad r3.x, -cb0[1].w, l(0.000260), v1.x
  div r3.x, r3.x, r1.y
  add r2.x, r2.x, -v1.x
  div r1.y, r2.x, r1.y
  ...
  and r1.x, r1.y, r1.x
  or r0.w, r0.w, r1.x
  mad r1.x, -cb0[2].x, l(0.000468), v1.y
  add r1.y, r2.y, -v1.y
