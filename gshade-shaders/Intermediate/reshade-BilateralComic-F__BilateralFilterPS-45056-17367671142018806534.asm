...
if_nz r0.w
  ...
  if_nz r0.w
    ...
    not r1.x, r0.w
    if_nz r0.w
      add r3.xyzw, v1.xyxy, l(-0.000260, -0.000000, -0.000521, -0.000000)
      ...
      div r1.y, r1.y, r1.z
      add r3.xyzw, v1.xyxy, l(-0.000000, -0.000468, -0.000000, -0.000936)
  ...
  add r4.xz, v1.yyxy, l(0.000000, 0.000000, -0.000260, 0.000000)
  mov r4.y, l(1.000000)
  add r5.xz, v1.yyxy, l(0.000000, 0.000000, -0.000521, 0.000000)
  mov r5.y, l(1.000000)
  mul r5.xyz, r1.yyyy, r5.xyzx
  mad r4.xyz, r4.xyzx, r0.wwww, -r5.xyzx
  add r5.yz, v1.xxyx, l(0.000000, 0.000000, -0.000468, 0.000000)
  mov r5.x, l(1.000000)
  add r6.yz, v1.xxyx, l(0.000000, 0.000000, -0.000936, 0.000000)
  mov r6.x, l(1.000000)
...
mad r3.xyzw, r1.xyxy, l(-0.000521, -0.000936, -0.000521, -0.000468), v1.xyxy
...
add r0.x, r0.w, r0.x
mad r3.xyzw, r1.xyxy, l(-0.000521, 0.000468, -0.000521, 0.000936), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t4.xyzw, s0
dp3 r0.w, r4.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
mad r0.w, r0.z, l(255.000000), -r0.w
mul r0.w, r0.w, r0.w
...
mad r2.xyz, r3.xyzx, r0.wwww, r2.xyzx
add r0.x, r0.w, r0.x
mad r3.xyzw, r1.xyxy, l(-0.000260, -0.000936, -0.000260, -0.000468), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t4.xyzw, s0
dp3 r0.w, r4.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
mad r0.w, r0.z, l(255.000000), -r0.w
mul r0.w, r0.w, r0.w
...
mad r2.xyz, r3.xyzx, r0.wwww, r2.xyzx
add r0.x, r0.w, r0.x
mad r3.xyzw, r1.xyxy, l(-0.000260, 0.000468, -0.000260, 0.000936), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r4.xyz, r3.xyxx, t4.xyzw, s0
dp3 r0.w, r4.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
mad r0.w, r0.z, l(255.000000), -r0.w
mul r0.w, r0.w, r0.w
...
mad r2.xyz, r3.xyzx, r0.wwww, r2.xyzx
add r0.x, r0.w, r0.x
mad r1.xyzw, r1.xyxy, l(0.000521, 0.000468, 0.000521, 0.000936), v1.xyxy
