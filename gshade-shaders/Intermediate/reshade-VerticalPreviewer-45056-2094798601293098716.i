...
texture texDraw { Width = 3840; Height = 2137; };
texture texDrawARatio { Width = 3840; Height = 2137; };
texture texVPreOut { Width = 3840; Height = 2137; };
#line 168
...
float2 pixelsize = float2((1.0 / 3840), (1.0 / 2137)) * p.offset;
#line 190
...
float3 result;
#line 534
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 0.25, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 1.75, texCoord.y));
#line 537
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 540
...
float3 result;
#line 546
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 0.35, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 1.65, texCoord.y));
#line 549
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 552
...
float3 result;
#line 558
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 0.69, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 1.31, texCoord.y));
#line 561
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 564
...
float3 result;
#line 570
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 0.514, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 1.486, texCoord.y));
#line 573
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 576
...
float3 result;
#line 582
sctpoint lineV1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 0.5, texCoord.y));
sctpoint lineH1 = NewPoint(gridColorARatio, lineWidthARatio, float2(((3840 / 2137) * 0.5) * 1.5, texCoord.y));
#line 585
result = DrawPoint(background, lineV1, texCoord);
result = DrawPoint(result, lineH1, texCoord);
#line 588
...
const float2 ScaleSize = (float2(3840, 2137) * cLayerVPre_Scale / float2(3840, 2137));
const float AspectX = 1.0 - 3840 * (1.0 / 2137);
const float AspectY = 1.0 - 2137 * (1.0 / 3840);
