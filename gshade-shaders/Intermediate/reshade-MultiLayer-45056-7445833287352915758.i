...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\MultiLayer.fx"
...
#line 47 "C:\Program Files\GShade\gshade-shaders\Shaders\MultiLayer.fx"
...
#line 48 "C:\Program Files\GShade\gshade-shaders\Shaders\MultiLayer.fx"
#line 54
...
> = 0;
#line 67
uniform int Layer_BlendMode < ui_category = ""; ui_category_closed = false; ui_items = "Normal\0" "Darken\0" "  Multiply\0" "  Color Burn\0" "  Linear Burn\0" "Lighten\0" "  Screen\0" "  Color Dodge\0" "  Linear Dodge\0" "  Addition\0" "  Glow\0" "Overlay\0" "  Soft Light\0" "  Hard Light\0" "  Vivid Light\0" "  Linear Light\0" "  Pin Light\0" "  Hard Mix\0" "Difference\0" "  Exclusion\0" "Subtract\0" "  Divide\0" "  Divide (Alternative)\0" "  Divide (Photoshop)\0" "  Reflect\0" "  Grain Extract\0" "  Grain Merge\0" "Hue\0" "  Saturation\0" "  Color\0" "  Luminosity\0"; ui_label = "Blending Mode"; ui_tooltip = "Select the blending mode applied to the layer."; ui_type = "combo"; ui_spacing = 0; > = 0;
#line 69
...
> = 0;
#line 146
texture MultiLayer_Tex <source = "LayerA.png";> { Width = 3840; Height = 2137; Format=RGBA8; };
...
const float2 ScaleSize = (float2(3840, 2137) * Layer_Scale / float2(3840, 2137));
