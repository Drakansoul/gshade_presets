...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\SmartNoise.fx"
#line 15
uniform float noise <
ui_type = "slider";
...
#line 24 "C:\Program Files\GShade\gshade-shaders\Shaders\SmartNoise.fx"
#line 25
...
#line 76
return color + ((gold_noise(texcoord * float2(3840, 2137).y * 2.0, ((luminance * float2(3840, 2137).y) + (float2(3840, 2137).x * texcoord.y) + texcoord.x + ReShade::GetLinearizedDepth(texcoord) * float2(3840, 2137).y) * 0.0001) * amount) - sub);
}
#line 79
