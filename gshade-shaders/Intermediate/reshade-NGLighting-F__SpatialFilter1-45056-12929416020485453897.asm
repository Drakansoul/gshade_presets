...
mov x0[6].xy, r0.yzyy
mov x0[7].xy, r4.xyxx
sample_l_indexable(texture2d)(float,float,float,float) r0.yzw, v1.xyxx, t18.wxyz, s0, l(0.000000)
mov r3.xyz, r0.yzwy
mov r2.yz, l(0,1,0,0)
mov r3.w, l(-1)
loop 
  ...
  lt r4.w, r4.w, r2.w
  and r4.z, r4.w, r4.z
  sample_l_indexable(texture2d)(float,float,float,float) r4.xyw, r4.xyxx, t18.xywz, s0, l(0.000000)
  and r5.xy, r4.zzzz, l(0x3f800000, 1, 0, 0)
  mad r3.xyz, r4.xywx, r5.xxxx, r3.xyzx
  iadd r2.y, r2.y, r5.y
  iadd r2.z, r2.z, l(1)
  ige r3.w, l(7), r2.z
endloop 
...
sample_indexable(texture2d)(float,float,float,float) r0.w, v1.xyxx, t18.xyzw, s0
