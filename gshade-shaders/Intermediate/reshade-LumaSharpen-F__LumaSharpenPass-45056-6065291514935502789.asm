...
if_z cb0[0].z
  mad r2.xyzw, cb0[0].wwww, l(0.000087, 0.000156, -0.000087, -0.000156), v1.xyxy
...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000130, -0.000234, 0.000130, 0.000234), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000130, 0.000234, 0.000130, -0.000234), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000104, -0.000562, 0.000313, 0.000187), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.000313, 0.000187, 0.000104, -0.000562), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000130,0,0,-0.000234)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.000468, -0.000260, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.000260, 0.000000, 0.000000, 0.000468)
  mov r4.yz, l(0,0.000234,-0.000130,0)
