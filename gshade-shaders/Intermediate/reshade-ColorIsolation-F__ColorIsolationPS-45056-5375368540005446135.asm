...
// {
//
//   float fUITargetHue;                // Offset:    0 Size:     4
//   int cUIWindowFunction;             // Offset:    4 Size:     4
//   float fUIOverlap;                  // Offset:    8 Size:     4
//   float fUIWindowHeight;             // Offset:   12 Size:     4
//   int iUIType;                       // Offset:   16 Size:     4
//   bool bUIShowDiff;                  // Offset:   20 Size:     4
//   bool bUIShowDebugOverlay;          // Offset:   24 Size:     4
//   float2 fUIOverlayPos;              // Offset:   32 Size:     8
//   int2 iUIOverlaySize;               // Offset:   40 Size:     8
//   float fUIOverlayOpacity;           // Offset:   48 Size:     4
//
// }
//
//
