...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\TAA.fx"
#line 7
...
#line 36
texture PastBackBuffer  { Width = 3840; Height = 2137; Format = RGBA8;};
#line 38
sampler PBackBuffer
{
...
#line 43
texture TAABackBuffer  { Width = 3840; Height = 2137; Format = RGBA8;};
#line 45
...
XY = XY * (float2((1.0 / 3840), (1.0 / 2137)) * Jitter_Ammount);
#line 95
...
#line 106
float3 in1 = tex2D(BackBuffer, texcoord + float2(+float2((1.0 / 3840), (1.0 / 2137)).x, 0.0)).xyz;
float3 in2 = tex2D(BackBuffer, texcoord + float2(-float2((1.0 / 3840), (1.0 / 2137)).x, 0.0)).xyz;
float3 in3 = tex2D(BackBuffer, texcoord + float2(0.0, +float2((1.0 / 3840), (1.0 / 2137)).y)).xyz;
float3 in4 = tex2D(BackBuffer, texcoord + float2(0.0, -float2((1.0 / 3840), (1.0 / 2137)).y)).xyz;
float3 in5 = tex2D(BackBuffer, texcoord + float2(+float2((1.0 / 3840), (1.0 / 2137)).x, +float2((1.0 / 3840), (1.0 / 2137)).y)).xyz;
float3 in6 = tex2D(BackBuffer, texcoord + float2(-float2((1.0 / 3840), (1.0 / 2137)).x, +float2((1.0 / 3840), (1.0 / 2137)).y)).xyz;
float3 in7 = tex2D(BackBuffer, texcoord + float2(+float2((1.0 / 3840), (1.0 / 2137)).x, -float2((1.0 / 3840), (1.0 / 2137)).y)).xyz;
float3 in8 = tex2D(BackBuffer, texcoord + float2(-float2((1.0 / 3840), (1.0 / 2137)).x, -float2((1.0 / 3840), (1.0 / 2137)).y)).xyz;
#line 115
...
for (int i = 0; i < 6; i++)
{
float4 neighbor = tex2D(BackBuffer, texcoord + XYoffset[i] * float2((1.0 / 3840), (1.0 / 2137)) );
#line 150
