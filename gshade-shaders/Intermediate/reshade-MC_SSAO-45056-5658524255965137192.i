...
#line 147
texture2D InterleavedAOTex  { Width = 3840 / 2;   Height = 2137 / 2;   Format = R8; MipLevels = 1;};
texture2D InterleavedAOTex2 { Width = 3840 / 2;   Height = 2137 / 2;   Format = R8; MipLevels = 1;};
texture2D InterleavedAOTex3 { Width = 3840 / 2;   Height = 2137 / 2;   Format = R8; MipLevels = 1;};
texture2D InterleavedAOTex4 { Width = 3840 / 2;   Height = 2137 / 2;   Format = R8; MipLevels = 1;};
#line 152
texture2D AOTex	{ Width = 3840;   Height = 2137;   Format = R8; MipLevels = 1;};
texture2D AOTex2	{ Width = 3840;   Height = 2137;   Format = R8; MipLevels = 1;};
texture2D NormalTex	{ Width = 3840;   Height = 2137;   Format = RGBA8; MipLevels = 1;};
#line 156
...
#line 186
const float2 offx = float2(float2((1.0 / 3840), (1.0 / 2137)).x, 0);
const float2 offy = float2(0, float2((1.0 / 3840), (1.0 / 2137)).y);
#line 189
...
#line 233
float2 off = float2(float2((1.0 / 3840), (1.0 / 2137)).x, 0);
#line 235
float4 my_normal;
#line 237
if (bilateral)
...
if (Bilateral == 2)
{
off = float2(0, float2((1.0 / 3840), (1.0 / 2137)).y);
}
#line 247
float weights[32];
weights[0] = 1;
...
range *= 3.0 * clamp(BlurQuality, 0.0, 1.0);
#line 336
float2 off = float2(0, float2((1.0 / 3840), (1.0 / 2137)).y);
#line 338
float4 my_normal;
#line 340
if (bilateral)
...
if (Bilateral == 2)
{
off = float2(float2((1.0 / 3840), (1.0 / 2137)).x, 0);
}
#line 350
float weights[32];
weights[0] = 1;
...
{
const float2 ray_in_pixels = ray / float2((1.0 / 3840), (1.0 / 2137));
...
{
uint2 texcoord_px = texcoord / float2((1.0 / 3840), (1.0 / 2137));
#line 447
...
ray.x = sin(angle);
ray.y = cos(angle);
ray *= float2((1.0 / 3840), (1.0 / 2137)) * sample_dist;
...
{
occlusion_1 = GetOcclusion(texcoord + float2(-0.25,  0.25) * float2((1.0 / 3840), (1.0 / 2137)),  0.00);
occlusion_2 = GetOcclusion(texcoord + float2( 0.25,  0.25) * float2((1.0 / 3840), (1.0 / 2137)),  0.25);
occlusion_3 = GetOcclusion(texcoord + float2(-0.25, -0.25) * float2((1.0 / 3840), (1.0 / 2137)),  0.50);
occlusion_4 = GetOcclusion(texcoord + float2( 0.25, -0.25) * float2((1.0 / 3840), (1.0 / 2137)),  0.75);
}
#line 551
technique MC_DAO
{
