...
if_nz r0.x
  ...
  mul r0.yw, v1.xxxy, l(0.000000, 480.000000, 0.000000, 268.000000)
  ftoi r1.xy, r0.ywyy
  mov r1.zw, l(0,0,0,0)
...
if_nz r0.x
  ...
  sample_l_indexable(texture2d)(float,float,float,float) r0.z, v1.xyxx, t12.yzxw, s0, l(9.000000)
  ...
  add r1.x, r1.y, r1.x
  sample_l_indexable(texture2d)(float,float,float,float) r1.y, v1.xyxx, t20.yxzw, s0, l(5.000000)
  add r1.x, r1.y, r1.x
