...
dcl_output o3.x
dcl_temps 12
add r0.xyzw, v1.xyxy, l(-0.000065, 0.000117, 0.000065, 0.000117)
...
mad r3.xyzw, v1.xyxy, l(1.000000, -1.000000, 1.000000, -1.000000), l(-0.000065, 0.999883, 0.000065, 0.999883)
mad r3.xyzw, r3.xyzw, l(2.000000, 2.000000, 2.000000, 2.000000), l(-1.000000, -1.000000, -1.000000, -1.000000)
mul r1.xz, r1.xxxx, l(0.008726, 0.000000, 0.004856, 0.000000)
...
itof r3.y, r3.y
mul r6.xy, r3.yyyy, l(0.000260, 0.000468, 0.000000, 0.000000)
...
loop 
  ...
  mov r9.y, r10.x
  mul r8.yz, r6.xxyx, r9.xxyx
  div r8.yz, r8.yyzy, r6.zzzz
  mov r8.w, l(0)
  mov r9.xy, l(0,-1,0,0)
  loop 
    breakc_z r9.y
    ...
    div r9.z, r9.z, r5.z
    max r9.z, r9.z, l(0.010000)
    mul r9.zw, r8.yyyz, r9.zzzz
    mul r10.xy, r9.zwzz, l(3839.999756, 2137.000000, 0.000000, 0.000000)
    max r10.x, |r10.y|, |r10.x|
    lt r10.y, r10.x, l(1.000000)
    div r10.xz, r9.zzwz, r10.xxxx
    movc r9.zw, r10.yyyy, r10.xxxz, r9.zzzw
    add r10.xy, r0.xyxx, r9.zwzz
    sample_l_indexable(texture2d)(float,float,float,float) r9.z, r10.xyxx, t2.yzxw, s0, l(0.000000)
    mad r9.w, -r9.z, l(999.000000), l(1000.000000)
    div r9.z, r9.z, r9.w
    mul r11.z, r9.z, l(1000.000000)
    add r10.z, -r10.y, l(1.000000)
    mad r9.zw, r10.xxxz, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
    div r10.xy, r4.xyxx, r11.zzzz
    div r11.xy, r9.zwzz, r10.xyxx
    add r10.xyz, -r2.xyzx, r11.xyzx
    dp3 r9.z, r10.xyzx, r10.xyzx
    rsq r9.z, r9.z
    mul r10.xyw, r9.zzzz, r10.xyxz
    dp3 r9.z, r1.xzwx, r10.xywx
    max r9.z, r9.z, l(0.000000)
    log r9.z, r9.z
    mul r9.z, r9.z, cb0[2].w
    exp r9.z, r9.z
    add r9.z, -r2.w, r9.z
    div_sat r9.z, r9.z, r6.w
    ge r9.w, |r10.z|, cb0[0].w
    add r10.x, |r10.z|, -cb0[0].w
    div r10.x, r10.x, r5.x
    add_sat r10.x, -r10.x, l(1.000000)
...
loop 
  ...
  loop 
    ...
    div r8.y, r8.y, r3.w
    max r8.y, r8.y, l(0.010000)
    mul r8.yz, r7.xxzx, r8.yyyy
    mul r9.xy, r8.yzyy, l(3839.999756, 2137.000000, 0.000000, 0.000000)
    max r8.w, |r9.y|, |r9.x|
    lt r9.x, r8.w, l(1.000000)
    div r9.yz, r8.yyzy, r8.wwww
    movc r8.yz, r9.xxxx, r9.yyzy, r8.yyzy
    add r9.xy, r0.zwzz, r8.yzyy
    sample_l_indexable(texture2d)(float,float,float,float) r8.y, r9.xyxx, t2.yxzw, s0, l(0.000000)
    mad r8.z, -r8.y, l(999.000000), l(1000.000000)
    div r8.y, r8.y, r8.z
    mul r10.z, r8.y, l(1000.000000)
    add r9.z, -r9.y, l(1.000000)
    mad r8.yz, r9.xxzx, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
    div r9.xy, r4.xyxx, r10.zzzz
    div r10.xy, r8.yzyy, r9.xyxx
    add r8.yzw, -r2.xxyz, r10.xxyz
    dp3 r9.x, r8.yzwy, r8.yzwy
    rsq r9.x, r9.x
    mul r9.xyz, r8.yzwy, r9.xxxx
    dp3 r8.y, r1.xzwx, r9.xyzx
    max r8.y, r8.y, l(0.000000)
    log r8.y, r8.y
    mul r8.y, r8.y, cb0[2].w
    exp r8.y, r8.y
    add r8.y, -r2.w, r8.y
    div_sat r8.y, r8.y, r6.w
    ge r8.z, |r8.w|, cb0[0].w
    add r8.w, |r8.w|, -cb0[0].w
    div r8.w, r8.w, r5.x
...
mad r7.xyzw, v1.xyxy, l(1.000000, -1.000000, 1.000000, -1.000000), l(-0.000065, 1.000117, 0.000065, 1.000117)
...
loop 
  breakc_z r5.y
  itof r5.z, r4.w
  add r5.z, r5.z, l(0.750000)
  mul r5.z, r3.w, r5.z
  sincos r8.x, r7.x, r5.z
  mov r8.y, r7.x
  mul r5.zw, r6.xxxy, r8.xxxy
  div r5.zw, r5.zzzw, r3.yyyy
  mov r6.z, l(0)
  mov r7.xz, l(0,0,-1,0)
  loop 
    breakc_z r7.z
    ...
    mul r8.xy, r5.zwzz, r7.wwww
    mul r8.zw, r8.xxxy, l(0.000000, 0.000000, 3839.999756, 2137.000000)
    max r7.w, |r8.w|, |r8.z|
