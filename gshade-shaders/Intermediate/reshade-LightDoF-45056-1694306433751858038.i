...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\LightDoF.fx"
...
#line 38 "C:\Program Files\GShade\gshade-shaders\Shaders\LightDoF.fx"
#line 41
...
#line 176
if (bLightDoF_UseCA) {
float2 rCoord = uv + offset * float2((1.0 / 3840), (1.0 / 2137)) * fLightDoF_Width * (1.0 + CA);
float2 gCoord = uv + offset * float2((1.0 / 3840), (1.0 / 2137)) * fLightDoF_Width * (1.0 + CA * 0.5);
float2 bCoord = uv + offset * float2((1.0 / 3840), (1.0 / 2137)) * fLightDoF_Width;
#line 181
...
float2 coord = uv + offset * float2((1.0 / 3840), (1.0 / 2137)) * fLightDoF_Width;
...
const float2 linearMouse = f2LightDoF_MouseCoord * float2((1.0 / 3840), (1.0 / 2137)); 
float2 focus;
