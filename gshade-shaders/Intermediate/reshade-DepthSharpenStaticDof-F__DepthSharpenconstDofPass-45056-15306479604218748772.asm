...
add r1.xyzw, v1.xyxy, l(-0.000260, -0.000468, 0.000260, -0.000468)
...
if_z cb0[0].z
  mad r3.xyzw, cb0[0].wwww, l(0.000087, 0.000156, -0.000087, -0.000156), v1.xyxy
...
if_nz r2.x
  mad r5.xyzw, cb0[0].wwww, l(0.000130, -0.000234, 0.000130, 0.000234), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r6.xyz, r5.xyxx, t0.xyzw, s0
  mad r7.xyzw, -cb0[0].wwww, l(0.000130, 0.000234, 0.000130, -0.000234), v1.xyxy
...
if_nz r2.y
  mad r5.xyzw, cb0[0].wwww, l(0.000104, -0.000562, 0.000313, 0.000187), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r2.xyw, r5.xyxx, t0.xywz, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000313, 0.000187, 0.000104, -0.000562), v1.xyxy
...
if_nz r2.z
  mov r2.xw, l(0.000130,0,0,-0.000234)
  mul r2.yz, cb0[0].wwww, l(0.000000, -0.000468, -0.000260, 0.000000)
  ...
  mul r5.xw, cb0[0].wwww, l(0.000260, 0.000000, 0.000000, 0.000468)
  mov r5.yz, l(0,0.000234,-0.000130,0)
