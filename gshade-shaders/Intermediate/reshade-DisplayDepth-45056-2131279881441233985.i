...
texcoord.x -= iUIOffset.x * (1.0 / 3840); 
texcoord.y += iUIOffset.y * (1.0 / 2137); 
#line 178
...
#line 217
float grid_position = frac(dot(texcoord, (float2(3840, 2137) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 219
...
color = normal;
if (iUIPresentType == 2)
color = lerp(normal, depth, step(3840 * 0.5, position.x));
#line 233
if (bUIShowOffset)
{
