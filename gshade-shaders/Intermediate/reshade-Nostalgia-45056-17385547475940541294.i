...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\Nostalgia.fx"
...
#line 52 "C:\Program Files\GShade\gshade-shaders\Shaders\Nostalgia.fx"
#line 74
...
{
#line 556
const float grid_position = frac(dot(texcoord, float2(3840, 2137) * 0.5) + 0.25); 
#line 559
...
{
color *= frac(texcoord.y * (2137 * 0.5)) + 0.5; 
}
if (Nostalgia_scanlines == 2)
{
float grey  = dot(color,float(1.0/3.0));
if (frac(texcoord.y * (2137 * 0.5)) >= 0.25);
