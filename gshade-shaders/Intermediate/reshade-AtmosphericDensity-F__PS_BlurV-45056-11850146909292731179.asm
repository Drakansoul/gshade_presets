...
if_z r0.w
  ...
  loop 
    breakc_z r1.z
    itof r1.w, r0.w
    mad r2.w, r1.w, l(0.000468), v1.y
    lt r2.w, l(0.575000), r2.w
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r1.ywyy, t12.xyzw, s1, l(0.000000)
    mad r2.xyz, r4.xyzx, r2.wwww, r3.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r1.z, r0.w, l(18)
  endloop 
  mov o0.xyz, r2.xyzx
