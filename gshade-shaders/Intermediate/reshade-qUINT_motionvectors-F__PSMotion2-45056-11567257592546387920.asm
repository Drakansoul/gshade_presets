...
loop 
  ...
  loop 
    ...
    mad r4.yw, r6.xxxy, l(0.000000, 0.002083, 0.000000, 0.003744), v1.xxxy
    sample_l_aoffimmi_indexable(3,0,0)(texture2d)(float,float,float,float) r6.x, r4.ywyy, t8.yxzw, s0, l(0.000000)
    sample_l_aoffimmi_indexable(0,0,0)(texture2d)(float,float,float,float) r7.xyzw, r4.ywyy, t22.xyzw, s0, l(0.000000)
    add r4.y, -r1.y, r6.x
...
if_nz r0.y
  add r3.xyzw, v1.xyxy, l(-0.001042, -0.001872, -0.001042, 0.000000)
  ...
  add r6.xyzw, v1.xyxy, l(-0.001042, 0.001872, 0.000000, -0.001872)
  ...
  add r1.xyzw, v1.xyxy, l(0.000000, 0.001872, 0.001042, -0.001872)
  ...
  add r4.xyz, r4.xyzx, r5.xyzx
  mad r0.yz, r1.xxyx, r1.zzwz, r0.yyzy
  add r1.xyzw, v1.xyxy, l(0.001042, 0.000000, 0.001042, 0.001872)
  sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r5.xy, r1.xyxx, t8.xyzw, s0, l(0.000000)
  add r6.xyzw, r2.xyxy, r1.xyzw
  sample_l_aoffimmi_indexable(2,0,0)(texture2d)(float,float,float,float) r1.xy, r6.xyxx, t10.xyzw, s0, l(0.000000)
  mov x0[7].xy, r5.xyxx
  ...
  mov r6.w, r4.x
  mov r3.zw, r2.xxxy
  mov r4.yz, l(0,0.001042,0.001872,0)
  mov r1.w, r0.y
  mov r4.w, |r0.z|
  mov r7.x, l(0)
  mov r7.y, r0.w
  loop 
    ...
    loop 
      ...
      loop 
        ...
        utof r14.x, r14.x
        utof r14.y, r15.x
        mad r13.zw, r14.xxxy, l(0.000000, 0.000000, 0.001042, 0.001872), r10.zzzw
