...
mul r1.yz, r2.xxxx, l(0.000000, -0.739000, 0.306000, 0.000000)
mad r2.x, -r1.x, l(0.306000), r1.y
mad r2.y, r1.x, r2.x, r1.z
mul r1.x, r0.y, l(0.000130)
...
loop 
  ...
  mul r5.xy, r5.xyxx, l(0.000130, 0.000234, 0.000000, 0.000000)
