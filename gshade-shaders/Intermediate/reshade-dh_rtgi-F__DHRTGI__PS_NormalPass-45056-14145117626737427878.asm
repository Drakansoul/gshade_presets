...
dcl_output o0.xyzw
dcl_temps 5
add r0.xyzw, v1.xyxy, l(-0.500000, -0.500000, -0.000000, -0.000468)
...
div r1.x, r0.z, r0.w
add r2.xyzw, v1.xyxy, l(-0.500000, -0.500468, 0.000260, 0.000000)
...
mul r0.x, cb0[1].z, l(3750.000000)
round_z r3.y, r0.x
mov r3.xz, l(2137.000000,0,3840.000000,0)
mul r0.xyw, r2.xyxz, r3.xyxz
mad r1.xyz, -r1.xyzx, r3.yzxy, r0.ywxy
mad r1.w, -r0.z, l(999.000000), l(1000.000000)
div r2.y, r0.z, r1.w
add r4.xy, v1.yxyy, l(-0.500000, -0.499740, 0.000000, 0.000000)
