...
//   float cLayer_PosX_Gauss;           // Offset:   60 Size:     4
//   float cLayer_PosY_Gauss;           // Offset:   64 Size:     4
//   float cLayer_Scale_Gauss;          // Offset:   68 Size:     4
//   int GaussianBlurRadius;            // Offset:   72 Size:     4
//   float GaussWeight;                 // Offset:   76 Size:     4
//   float GaussWeightH;                // Offset:   80 Size:     4 [unused]
//   float GaussWeightV;                // Offset:   84 Size:     4
...
dcl_temps 3
mov r0.xz, v1.xxyx
mad r0.y, cb0[3].w, l(-0.100000), l(-0.500000)
dp2 r0.x, r0.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
mad r0.w, cb0[4].x, l(-0.100000), l(-0.500000)
dp2 r0.y, r0.zwzz, l(1.000000, 1.000000, 0.000000, 0.000000)
add r0.z, cb0[0].z, cb0[4].y
add r0.z, r0.z, l(-1.000000)
mul r0.xyzw, r0.xyzz, l(-0.796911, 0.443490, -0.300917, 0.020753)
...
switch cb0[4].z
  ...
  loop 
    breakc_z r1.w
    mul r2.x, r0.w, icb[r1.z + 0].x
    mul r1.y, r2.x, l(0.000468)
    add r2.xy, r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t6.wxyz, s0, l(0.000000)
    mad r2.x, r2.x, icb[r1.z + 0].y, r0.y
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.yzyy, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r1.z + 0].y, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(6)
  endloop 
  break 
  ...
  loop 
    breakc_z r1.w
    mul r2.x, r0.w, icb[r1.z + 0].z
    mul r1.y, r2.x, l(0.000468)
    add r2.xy, r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t6.wxyz, s0, l(0.000000)
    mad r2.x, r2.x, icb[r1.z + 0].w, r0.y
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.yzyy, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r1.z + 0].w, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(11)
  endloop 
  break 
  ...
  loop 
    breakc_z r1.w
    mul r2.x, r0.w, icb[r1.z + 6].x
    mul r1.y, r2.x, l(0.000468)
    add r2.xy, r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r2.x, r2.xyxx, t6.wxyz, s0, l(0.000000)
    mad r2.x, r2.x, icb[r1.z + 6].y, r0.y
    add r2.yz, -r1.xxyx, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.yzyy, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r1.z + 6].y, r2.x
    iadd r1.z, r1.z, l(1)
    ilt r1.w, r1.z, l(6)
  endloop 
  break 
  ...
  loop 
    breakc_z r1.z
    mul r1.w, r0.z, icb[r0.w + 11].z
    mul r1.y, r1.w, l(0.000468)
    add r2.xy, r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.w, r2.xyxx, t6.xyzw, s0, l(0.000000)
    mad r1.w, r1.w, icb[r0.w + 11].w, r0.y
    add r2.xy, -r1.xyxx, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.y, r2.xyxx, t6.xwyz, s0, l(0.000000)
    mad r0.y, r1.y, icb[r0.w + 11].w, r1.w
    iadd r0.w, r0.w, l(1)
    ilt r1.z, r0.w, l(4)
  endloop 
  break 
