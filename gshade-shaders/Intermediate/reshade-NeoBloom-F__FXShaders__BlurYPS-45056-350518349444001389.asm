...
dcl_output o0.xyzw
dcl_temps 18
add r0.xyzw, v1.xyxy, l(0.000000, 0.000936, 0.000000, 0.001872)
...
add r2.xyzw, v1.xyxy, l(0.000000, -0.000936, 0.000000, -0.000000)
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.zwzz, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t8.xyzw, s1
add r4.xyzw, v1.xyxy, l(0.000000, -0.002808, 0.000000, -0.001872)
sample_indexable(texture2d)(float,float,float,float) r5.xyzw, r4.zwzz, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r4.xyzw, r4.xyxx, t8.xyzw, s1
add r6.xyzw, v1.xyxy, l(0.000000, -0.004679, 0.000000, -0.003744)
sample_indexable(texture2d)(float,float,float,float) r7.xyzw, r6.zwzz, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r6.xyzw, r6.xyxx, t8.xyzw, s1
add r8.xyzw, v1.xyxy, l(0.000000, -0.006551, 0.000000, -0.005615)
sample_indexable(texture2d)(float,float,float,float) r9.xyzw, r8.zwzz, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r8.xyzw, r8.xyxx, t8.xyzw, s1
add r10.xyzw, v1.xyxy, l(0.000000, -0.008423, 0.000000, -0.007487)
sample_indexable(texture2d)(float,float,float,float) r11.xyzw, r10.zwzz, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r10.xyzw, r10.xyxx, t8.xyzw, s1
add r12.xyzw, v1.xyxy, l(0.000000, -0.010295, 0.000000, -0.009359)
sample_indexable(texture2d)(float,float,float,float) r13.xyzw, r12.zwzz, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r12.xyzw, r12.xyxx, t8.xyzw, s1
add r14.xyzw, v1.xyxy, l(-0.000000, -0.012167, 0.000000, -0.011231)
sample_indexable(texture2d)(float,float,float,float) r15.xyzw, r14.xyxx, t8.xyzw, s1
sample_indexable(texture2d)(float,float,float,float) r14.xyzw, r14.zwzz, t8.xyzw, s1
...
add r1.xyzw, v1.xyxy, l(0.000000, 0.002808, 0.000000, 0.003744)
