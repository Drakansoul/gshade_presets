...
mov r1.xz, l(0,0,0,0)
mul r1.yw, cb0[2].wwww, l(0.000000, 0.000468, 0.000000, 0.000936)
add r2.xyzw, r1.zyzw, v1.xyxy
...
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyxx, t6.xyzw, s0
...
mov r1.xz, l(0,0,0,0)
mul r1.yw, cb0[2].wwww, l(0.000000, 0.001404, 0.000000, 0.001872)
add r2.xyzw, r1.zyzw, v1.xyxy
add r1.xyzw, -r1.xyzw, v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyzw, r2.xyxx, t6.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.zwzz, t6.xyzw, s0
