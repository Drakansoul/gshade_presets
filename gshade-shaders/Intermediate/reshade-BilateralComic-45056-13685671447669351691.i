...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\BilateralComic.fx"
...
#line 7 "C:\Program Files\GShade\gshade-shaders\Shaders\BilateralComic.fx"
#line 12
texture BackBuffer : COLOR;
texture Luma <Pooled = true;> {Width = 3840; Height = 2137; Format = R16f;};
texture Sobel <Pooled = true;> {Width = 3840; Height = 2137; Format = R8;};
#line 16
...
{
float3 offset = float3(float2((1.0 / 3840), (1.0 / 2137)), 0.0);
float c;
float4 h;
float4 v;
if(Anisotropy == 1)
...
{
float2 offset = (float2(i, j) * normals.xy) * 1 / float2(3840, 2137);
