...
if_nz r1.y
  ...
  if_nz r1.z
    ...
    max r1.w, r0.y, r0.x
    max r1.w, r0.z, r1.w
    ieq r2.xy, cb0[4].yyyy, l(1, 2, 0, 0)
    min r2.z, r0.y, r0.x
    min r2.z, r0.z, r2.z
    add r2.z, r1.w, r2.z
    mul r2.z, r2.z, l(0.500000)
    dp3 r2.w, r0.xyzx, l(0.210000, 0.720000, 0.070000, 0.000000)
    movc r2.z, r2.y, r2.z, r2.w
    movc r1.w, r2.x, r1.w, r2.z
    ...
    loop 
      ...
      movc r6.z, r2.y, r6.z, r6.w
      movc r6.y, r2.x, r6.y, r6.z
      ...
      mad r6.yzw, r7.xxyz, r7.wwww, r3.xxyz
      mad r4.w, r4.w, r6.x, r1.w
      mad r7.xy, -r1.yzyy, r3.wwww, v1.xyxx
      sample_l_indexable(texture2d)(float,float,float,float) r9.xyz, r7.xyxx, t0.xyzw, s0, l(0.000000)
      ...
      movc r7.y, r2.y, r7.y, r7.z
      movc r7.x, r2.x, r7.x, r7.y
      ...
      mad r3.xyz, r9.xyzx, r9.wwww, r6.yzwy
    ...
    movc r1.xyzw, r2.yyyy, r5.xyzw, r6.xyzw
