...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\DLAA.fx"
#line 26
...
texture SLPtex {Width = 3840; Height = 2137; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) * float2((1.0 / 3840), (1.0 / 2137)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) * float2((1.0 / 3840), (1.0 / 2137)).xy);
}
#line 86
