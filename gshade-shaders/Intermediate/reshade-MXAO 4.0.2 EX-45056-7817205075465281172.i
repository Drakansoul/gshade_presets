...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\MXAO 4.0.2 EX.fx"
#line 42
...
#line 170 "C:\Program Files\GShade\gshade-shaders\Shaders\MXAO 4.0.2 EX.fx"
#line 171
texture2D MXAO_ColorTex 	{ Width = 3840;   Height = 2137;   Format = RGBA8; MipLevels = 3+2;};
texture2D MXAO_DepthTex 	{ Width = 3840;   Height = 2137;   Format = R16F;  MipLevels = 3+0;};
texture2D MXAO_NormalTex	{ Width = 3840;   Height = 2137;   Format = RGBA8; MipLevels = 3+2;};
texture2D MXAO_CullingTex	{ Width = 3840/8; Height = 2137/8; Format = R8; };
#line 176
...
{
const float2 sampleCoord = MXAO.texcoord.xy + blurOffsets[iStep] * float2((1.0 / 3840), (1.0 / 2137)) * radius / inputscale;
#line 303
...
{
const float2 searchRadiusScaled = 0.018 / P.z * float2(1.0,(3840 * (1.0 / 2137)));
...
{
const float4 cOffsets = float4(float2((1.0 / 3840), (1.0 / 2137)),-float2((1.0 / 3840), (1.0 / 2137))) * 8;
...
{
const float3 offs = float3(float2((1.0 / 3840), (1.0 / 2137)),0);
#line 406
...
{
sampleUV = MXAO.scaledcoord.xy + Dir.xy * float2(1.0, (3840 * (1.0 / 2137))) * (iSample + randStep);
...
|| 0.25 * 0.5 * MXAO_SAMPLE_RADIUS / (tex2D(sMXAO_DepthTex,MXAO.scaledcoord.xy).x + 2.0) * 2137 < 1.0
