...
if_nz cb0[1].x
  ...
  if_nz cb0[1].y
    mul r0.yz, r1.yyxy, l(0.000000, 0.556510, 1.000000, 0.000000)
    mad r2.xy, r1.xyxx, l(1.000000, 0.556510, 0.000000, 0.000000), l(-0.500000, -0.278255, 0.000000, 0.000000)
    dp2 r0.w, r2.xyxx, r2.xyxx
    sqrt r1.w, r0.w
    mad r2.z, cb0[1].z, l(0.020000), l(-0.500000)
    mul r2.w, r2.z, l(5.490264)
    lt r3.x, l(0.000000), r2.z
    movc r3.y, r3.x, l(0.572211), l(0.500000)
    if_nz r3.x
      rsq r3.x, r0.w
      ...
      add r0.yz, r3.zzxz, l(0.000000, 0.278255, 0.500000, 0.000000)
      mov r1.x, r0.z
    else 
      ...
      if_nz r2.z
        ...
        add r0.yz, r2.yyxy, l(0.000000, 0.278255, 0.500000, 0.000000)
        mov r1.x, r0.z
      else 
        mov r1.x, r0.z
      endif 
    endif 
    mul r1.y, r0.y, l(1.796912)
  endif 
else 
  mov r1.xy, v1.xyxx
endif 
...
if_nz cb0[0].y
  mul r0.z, cb0[0].w, l(0.000260)
  or r0.w, r2.y, r2.x
  or r0.w, r2.z, r0.w
  or r0.y, r0.y, r2.w
  movc r0.w, r0.w, l(21), l(17)
  movc r0.y, r0.y, l(28), r0.w
  add r2.xy, r1.xyxx, l(-0.000130, -0.000000, 0.000000, 0.000000)
  itof r0.w, r0.y
  mul r1.w, r0.w, l(0.000978)
  frc r1.w, r1.w
  mul r1.w, r1.w, l(1023.000000)
  add r1.z, r1.x, l(-0.000130)
  mov r3.y, l(0)
