...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\FastSharpen.fx"
...
#line 22 "C:\Program Files\GShade\gshade-shaders\Shaders\FastSharpen.fx"
#line 23
...
> = 0.50;
#line 48
static const float2 g10 = float2( 0.3333,-1.0)*float2((1.0 / 3840), (1.0 / 2137));
static const float2 g01 = float2(-1.0,-0.3333)*float2((1.0 / 3840), (1.0 / 2137));
static const float2 g12 = float2(-0.3333, 1.0)*float2((1.0 / 3840), (1.0 / 2137));
static const float2 g21 = float2( 1.0, 0.3333)*float2((1.0 / 3840), (1.0 / 2137));
#line 53
