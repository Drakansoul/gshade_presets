...
if_nz r1.x
  itof r1.x, cb0[0].w
  lt r1.y, r0.w, l(1.796911)
  if_nz r1.y
    mad r1.y, -r0.w, l(2137.000000), l(3840.000000)
    mul r1.z, r1.y, l(0.500000)
    add r1.w, -r1.y, l(3840.000000)
    div r1.w, r1.w, r1.x
    lt r1.z, v0.x, r1.z
    mad r2.x, -r1.y, l(0.500000), l(3840.000000)
    lt r2.x, r2.x, v0.x
    or r1.z, r1.z, r2.x
    div r2.x, l(2137.000000), r1.x
    mul r2.y, r2.x, v0.y
    ge r2.y, r2.y, -r2.y
    ...
    div r2.x, l(3840.000000), r0.w
    add r2.x, -r2.x, l(2137.000000)
    mul r2.y, r2.x, l(0.500000)
    add r2.z, -r2.x, l(2137.000000)
    div r2.z, r2.z, r1.x
    lt r2.y, v0.y, r2.y
    mad r2.w, -r2.x, l(0.500000), l(2137.000000)
    lt r2.w, r2.w, v0.y
    or r2.y, r2.w, r2.y
    div r1.x, l(3840.000000), r1.x
    mul r2.w, r1.x, v0.x
    ge r2.w, r2.w, -r2.w
  ...
  ge r2.zw, v0.xxxy, l(0.000000, 0.000000, 3839.000000, 2136.000000)
  or r1.x, r2.z, r2.x
  or r1.x, r2.y, r1.x
  or r1.x, r2.w, r1.x
  ...
  if_nz r1.w
    lt r1.w, r0.w, l(1.796911)
    if_nz r1.w
      mad r2.x, -r0.w, l(2137.000000), l(3840.000000)
      add r2.z, -r2.x, l(3840.000000)
      mul r2.yz, r2.xxzx, l(0.000000, 0.500000, 0.618034, 0.000000)
      lt r2.y, v0.x, r2.y
      mad r2.w, -r2.x, l(0.500000), l(3840.000000)
      lt r2.w, r2.w, v0.x
      or r2.y, r2.w, r2.y
      mul r2.w, v0.y, l(1320.738647)
      ge r2.w, r2.w, -r2.w
      movc r3.xy, r2.wwww, l(1320.738647,0.000757,0,0), l(-1320.738647,-0.000757,0,0)
      mul r2.w, r3.y, v0.y
      frc r2.w, r2.w
      mul r2.w, r2.w, r3.x
      ...
      div r2.w, l(3840.000000), r0.w
      add r2.w, -r2.w, l(2137.000000)
      mul r3.x, r2.w, l(0.500000)
      add r3.y, -r2.w, l(2137.000000)
      mul r3.y, r3.y, l(0.618034)
      lt r3.x, v0.y, r3.x
      mad r3.z, -r2.w, l(0.500000), l(2137.000000)
      lt r3.z, r3.z, v0.y
      or r3.x, r3.z, r3.x
      mul r3.z, v0.x, l(2373.250488)
      ge r3.z, r3.z, -r3.z
      movc r3.zw, r3.zzzz, l(0,0,2373.250488,0.000421), l(0,0,-2373.250488,-0.000421)
      mul r3.w, r3.w, v0.x
      frc r3.w, r3.w
      mul r3.z, r3.w, r3.z
    ...
    ge r3.zw, v0.xxxy, l(0.000000, 0.000000, 3839.000000, 2136.000000)
    or r2.w, r3.z, r3.x
    or r2.w, r3.y, r2.w
    or r2.w, r3.w, r2.w
    add r3.xy, -v0.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000)
    if_nz r1.w
      mad r1.w, -r0.w, l(2137.000000), l(3840.000000)
      mul r3.z, r1.w, l(0.500000)
      add r3.w, -r1.w, l(3840.000000)
      mul r3.w, r3.w, l(0.618034)
      lt r3.z, r3.x, r3.z
      mad r4.x, -r1.w, l(0.500000), l(3840.000000)
      lt r4.x, r4.x, r3.x
      or r3.z, r3.z, r4.x
      or r3.z, r2.w, r3.z
      mul r4.x, r3.y, l(1320.738647)
      ge r4.x, r4.x, -r4.x
      movc r4.xy, r4.xxxx, l(1320.738647,0.000757,0,0), l(-1320.738647,-0.000757,0,0)
      mul r4.y, r3.y, r4.y
      frc r4.y, r4.y
      mul r4.x, r4.y, r4.x
      ...
      add r0.w, -r0.w, l(2137.000000)
      mul r1.w, r0.w, l(0.500000)
      add r3.z, -r0.w, l(2137.000000)
      mul r3.z, r3.z, l(0.618034)
      lt r1.w, r3.y, r1.w
      mad r3.w, -r0.w, l(0.500000), l(2137.000000)
      lt r3.w, r3.w, r3.y
      or r1.w, r1.w, r3.w
      or r1.w, r1.w, r2.w
      mul r2.w, r3.x, l(2373.250488)
      ge r2.w, r2.w, -r2.w
      movc r5.xy, r2.wwww, l(2373.250488,0.000421,0,0), l(-2373.250488,-0.000421,0,0)
      mul r2.w, r3.x, r5.y
      frc r2.w, r2.w
      mul r2.w, r2.w, r5.x
      lt r2.w, r2.w, l(1.000000)
    ...
    ge r2.zw, r3.xxxy, l(0.000000, 0.000000, 3839.000000, 2136.000000)
    or r0.w, r2.z, r2.x
    or r0.w, r2.y, r0.w
    or r0.w, r2.w, r0.w
