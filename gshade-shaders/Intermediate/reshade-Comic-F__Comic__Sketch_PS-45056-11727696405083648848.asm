...
ilt r2.y, l(1), r2.x
if_nz r2.y
  add r5.xyzw, v1.xyxy, l(0.000000, -0.000936, 0.000521, -0.000936)
  ...
  mad r2.w, -r2.z, l(999.000000), l(1000.000000)
  div r8.y, r2.z, r2.w
  add r5.xyzw, v1.xyxy, l(0.000521, 0.000000, 0.000521, 0.000936)
  sample_l_indexable(texture2d)(float,float,float,float) r2.z, r5.xyxx, t2.yzxw, s0, l(0.000000)
  mad r2.w, -r2.z, l(999.000000), l(1000.000000)
  div r8.z, r2.z, r2.w
  sample_l_indexable(texture2d)(float,float,float,float) r2.z, r5.zwzz, t2.yzxw, s0, l(0.000000)
...
add r3.yz, v1.xxyx, l(0.000000, 0.000000, -0.000468, 0.000000)
mov r3.x, r6.x
mov r1.xz, v1.yyxy
