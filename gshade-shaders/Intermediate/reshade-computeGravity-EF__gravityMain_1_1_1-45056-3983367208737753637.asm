...
loop 
  ...
  imul null, r1.z, r0.z, l(2137)
  udiv r1.z, null, r1.z, l(768)
  utof r1.z, r1.z
  add r1.z, r1.z, l(0.500000)
  mul r1.y, r1.z, l(0.000468)
  ...
  div r1.y, r1.y, r1.z
  store_structured g2.x, r0.z, l(0), r1.y
...
mad r0.y, r0.y, l(0.000260), -cb0[3].w
mul r0.y, r0.y, l(3840.000000)
itof r1.y, cb0[3].z
mul r1.y, r1.y, l(0.000260)
...
loop 
  breakc_z r6.x
  imad r6.y, l(-2), r2.w, l(767)
  imad r3.w, r6.y, r0.z, r2.w
  imul null, r6.y, r3.w, l(2137)
  ...
  and r4.x, r5.x, r4.x
  or r4.x, r0.w, r4.x
  mad r3.x, r3.x, l(0.000468), -cb0[4].x
  mul r3.x, r3.x, l(2137.000000)
  mul r3.x, r3.x, r3.x
  ...
  if_z r2.y
    ...
    loop 
      breakc_z r6.z
      imad r6.w, l(-2), r5.y, l(767)
      imad r6.w, r6.w, r0.z, r5.y
      ld_structured r7.x, r6.w, l(0), g2.xxxx
      lt r7.y, r6.y, r7.x
      ld_structured r7.z, r6.w, l(0), g0.xxxx
      movc r7.y, r7.y, r3.w, r7.z
      store_structured g0.x, r6.w, l(0), r7.y
      min r7.x, r6.y, r7.x
      store_structured g2.x, r6.w, l(0), r7.x
      iadd r5.y, r5.y, l(1)
      uge r6.z, r3.x, r5.y
    endloop 
  else 
    ...
    loop 
      breakc_z r5.y
      imad r6.y, l(-2), r5.x, l(767)
      imad r6.y, r6.y, r0.z, r5.x
      store_structured g0.x, r6.y, l(0), r3.w
      store_structured g2.x, r6.y, l(0), l(0)
      iadd r5.x, r5.x, l(1)
      iadd r2.z, r2.z, l(1)
      uge r5.y, r4.x, r5.x
    endloop 
...
loop 
  ...
  ine r2.w, r2.z, r2.x
  if_nz r2.w
    imul null, r2.w, r2.z, l(2137)
    udiv r1.y, null, r2.w, l(768)
    ld_indexable(texture2d)(float,float,float,float) r3.xyzw, r1.xyzw, t0.xyzw
    utof r1.y, r2.x
    utof r2.w, r2.z
    add r2.w, -r1.y, r2.w
    ld_structured r2.z, r2.z, l(0), g3.xxxx
    utof r2.z, r2.z
