...
mul r0.w, cb0[1].z, l(3750.000000)
mov r1.xy, l(3840.000000,2137.000000,0,0)
...
round_z r3.xy, r3.xyxx
mad r3.xy, v1.xyxx, l(3840.000000, 2137.000000, 0.000000, 0.000000), r3.xyxx
mul r4.xyzw, r3.xyxy, l(512.000000, 512.000000, 512.000000, 512.000000)
ge r4.xyzw, r4.xyzw, -r4.zwzw
movc r4.xyzw, r4.xyzw, l(512.000000,512.000000,0.001953,0.001953), l(-512.000000,-512.000000,-0.001953,-0.001953)
mul r3.xy, r3.xyxx, r4.zwzz
...
ilt r3.w, l(0), cb0[2].w
iadd r6.y, cb0[3].x, l(-1)
ilt r6.z, l(0), r6.y
mov r12.w, l(0)
...
loop 
  ...
  add r15.x, r6.w, r15.x
  div r18.xyz, r17.xyzx, r1.xyzx
  div r18.xy, r18.xyxx, r18.zzzz
  add r18.xy, r18.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  sample_l_indexable(texture2d)(float,float,float,float) r17.w, r18.xyxx, t2.yzwx, s0, l(0.000000)
  mad r18.w, -r17.w, l(999.000000), l(1000.000000)
  div r17.w, r17.w, r18.w
  mad r18.w, r17.w, r1.w, -r17.z
  ge r19.x, l(0.000000), r18.w
  and r19.x, r16.y, r19.x
  if_nz r19.x
    dp3 r19.x, r8.yzwy, r2.xyzx
    add r19.x, r19.x, r19.x
    mad r8.yzw, r2.xxyz, -r19.xxxx, r8.yyzw
    ...
    if_nz r16.x
      ...
      lt r19.x, r18.w, l(0.000000)
      iadd r18.z, -r18.z, r19.x
      itof r18.z, r18.z
      lt r19.x, l(0.000000), r15.w
      lt r19.y, r15.w, l(0.000000)
      iadd r19.x, -r19.x, r19.y
      itof r19.x, r19.x
      ne r18.z, r18.z, r19.x
      ...
      if_nz r18.y
        ...
        loop 
          breakc_z r20.x
          mul r20.yzw, r3.zzzz, r19.yyzw
          mul r21.x, r3.z, r18.y
          mov r21.yzw, r14.yyzw
          mov r22.xy, r15.zwzz
          mov r22.zw, l(0,0,0,0)
          mov r23.x, r6.z
          loop 
            breakc_z r23.x
            mad r21.yzw, -r19.yyzw, r3.zzzz, r21.yyzw
            mad r22.x, -r18.y, r3.z, r22.x
            mad r22.y, r17.w, r1.w, -r21.w
            lt r23.y, l(0.000000), r22.y
            lt r23.z, r22.y, l(0.000000)
            iadd r23.y, -r23.y, r23.z
            itof r23.y, r23.y
            eq r22.w, r19.x, r23.y
            iadd r22.z, r22.z, l(1)
            not r23.y, r22.w
            ilt r23.z, r22.z, r6.y
            and r23.x, r23.z, r23.y
          endloop 
          mad r23.xyz, r19.yzwy, r3.zzzz, r21.yzwy
          mad r24.x, r18.y, r3.z, r22.x
          mad r24.y, r17.w, r1.w, -r23.z
          movc r14.yzw, r22.wwww, r23.xxyz, r21.yyzw
          movc r15.zw, r22.wwww, r24.xxxy, r22.xxxy
          iadd r18.z, r18.z, l(1)
          ilt r20.x, r18.z, cb0[2].w
      ...
      ge r17.w, r15.y, |r15.w|
      or r17.w, r18.x, r17.w
      if_nz r17.w
  ...
  mul r6.w, r0.w, r6.w
  lt r9.x, r15.y, cb0[3].w
  mad r9.y, cb0[3].w, l(0.020000), r15.y
  movc r15.y, r9.x, r9.y, r15.y
  mul r8.yzw, r0.wwww, r8.yyzw
  lt r16.z, r15.x, l(3840.000000)
  mov r16.y, l(0)
endloop 
and r2.xyzw, r13.xyzw, r16.wwww
