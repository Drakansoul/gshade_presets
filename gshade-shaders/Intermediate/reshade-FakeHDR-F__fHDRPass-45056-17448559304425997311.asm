...
// {
//
//   float fHDRPower;                   // Offset:    0 Size:     4
//   float fradius1;                    // Offset:    4 Size:     4
//   float fradius2;                    // Offset:    8 Size:     4
//
// }
//
//
...
dcl_output o0.xyz
dcl_temps 4
mad r0.xyzw, cb0[0].yyyy, l(0.000391, -0.000702, -0.000391, -0.000702), v1.xyxy
...
mad r1.xyzw, cb0[0].yyyy, l(0.000391, 0.000702, -0.000391, 0.000702), v1.xyxy
...
mad r1.xyzw, cb0[0].yyyy, l(0.000000, -0.001170, 0.000000, 0.001170), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
add r0.xyz, r0.xyzx, r2.xyzx
add r0.xyz, r1.xyzx, r0.xyzx
mad r1.xyzw, cb0[0].yyyy, l(-0.000651, 0.000000, 0.000651, 0.000000), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
add r0.xyz, r0.xyzx, r2.xyzx
add r0.xyz, r1.xyzx, r0.xyzx
mul r0.xyz, r0.xyzx, l(0.005000, 0.005000, 0.005000, 0.000000)
mad r1.xyzw, cb0[0].zzzz, l(0.000391, -0.000702, -0.000391, -0.000702), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
add r1.xyz, r1.xyzx, r2.xyzx
mad r2.xyzw, cb0[0].zzzz, l(0.000391, 0.000702, -0.000391, 0.000702), v1.xyxy
...
mad r2.xyzw, cb0[0].zzzz, l(0.000000, -0.001170, 0.000000, 0.001170), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0
add r1.xyz, r1.xyzx, r3.xyzx
add r1.xyz, r2.xyzx, r1.xyzx
mad r2.xyzw, cb0[0].zzzz, l(-0.000651, 0.000000, 0.000651, 0.000000), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0
add r1.xyz, r1.xyzx, r3.xyzx
add r1.xyz, r2.xyzx, r1.xyzx
