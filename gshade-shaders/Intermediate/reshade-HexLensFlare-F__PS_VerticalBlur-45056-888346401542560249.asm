...
dcl_output o0.xyzw
dcl_temps 4
mul r0.xy, cb0[0].zzzz, l(-0.001042, 0.000000, 0.000000, 0.000000)
mad r0.zw, cb0[0].zzzz, l(0.000000, 0.000000, -0.000521, 0.000000), v1.xxxy
mov r1.w, l(1.000000)
...
loop 
  ...
  sample_indexable(texture2d)(float,float,float,float) r1.xyz, r3.zwzz, t2.xyzw, s1
