...
//   bool ShowOverlay;                  // Offset:    8 Size:     4 [unused]
//
// }
//
//
...
loop 
  breakc_z r6.x
  udiv r7.x, r8.x, r1.w, l(10)
  mov r8.y, r7.x
  ishl r6.yz, r8.xxyx, l(0, 1, 1, 0)
  iadd r2.xy, r1.xyxx, r6.yzyy
  ld_indexable(texture2d)(float,float,float,float) r6.yzw, r2.xyzw, t4.wxyz
  dp3 r6.y, r6.yzwy, l(0.299000, 0.587000, 0.114000, 0.000000)
  iadd r7.xyzw, r2.xyxy, l(1, 0, 0, 1)
  mov r3.xy, r7.xyxx
  ld_indexable(texture2d)(float,float,float,float) r8.xyz, r3.xyzw, t4.xyzw
  dp3 r3.x, r8.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
  mov r4.xy, r7.zwzz
  ld_indexable(texture2d)(float,float,float,float) r7.xyz, r4.xyzw, t4.xyzw
  dp3 r3.y, r7.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
  iadd r5.xy, r2.xyxx, l(1, 1, 0, 0)
  ld_indexable(texture2d)(float,float,float,float) r7.xyz, r5.xyzw, t4.xyzw
  dp3 r2.x, r7.xyzx, l(0.299000, 0.587000, 0.114000, 0.000000)
  add r2.y, -r3.x, r6.y
  add r4.x, -r2.x, r3.y
  max r7.x, |r2.y|, |r4.x|
  add r2.y, -r3.y, r6.y
...
if_nz r1.x
  ...
  lt r1.x, r2.z, cb0[0].y
  lt r1.y, r2.y, r2.x
  lt r3.xy, cb0[0].yyyy, r2.yxyy
