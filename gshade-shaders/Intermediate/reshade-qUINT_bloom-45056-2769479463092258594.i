...
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\qUINT_bloom.fx"
#line 30
...
> = 4.0;
#line 1 "C:\Program Files\GShade\gshade-shaders\Shaders\qUINT_common.fxh"
#line 111
namespace qUINT
{
...
#line 124
static const float2 ASPECT_RATIO 	= float2(1.0, 3840 * (1.0 / 2137));
static const float2 PIXEL_SIZE 		= float2((1.0 / 3840), (1.0 / 2137));
static const float2 SCREEN_SIZE 	= float2(3840, 2137);
#line 130
...
#line 134 "C:\Program Files\GShade\gshade-shaders\Shaders\qUINT_bloom.fx"
#line 138
static const int BloomTex7_LowestMip = (((2137/128 >> 1) != 0) + ((2137/128 >> 2) != 0) + ((2137/128 >> 3) != 0) + ((2137/128 >> 4) != 0) + ((2137/128 >> 5) != 0) + ((2137/128 >> 6) != 0) + ((2137/128 >> 7) != 0) + ((2137/128 >> 8) != 0) + ((2137/128 >> 9) != 0) + ((2137/128 >> 10) != 0) + ((2137/128 >> 11) != 0) + ((2137/128 >> 12) != 0) + ((2137/128 >> 13) != 0) + ((2137/128 >> 14) != 0) + ((2137/128 >> 15) != 0) + ((2137/128 >> 16) != 0));
#line 140
texture2D MXBLOOM_BloomTexSource 	{ Width = 3840/2; 	Height = 2137/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 3840/2; 	Height = 2137/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 3840/4;  	Height = 2137/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 3840/8;  	Height = 2137/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 3840/16;  Height = 2137/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 3840/32;  Height = 2137/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 3840/64;  Height = 2137/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 3840/128; Height = 2137/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
