...
>;
#line 226
texture texHalfRes { Width = 3840; Height = 640; Format = RGBA16F; };
texture texNoise < source = "colorsort_noise.png"; > { Width = 4096; Height = 1024; Format = R8; };
texture texMask {Width = 3840; Height = 640; Format = R16F; };
texture texBackground { Width = 3840; Height = 2137; Format = RGBA16F; };
texture texColorSort { Width = 3840; Height = 640; Format = RGBA16F; };
...
#line 404
uint hs_width = HotsamplingMode ? 2036 : 3840;
...
fragment = tex2D(ReShade::BackBuffer, texcoord);
#line 435
float2 t_noise = float2(frac(texcoord.x * 3840 / 4096), frac(texcoord.y * 640 / 1024));
float noise_1 = tex2D(SamplerNoise, t_noise).r;
...
pass sortColor { ComputeShader = sort_color< 2, ((uint)16) >; DispatchSizeX = 3840 / 2; DispatchSizeY = 1; }
